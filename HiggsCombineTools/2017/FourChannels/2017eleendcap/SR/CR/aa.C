...
//=========  (Fri Jun  5 17:21:57 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-44.35073,1.0625,296.8087);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(253.4327);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(266.1044);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.3620329);
   unrolledsPhist_stack_1->SetBinError(1,0.269869);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,1.510619);
   unrolledsPhist_stack_2->SetBinError(1,0.5964894);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,0.8186073);
   unrolledsPhist_stack_3->SetBinError(1,0.4574589);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,48.7656);
   unrolledsPhist_stack_5->SetBinError(1,3.06009);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,73.12243);
   unrolledsPhist_stack_6->SetBinError(1,3.634833);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,2.137067);
   unrolledsPhist_stack_7->SetBinError(1,0.1763928);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [2.14]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [73.12]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [48.77]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [0.82]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [1.51]","lpf");
