...
int Print_Uncer_all(){
		...
		for(int j=0;j<tag.size();j++){
			...
			TString f_pileup      ="./pileup/pu_uncer"+tag[j]+".txt";
			...
			TString f_puIdeff ="./puIdSF/eff_uncer_"+channel[i]+tag[j]+".txt";
			TString f_puIdmis ="./puIdSF/mis_uncer_"+channel[i]+tag[j]+".txt";
