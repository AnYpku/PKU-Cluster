...
fdir = '/data/pku/home/anying/cms/PKU-Cluster/Significance/CR/tight_pu/root/'
...
genbinerror=[]
arr={}
f=open('/data/pku/home/anying/cms/PKU-Cluster/Significance/CR/Uncer/tight_pu/summary_uncer_'+sys.argv[2]+sys.argv[1]+'CR.txt')
import re
import numpy as np
for line in f:
        if not line.strip():
