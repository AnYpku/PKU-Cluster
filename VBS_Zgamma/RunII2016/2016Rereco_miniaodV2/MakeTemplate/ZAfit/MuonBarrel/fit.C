...
TFile* fdata = TFile::Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/analysis_code/MakeTemplate/ZAJetfakephoton/MuonBarrel/root/Data_template-cutlep-outDMuon16.root");
TFile* ftrue = TFile::Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/analysis_code/MakeTemplate/ZAJetfakephoton/MuonBarrel/root/True_template-cutlep-outZA.root");
...
TFile* ffake = TFile::Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/analysis_code/MakeTemplate/ZAJetfakephoton/MuonBarrel/root/Fake_template-cutlep-outDMuon16.root");
TString name;
