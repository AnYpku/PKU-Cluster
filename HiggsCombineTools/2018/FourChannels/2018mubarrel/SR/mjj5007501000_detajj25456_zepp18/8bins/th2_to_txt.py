...
fakephoton=[1.10,1.10,1.10,1.09,1.10,1.11,1.08,1.09]

pdf_QCD  =[1.01,1.01,1.03,1.01,1.01,1.02,1.01,1.01]
scale_QCD=[1.16,1.20,1.26,1.11,1.16,1.16,1.12,1.13]
QCDZA_scale_extra_down = [0.974,0.950,0.918,1.029,0.937,0.969,1.009,0.992]
QCDZA_scale_extra_up   = [1.030,1.062,1.099,0.965,1.067,1.036,0.985,1.006]
pdf_ewk   =[1.04,1.04,1.04,1.04,1.04,1.04,1.05,1.05]
scale_ewk =[1.04,1.06,1.09,1.04,1.06,1.11,1.05,1.13]
interf    =[1.02,1.01,1.02,1.01,1.00,1.01,1.00,1.00]

jes_QCD  =[1.23,1.29,1.41,1.48,1.46,1.94,1.98,1.93]
jes      =[1.02,1.04,1.14,1.07,1.01,1.10,1.52,1.10]
jer      =[1.00,1.01,1.01,1.03,1.01,1.02,1.10,1.00]
jer_QCD  =[1.21,1.00,1.12,1.21,1.09,1.28,1.35,1.48]
jes_ST =[1.84,1.84,1.84,1.84,1.84,1.84,1.84,1,84]
jes_TTA=[1.26,1.26,1.26,1.26,1.26,1.26,1.26,1,26]
jes_VV =[1.74,1.74,1.74,1.74,1.74,1.74,1.74,1.74]
jer_ST =[1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00]
jer_TTA=[1.06,1.06,1.06,1.06,1.06,1.06,1.06,1.06]
jer_VV =[1.38,1.38,1.38,1.38,1.38,1.38,1.38,1.38]
for i in range(1,9):
...
# bin error
   ...
   f.write('JES_17\tlnN\t%0.2f\t%0.2f\t-\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%(jes[i-1],jes_QCD[i-1],jes_TTA[i-1],jes_VV[i-1],jes_ST[i-1],jes[i-1]))
   f.write('JER_17\tlnN\t%0.2f\t%0.2f\t-\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%(jer[i-1],jer_QCD[i-1],jer_TTA[i-1],jer_VV[i-1],jer_ST[i-1],jes[i-1]))
