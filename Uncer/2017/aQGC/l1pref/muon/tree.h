...
// Tue Apr 21 15:33:44 2020 by ROOT version 6.06/01
// from TTree outtree/outtree
// found on file: optimal_2016_ZA.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual TH1D*     Loop(TString filename, Int_t i);
   virtual Bool_t   Notify();
   virtual void     Show(Long64_t entry = -1);
   virtual void     run(TString filename);
};
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("optimal_2016_ZA.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("optimal_2016_ZA.root");
      }
...
void tree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("ZGmass", &ZGmass, &b_ZGmass);
