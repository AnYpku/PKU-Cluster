...
input_filename_e = '/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/2016/el-muon-combine/paramsets_'+sys.argv[1]+'_el.txt'
...
for l_num, l in enumerate(input_file_e):
	...
	hists[l_num].Write()#the first five histos are muon-ele combined channel ZGmass bins
