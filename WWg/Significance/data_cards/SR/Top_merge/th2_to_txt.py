...
# bin error
   ...
   f.write('Top_Stat_bin%d_%s\tlnN\t'%(i,sys.argv[1]))
   f.write('-\t-\t-\t-\t-\t%0.3f\n'%(ST_binerror))
   ...
   f.write('pdf_Top%s\tlnN\t'%(sys.argv[1]))
   f.write('-\t-\t-\t-\t-\t%0.3f\n'%(arr['Top_pdf'][i-1]))

   f.write('Scale_muR_Top%s\tlnN\t'%(sys.argv[1]))
   f.write('-\t-\t-\t-\t-\t%0.3f\n'%(arr['Top_scale_muR1'][i-1]))

   f.write('Scale_muF_Top%s\tlnN\t'%(sys.argv[1]))
   f.write('-\t-\t-\t-\t-\t%0.3f\n'%(arr['Top_scale_muF1'][i-1]))

   f.write('Scale_muFmuR_Top%s\tlnN\t'%(sys.argv[1]))
