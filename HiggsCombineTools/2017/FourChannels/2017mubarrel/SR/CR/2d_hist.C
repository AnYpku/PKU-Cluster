...
TH2D* hist_2d_mc(std::string filename){
	...
	std::string file = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2017/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2017_"+filename+".root";
...
//        TString cut="ZGmass>100 && lep==13 && fabs(photoneta)<2.5 && fabs(photoneta)>1.566 && Mjj<400 && Mjj>150";
