...
//	t->SetBranchAddress("detajj", &deltaetajj);
	...
	th2[i]->Sumw2();
        TString cut="Mva>100 && lep==13 && fabs(photoneta)<1.4442 && Mjj<400 && Mjj>150";
...
int d_hist(){
	TH2D* h0 = run("/eos/user/y/yian/2016legacy/cutla-outZA_plj.root",0);
	TH2D* hup = run("/eos/user/y/yian/2016legacy/cutla-outZA-EWK_plj.root",1);
	TH2D* hdown = run("/eos/user/y/yian/2016legacy/cutla-outplj.root",2);
