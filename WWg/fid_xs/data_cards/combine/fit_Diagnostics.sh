...
do
  ...
  combine -M FitDiagnostics shape_17_${var}.txt --saveShapes -t -1 --expectSignal=1 --saveWithUncertainties -n _${var}_17
  combine -M FitDiagnostics shape_18_${var}.txt --saveShapes -t -1 --expectSignal=1 --saveWithUncertainties -n _${var}_18
done
