...
// Sat Nov 21 11:18:30 2020 by ROOT version 5.34/38
// from TChain Events/
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           GenPart_genPartIdxMother[84];   //[nGenPart]
   Int_t           GenPart_pdgId[84];   //[nGenPart]
   Int_t           GenPart_status[84];   //[nGenPart]
   Int_t           GenPart_statusFlags[84];   //[nGenPart]
   UInt_t          nSubGenJetAK8;
   Float_t         SubGenJetAK8_eta[7];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_mass[7];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_phi[7];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_pt[7];   //[nSubGenJetAK8]
   ...
   Float_t         Jet_jercCHF[19];   //[nJet]
   Float_t         Jet_jercCHPUF[19];   //[nJet]
   ...
   UInt_t          nSubJet;
   Float_t         SubJet_btagCMVA[5];   //[nSubJet]
   ...
   UInt_t          nLepton;
   Float_t         Lepton_dr03EcalRecHitSumEt[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V1Iso_WP90[5];   //[nLepton]
   Bool_t          Lepton_softMvaId[5];   //[nLepton]
   Bool_t          Lepton_isGlobal[5];   //[nLepton]
   Float_t         Lepton_pfRelIso03_all[5];   //[nLepton]
   Float_t         Lepton_miniPFRelIso_chg[5];   //[nLepton]
   Int_t           Lepton_genPartIdx[5];   //[nLepton]
   Float_t         Lepton_ip3d[5];   //[nLepton]
   Float_t         Lepton_jetPtRelv2[5];   //[nLepton]
   Float_t         Lepton_pfRelIso03_chg[5];   //[nLepton]
   UChar_t         Lepton_lostHits[5];   //[nLepton]
   Int_t           Lepton_charge[5];   //[nLepton]
   Int_t           Lepton_vidNestedWPBitmapHEEP[5];   //[nLepton]
   Float_t         Lepton_sieie[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V1Iso_WP80[5];   //[nLepton]
   Float_t         Lepton_dr03HcalDepth1TowerSumEt[5];   //[nLepton]
   Float_t         Lepton_dz[5];   //[nLepton]
   Bool_t          Lepton_isTracker[5];   //[nLepton]
   Float_t         Lepton_tkRelIso[5];   //[nLepton]
   Bool_t          Lepton_tightId[5];   //[nLepton]
   Float_t         Lepton_pfRelIso04_all[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V1noIso_WP80[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V1noIso_WPL[5];   //[nLepton]
   Float_t         Lepton_dzErr[5];   //[nLepton]
   UChar_t         Lepton_pfIsoId[5];   //[nLepton]
   Float_t         Lepton_phi[5];   //[nLepton]
   Int_t           Lepton_tightCharge[5];   //[nLepton]
   Float_t         Lepton_eCorr[5];   //[nLepton]
   Float_t         Lepton_softMva[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V1noIso_WP90[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V2Iso_WP80[5];   //[nLepton]
   Bool_t          Lepton_inTimeMuon[5];   //[nLepton]
   UChar_t         Lepton_genPartFlav[5];   //[nLepton]
   Float_t         Lepton_dr03TkSumPtHEEP[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V2noIso_WP90[5];   //[nLepton]
   Int_t           Lepton_nTrackerLayers[5];   //[nLepton]
   UChar_t         Lepton_tkIsoId[5];   //[nLepton]
   UChar_t         Lepton_miniIsoId[5];   //[nLepton]
   Float_t         Lepton_ptErr[5];   //[nLepton]
   Float_t         Lepton_r9[5];   //[nLepton]
   UChar_t         Lepton_seedGain[5];   //[nLepton]
   Float_t         Lepton_eta[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V2Iso_WP90[5];   //[nLepton]
   Int_t           Lepton_jetIdx[5];   //[nLepton]
   Float_t         Lepton_mvaFall17V1Iso[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V2noIso_WP80[5];   //[nLepton]
   Bool_t          Lepton_convVeto[5];   //[nLepton]
   Float_t         Lepton_segmentComp[5];   //[nLepton]
   Int_t           Lepton_photonIdx[5];   //[nLepton]
   Float_t         Lepton_mvaFall17V2Iso[5];   //[nLepton]
   Float_t         Lepton_tunepRelPt[5];   //[nLepton]
   Bool_t          Lepton_cutBased_HEEP[5];   //[nLepton]
   Float_t         Lepton_pt[5];   //[nLepton]
   UChar_t         Lepton_highPtId[5];   //[nLepton]
   Int_t           Lepton_vidNestedWPBitmap[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V2noIso_WPL[5];   //[nLepton]
   Float_t         Lepton_dxyErr[5];   //[nLepton]
   Float_t         Lepton_dr03TkSumPt[5];   //[nLepton]
   Float_t         Lepton_mvaFall17V1noIso[5];   //[nLepton]
   Bool_t          Lepton_mediumId[5];   //[nLepton]
   Float_t         Lepton_mvaFall17V2noIso[5];   //[nLepton]
   Float_t         Lepton_sip3d[5];   //[nLepton]
   UChar_t         Lepton_multiIsoId[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V2Iso_WPL[5];   //[nLepton]
   Int_t           Lepton_nStations[5];   //[nLepton]
   UChar_t         Lepton_cleanmask[5];   //[nLepton]
   Bool_t          Lepton_mediumPromptId[5];   //[nLepton]
   Float_t         Lepton_mvaLowPt[5];   //[nLepton]
   UChar_t         Lepton_mvaId[5];   //[nLepton]
   Bool_t          Lepton_mvaFall17V1Iso_WPL[5];   //[nLepton]
   Float_t         Lepton_dxy[5];   //[nLepton]
   Float_t         Lepton_energyErr[5];   //[nLepton]
   Int_t           Lepton_pdgId[5];   //[nLepton]
   Float_t         Lepton_jetRelIso[5];   //[nLepton]
   Bool_t          Lepton_triggerIdLoose[5];   //[nLepton]
   Float_t         Lepton_hoe[5];   //[nLepton]
   Float_t         Lepton_miniPFRelIso_all[5];   //[nLepton]
   Float_t         Lepton_mvaTTH[5];   //[nLepton]
   Bool_t          Lepton_isPFcand[5];   //[nLepton]
   Bool_t          Lepton_softId[5];   //[nLepton]
   Float_t         Lepton_eInvMinusPInv[5];   //[nLepton]
   Int_t           Lepton_fsrPhotonIdx[5];   //[nLepton]
   Bool_t          Lepton_looseId[5];   //[nLepton]
   Int_t           Lepton_cutBased[5];   //[nLepton]
   Float_t         Lepton_deltaEtaSC[5];   //[nLepton]
   Int_t           Lepton_cutBased_Fall17_V1[5];   //[nLepton]
   Float_t         Lepton_mass[5];   //[nLepton]
   ...
   TBranch        *b_Lepton_mvaFall17V1Iso_WP90;   //!
   ...
   TBranch        *b_Lepton_mvaFall17V1Iso_WP80;   //!
   ...
   TBranch        *b_Lepton_mvaFall17V1noIso_WP80;   //!
   TBranch        *b_Lepton_mvaFall17V1noIso_WPL;   //!
   ...
   TBranch        *b_Lepton_mvaFall17V1noIso_WP90;   //!
   ...
   TBranch        *b_Lepton_mvaFall17V1Iso;   //!
   ...
   TBranch        *b_Lepton_mvaFall17V1noIso;   //!
   ...
   TBranch        *b_Lepton_mvaFall17V1Iso_WPL;   //!
   ...
   TBranch        *b_Lepton_cutBased_Fall17_V1;   //!
   TBranch        *b_Lepton_mass;   //!

   TString m_dataset;
   tree(TTree *tree=0,TString dataset="");
   virtual ~tree();
   ...
   virtual void     Loop();
   virtual void endJob();
   virtual Double_t Delta(Double_t eta1, Double_t phi1, Double_t eta2, Double_t phi2);
...
#ifdef tree_cxx
tree::tree(TTree *tree,TString dataset) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("wwgamma_final_5f_NLO_1027648_4_Skim.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("wwgamma_final_5f_NLO_1027648_4_Skim.root");
      }
      ...
      chain->Add("wwgamma_final_5f_NLO_1027648_4_Skim.root/Events");
      tree = chain;
#endif // SINGLE_TREE
...
//   fChain->SetBranchAddress("weight", &weight, &b_weight);
   ...
   fChain->SetBranchAddress("Lepton_mvaFall17V1Iso_WP90", Lepton_mvaFall17V1Iso_WP90, &b_Lepton_mvaFall17V1Iso_WP90);
   ...
   fChain->SetBranchAddress("Lepton_mvaFall17V1Iso_WP80", Lepton_mvaFall17V1Iso_WP80, &b_Lepton_mvaFall17V1Iso_WP80);
   ...
   fChain->SetBranchAddress("Lepton_mvaFall17V1noIso_WP80", Lepton_mvaFall17V1noIso_WP80, &b_Lepton_mvaFall17V1noIso_WP80);
   fChain->SetBranchAddress("Lepton_mvaFall17V1noIso_WPL", Lepton_mvaFall17V1noIso_WPL, &b_Lepton_mvaFall17V1noIso_WPL);
   ...
   fChain->SetBranchAddress("Lepton_mvaFall17V1noIso_WP90", Lepton_mvaFall17V1noIso_WP90, &b_Lepton_mvaFall17V1noIso_WP90);
   ...
   fChain->SetBranchAddress("Lepton_mvaFall17V1Iso", Lepton_mvaFall17V1Iso, &b_Lepton_mvaFall17V1Iso);
   ...
   fChain->SetBranchAddress("Lepton_mvaFall17V1noIso", Lepton_mvaFall17V1noIso, &b_Lepton_mvaFall17V1noIso);
   ...
   fChain->SetBranchAddress("Lepton_mvaFall17V1Iso_WPL", Lepton_mvaFall17V1Iso_WPL, &b_Lepton_mvaFall17V1Iso_WPL);
   ...
   fChain->SetBranchAddress("Lepton_cutBased_Fall17_V1", Lepton_cutBased_Fall17_V1, &b_Lepton_cutBased_Fall17_V1);
