...
//	const char *name[7]={"0.5-0.8","0.8-1.2","1.2-2","0.5-0.8","0.8-1.2","1.2-2","0.5-2"};
	const char *name[7]={"0.5-0.8 ","0.8-1.2 ","1.2-#infty ","0.5-0.8 ","0.8-1.2 ","1.2-#infty ","0.5-#infty "};
        ...
        TH1F*th2_ZA_sig  =(TH1F*)f1->Get("hist_ZA_"+channel);
        TH1F*th2_ZA_sig17=(TH1F*)f2->Get("hist_ZA_"+channel);
        TH1F*th2_ZA_sig18=(TH1F*)f3->Get("hist_ZA_"+channel);
	...
	th2_ZA_sig->SetMarkerStyle(21);
        ...
        th2_ZA_sigout->SetFillColor(kBlue-6);
        th2_ZA_sigout->SetMarkerColor(kBlue-6);
        th2_ZA_sigout->SetLineColor(kBlue-6);
...
//        fPads1->SetGridx();
	...
	cout<<Form("Z#gamma[%.1f #pm %.2f] ",th2_ZA_sig->GetSum(),ewk_e) <<endl;
	...
	leg->AddEntry(th2_ZA_sig,"EW+QCD Z#gamma" );
	leg->AddEntry(th2_ZA_sigout,    "EW+QCD out fid.");
...
//              x_down[i]=gr16->GetErrorXlow(i);
	...
	c1->SaveAs("QCD_"+channel+"_fid.pdf");
}
int unroll_full(){
