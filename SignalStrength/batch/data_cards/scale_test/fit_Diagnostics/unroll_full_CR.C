...
void run(TString channel){
	...
	Double_t lumi=137.1;
        ...
        TFile*f1=new TFile("./hist_fit16CR.root");
        TFile*f2=new TFile("./hist_fit17CR.root");
	...
	TFile*ff1=new TFile("/home/pku/anying/cms/PKU-Cluster/SignalStrength/batch/CR/root/hist_"+par+"_16CR_"+ch+".root");
	TFile*ff2=new TFile("/home/pku/anying/cms/PKU-Cluster/SignalStrength/batch/CR/root/hist_"+par+"_17CR_"+ch+".root");
	TFile*ff3=new TFile("/home/pku/anying/cms/PKU-Cluster/SignalStrength/batch/CR/root/hist_"+par+"_18CR_"+ch+".root");
	...
	const char *name[7]={"150-300","300-400","400-500"};
	...
	th2_ZA_sig->SetMarkerStyle(21);
        ...
        TH1F*th2_ZA_sigout17=(TH1F*)f2->Get("hist_Sig_out_"+channel);
        TH1F*th2_ZA_sigout18=(TH1F*)f3->Get("hist_Sig_out_"+channel);
        th2_ZA_sigout->Add(th2_ZA_sigout17,1);
        th2_ZA_sigout->Add(th2_ZA_sigout18,1);
	...
	htot->Add(htot18,1);
        ...
        TH1F*hist_data=(TH1F*)ff1->Get("hist_data");
        TH1F*hist_data1=(TH1F*)ff2->Get("hist_data");
        TH1F*hist_data2=(TH1F*)ff3->Get("hist_data");
        hist_data->Add(hist_data1,1);hist_data->Add(hist_data2,1);
