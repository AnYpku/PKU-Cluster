...
// Setup names of data files for trees.
	...
	std::string bkgLabels[nmc] ={"plj","fakeL","VV","tW","QCD Z#gamma","t#bar{t}#gamma","t#bar{t}","QCD W#gamma","tZq"};
	std::string mcLabels[nmc] ={"plj","fakeL","VV","ST","ZGJets","TTGJets","TTJets","WGJets","tZq"};
