...
TFile* f1 = new TFile("/afs/cern.ch/work/y/yian/work/PKU-Cluster/RunII2017/plj/plj-plot/MuonEndcap/plj-hist/cutla-outDMuon_plj_h.root");
TFile* f2 = new TFile("/afs/cern.ch/work/y/yian/work/PKU-Cluster/RunII2017/plj/plj-plot/MuonEndcap/plj-hist/cutla-outDMuon_h.root");
TFile* f3 = new TFile("/afs/cern.ch/work/y/yian/work/PKU-Cluster/RunII2017/plj/plj-plot/MuonEndcap/plj-hist/cutla-outZA_plj_h.root");
