...
void open(double lowpt,double highpt,TString name1,TString name2){
	...
	ifstream f1,f2;
        f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/ElectronEndcap/ZAfit/fractionfitResult_za/txt/fakerate_"+name1+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
        f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/ElectronEndcap/ZAfit/fractionfitResult_za/txt/fakerate_"+name2+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
        double ff1,ff2;
        f1>>ff1;f2>>ff2;
