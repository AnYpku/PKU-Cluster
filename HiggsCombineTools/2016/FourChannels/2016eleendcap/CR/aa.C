...
//=========  (Fri Jun  5 00:28:58 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-69.15615,1.0625,462.8142);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(395.178);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(414.9369);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.3596632);
   unrolledsPhist_stack_1->SetBinError(1,0.2545861);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,3.689913);
   unrolledsPhist_stack_2->SetBinError(1,0.8055379);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,2.650968);
   unrolledsPhist_stack_3->SetBinError(1,1.741769);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,72.59171);
   unrolledsPhist_stack_5->SetBinError(1,4.002896);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,115.5049);
   unrolledsPhist_stack_6->SetBinError(1,4.717282);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,2.791832);
   unrolledsPhist_stack_7->SetBinError(1,0.1849436);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [2.79]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [115.50]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [72.59]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [2.65]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [3.69]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.36]","lpf");
