...
//		file_ID_sys1->Close();file_ISO_sys1->Close();
	...
	if(particle.Contains("muon")&&tag.Contains("18")){
		cout<<"before open muon 18 SF file"<<endl;
...
//		file_ID->Close();
	...
	double scalef,pileupWeight,prefWeight,photon_veto_scale,puIdweight_T,puIdweight_M,puIdweight_L,puIdweight;;
