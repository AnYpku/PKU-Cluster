...
//=========  (Fri Jun  5 17:42:54 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-316.6372,1.0625,2119.034);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(1809.356);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(1899.823);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,3.323374);
   unrolledsPhist_stack_1->SetBinError(1,0.8957301);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,16.0032);
   unrolledsPhist_stack_2->SetBinError(1,2.647241);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,7.208344);
   unrolledsPhist_stack_3->SetBinError(1,1.711131);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,299.4208);
   unrolledsPhist_stack_5->SetBinError(1,10.26578);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,564.6383);
   unrolledsPhist_stack_6->SetBinError(1,18.4474);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,14.0837);
   unrolledsPhist_stack_7->SetBinError(1,0.5526619);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [14.08]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [564.64]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [299.42]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [7.21]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [16.00]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [3.32]","lpf");
