...
// Sat Jan 22 14:55:07 2022 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: TTGJets18.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("TTGJets18.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("TTGJets18.root");
      }
