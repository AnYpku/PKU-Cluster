...
//=========  (Mon Jun  8 04:19:34 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-17.40839,7.4375,116.5023);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(99.4765);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(104.4503);
   ...
   ST_stack_1->SetBinContent(1,0.4839043);
   ST_stack_1->SetBinContent(4,0.1950285);
   ST_stack_1->SetBinError(1,0.3429398);
   ST_stack_1->SetBinError(4,0.1950285);
   ...
   TTA_stack_2->SetBinContent(1,0.5590142);
   TTA_stack_2->SetBinContent(2,0.7712674);
   TTA_stack_2->SetBinContent(3,0.364102);
   TTA_stack_2->SetBinContent(4,0.08155059);
   TTA_stack_2->SetBinContent(5,0.009907822);
   TTA_stack_2->SetBinContent(6,0.1274401);
   TTA_stack_2->SetBinContent(7,0.09460692);
   TTA_stack_2->SetBinError(1,0.6042839);
   TTA_stack_2->SetBinError(2,0.4225252);
   TTA_stack_2->SetBinError(3,0.211217);
   TTA_stack_2->SetBinError(4,0.4053138);
   TTA_stack_2->SetBinError(5,0.1698139);
   TTA_stack_2->SetBinError(6,0.2025558);
   ...
   VV_stack_3->SetBinContent(1,1.161775);
   VV_stack_3->SetBinContent(3,0.3789001);
   VV_stack_3->SetBinContent(4,1.109892);
   VV_stack_3->SetBinContent(5,0.3369724);
   VV_stack_3->SetBinContent(7,0.329818);
   VV_stack_3->SetBinError(1,0.680865);
   VV_stack_3->SetBinError(3,0.3789001);
   VV_stack_3->SetBinError(4,0.6436635);
   VV_stack_3->SetBinError(5,0.3369724);
   ...
   plj_stack_5->SetBinContent(1,12.73099);
   plj_stack_5->SetBinContent(2,1.154105);
   plj_stack_5->SetBinContent(3,0.215966);
   plj_stack_5->SetBinContent(4,25.92853);
   plj_stack_5->SetBinContent(5,8.806801);
   plj_stack_5->SetBinContent(6,1.418142);
   plj_stack_5->SetBinContent(7,17.38);
   plj_stack_5->SetBinError(1,2.065761);
   plj_stack_5->SetBinError(2,0.630863);
   plj_stack_5->SetBinError(3,0.215966);
   plj_stack_5->SetBinError(4,3.057264);
   plj_stack_5->SetBinError(5,1.778412);
   plj_stack_5->SetBinError(6,0.598465);
   ...
   t_ZA_stack_6->SetBinContent(1,26.73934);
   t_ZA_stack_6->SetBinContent(2,6.642584);
   t_ZA_stack_6->SetBinContent(3,2.298715);
   t_ZA_stack_6->SetBinContent(4,37.37084);
   t_ZA_stack_6->SetBinContent(5,12.17012);
   t_ZA_stack_6->SetBinContent(6,3.009829);
   t_ZA_stack_6->SetBinContent(7,23.54903);
   t_ZA_stack_6->SetBinError(1,4.132103);
   t_ZA_stack_6->SetBinError(2,1.79837);
   t_ZA_stack_6->SetBinError(3,1.090551);
   t_ZA_stack_6->SetBinError(4,4.635056);
   t_ZA_stack_6->SetBinError(5,2.651318);
   t_ZA_stack_6->SetBinError(6,1.066974);
   ...
   ZA_sig_stack_7->SetBinContent(1,7.568043);
   ZA_sig_stack_7->SetBinContent(2,6.556235);
   ZA_sig_stack_7->SetBinContent(3,4.673324);
   ZA_sig_stack_7->SetBinContent(4,1.221185);
   ZA_sig_stack_7->SetBinContent(5,3.374066);
   ZA_sig_stack_7->SetBinContent(6,6.312149);
   ZA_sig_stack_7->SetBinContent(7,3.076784);
   ZA_sig_stack_7->SetBinError(1,0.4059713);
   ZA_sig_stack_7->SetBinError(2,0.3784818);
   ZA_sig_stack_7->SetBinError(3,0.3204061);
   ZA_sig_stack_7->SetBinError(4,0.1621625);
   ZA_sig_stack_7->SetBinError(5,0.2693946);
   ZA_sig_stack_7->SetBinError(6,0.3732947);
   ...
   ZA_sigout_stack_8->SetBinContent(1,1.43657);
   ZA_sigout_stack_8->SetBinContent(2,0.4830323);
   ZA_sigout_stack_8->SetBinContent(3,0.2106067);
   ZA_sigout_stack_8->SetBinContent(4,0.4106401);
   ZA_sigout_stack_8->SetBinContent(5,0.465622);
   ZA_sigout_stack_8->SetBinContent(6,0.3466452);
   ZA_sigout_stack_8->SetBinContent(7,0.3800266);
   ZA_sigout_stack_8->SetBinError(1,0.1774572);
   ZA_sigout_stack_8->SetBinError(2,0.1032182);
   ZA_sigout_stack_8->SetBinError(3,0.06679081);
   ZA_sigout_stack_8->SetBinError(4,0.0945339);
   ZA_sigout_stack_8->SetBinError(5,0.09967139);
   ZA_sigout_stack_8->SetBinError(6,0.08696434);
   ...
   TLegendEntry *entry=leg->AddEntry("ZA_sig_stack_7","EWK in fid.[32.78]","lpf");
   ...
   entry=leg->AddEntry("ZA_sigout_stack_8","EWK out fid. [3.73]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("t_ZA_stack_6","ZA [111.78]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("plj_stack_5","non-prompt [67.63]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("VV_stack_3","VV [3.32]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("TTA_stack_2","TTA [2.01]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("ST_stack_1","ST  [0.68]","lpf");
