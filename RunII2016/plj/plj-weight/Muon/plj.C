...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ifstream f1,f2;
//   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/mubarrel/step1/pljweight_down.txt");
//   f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/muendcap/step1/pljweight_down.txt");
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/mubarrel/step1/pljweight_up.txt");
   f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/muendcap/step1/pljweight_up.txt");
//   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/mubarrel/step1/pljweight.txt");
//   f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/muendcap/step1/pljweight.txt");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(lep==13 && fabs(photoneta)>1.566 && fabs(photoneta)<2.5){
	      ...
	      if(photonet>60/*&&  photonet<400*/)  {int i=6;scalef_tmp = scalef_f2[i];}
      }
