...
// Fri May 29 23:03:59 2020 by ROOT version 6.12/07
// from TTree demo/demo
// found on file: ../../../produce/unfold_outZA-EWK.root
//////////////////////////////////////////////////////////
...
//   static constexpr Int_t kMaxpassFilter_duplicateMuon = 1;
   ...
   Double_t        genphiVlep;
   Double_t        genptVlep;
   Double_t        genmassVlep;
   Double_t        genmuon1pt;
   Double_t        genmuon2pt;
   Double_t        genmuon1eta;
   Double_t        genmuon2eta;
   Double_t        genmuon1phi;
   Double_t        genmuon2phi;
   Double_t        genele1pt;
   Double_t        genele2pt;
   Double_t        genele1eta;
   Double_t        genele2eta;
   ...
   Double_t        genjet1e;
   Double_t        genjet2e;
   Double_t        genphotonet;
   Double_t        genphotoneta;
   Double_t        genphotonphi;
   Double_t        gendrj1m1;
   Double_t        gendrj1m2;
   Double_t        gendrj2m1;
   Double_t        gendrj2m2;
   ...
   TBranch        *b_l1_weight;   //!
   TBranch        *b_genyVlep;   //!
   TBranch        *b_genphiVlep;   //!
   TBranch        *b_genptVlep;   //!
   TBranch        *b_genmassVlep;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../produce/unfold_outZA-EWK.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../produce/unfold_outZA-EWK.root");
      }
...
void xx::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("genyVlep", &genyVlep, &b_genyVlep);
   fChain->SetBranchAddress("genphiVlep", &genphiVlep, &b_genphiVlep);
   fChain->SetBranchAddress("genptVlep", &genptVlep, &b_genptVlep);
   fChain->SetBranchAddress("genmassVlep", &genmassVlep, &b_genmassVlep);
   ...
   fChain->SetBranchAddress("gendrjj", &gendrjj, &b_gendrjj);
   fChain->SetBranchAddress("drjj", &drjj, &b_drjj);
   fChain->SetBranchAddress("genlep", &genlep, &b_genlep);
   ...
   fChain->SetBranchAddress("genphotonet", &genphotonet, &b_genphotonet);
   ...
   fChain->SetBranchAddress("gendrj1m1", &gendrj1m1, &b_gendrj1m1);
   fChain->SetBranchAddress("gendrj1m2", &gendrj1m2, &b_gendrj1m2);
   fChain->SetBranchAddress("gendrj2m1", &gendrj2m1, &b_gendrj2m1);
   fChain->SetBranchAddress("gendrj2m2", &gendrj2m2, &b_gendrj2m2);
   fChain->SetBranchAddress("gendrj1e1", &gendrj1e1, &b_gendrj1e1);
   fChain->SetBranchAddress("gendrj1e2", &gendrj1e2, &b_gendrj1e2);
   fChain->SetBranchAddress("gendrj2e1", &gendrj2e1, &b_gendrj2e1);
   fChain->SetBranchAddress("gendrj2e2", &gendrj2e2, &b_gendrj2e2);
   fChain->SetBranchAddress("gendrj1a", &gendrj1a, &b_gendrj1a);
   fChain->SetBranchAddress("gendrj2a", &gendrj2a, &b_gendrj2a);
   fChain->SetBranchAddress("gendrj1l", &gendrj1l, &b_gendrj1l);
   fChain->SetBranchAddress("gendrj2l", &gendrj2l, &b_gendrj2l);
   fChain->SetBranchAddress("gendrj1l2", &gendrj1l2, &b_gendrj1l2);
   fChain->SetBranchAddress("gendrj2l2", &gendrj2l2, &b_gendrj2l2);
   fChain->SetBranchAddress("gendrma1", &gendrma1, &b_gendrma1);
   fChain->SetBranchAddress("gendrma2", &gendrma2, &b_gendrma2);
   fChain->SetBranchAddress("gendrea1", &gendrea1, &b_gendrea1);
   fChain->SetBranchAddress("gendrea2", &gendrea2, &b_gendrea2);
   fChain->SetBranchAddress("genMjj", &genMjj, &b_genMjj);
   fChain->SetBranchAddress("gendetajj", &gendetajj, &b_gendetajj);
   fChain->SetBranchAddress("genzepp", &genzepp, &b_genzepp);
   fChain->SetBranchAddress("gendrla1", &gendrla1, &b_gendrla1);
   fChain->SetBranchAddress("gendrla2", &gendrla2, &b_gendrla2);
   fChain->SetBranchAddress("gendelta_phi", &gendelta_phi, &b_gendelta_phi);
   fChain->SetBranchAddress("genZGmass", &genZGmass, &b_genZGmass);
   Notify();
}
