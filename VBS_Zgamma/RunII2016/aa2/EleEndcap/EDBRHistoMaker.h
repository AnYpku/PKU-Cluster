...
*/		//rochester correction
		...
		if (/*drll>0.3 &&*/ drla>0.7 && drla2>0.7 && lep == 11 && (HLT_Ele1 > 0 || HLT_Ele2>0) && ptlep1 > 25. && ptlep2 > 25. && fabs(etalep1) < 2.5 && fabs(etalep2) < 2.5 && nlooseeles < 3 && nloosemus == 0 && massVlep > 70. && massVlep < 110. && photonet > 20.&& (fabs(photoneta)<2.5&&fabs(photoneta)>1.566) && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && Mjj > 150&&Mjj<400 && ZGmass>100) {
			numbe_out++;
			treename->Fill();
		}
		else
	...
	cout << "after cut: " << numbe_out << "*actualweight" << actualWeight
		<< " result " << sum <<"; yield "<<sum * 35.86<< endl;
