void histo_gen(){
	gStyle->SetOptStat(0);
	TFile*file=new TFile("../../2016/jet1pt/hist_ZA-EWK.root");
	TFile*file1=new TFile("../../2017/jet1pt/hist_ZA-EWK-pweight.root");
	TFile*file2=new TFile("../../2018/jet1pt/hist_ZA-EWK-pweight.root");
	...
	for(int i=0;i<3;i++){
      ...
      for(int i=0;i<3;i++){
          hist1[i]->Add(hist1_17[i],41.52/35.8);
       ...
       fPads2->Draw();
       fPads1->cd();
       hist2[0]->SetTitle("leading jet p_{T}");
       ...
       double Err[4]={0.35,0.23,0.36,0.46};
...
//          hist3[i]->Draw("same hist");
      ...
      fPads2->Update();
      c1[0]->Print("unfold_jet1pt_full.pdf");
