...
cp -f /home/pku/anying/cms/PKU-Cluster/WWg/Significance/vars/data_cards/CR/txt/*1jets*.txt .
years="\
16
_pre16
17
...
do
  ...
  do
    ...
    do
      echo "${y} ${njets} ${var}"
      combineCards.py emu_${y}_${njets}_${var}_*bin*.txt emu_${y}_1jets_${var}_CR_bin* > full${y}_${var}_${njets}_test.txt 
