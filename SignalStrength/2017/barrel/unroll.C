...
//	t_ZA_sig->Scale(lumi);
	...
	t_ZA_sigout->SetFillColor(kRed-7);
	t_ZA_sigout->SetMarkerColor(kRed-7);
        t_ZA_sigout->SetLineColor(kRed-7);
...
//	t_ST->Scale(lumi);
	...
	TFile* f_plj=TFile::Open("./hist_plj.root");
	...
	leg->AddEntry(t_ZA_sigout, "ZA_sigout");
