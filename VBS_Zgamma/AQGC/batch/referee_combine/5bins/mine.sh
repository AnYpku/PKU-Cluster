...
#   echo "$NP1"
   ...
   do
       ...
       text2workspace.py -m 125 all_${year[$j]}.txt -o os_mll_${operator}_${year[$j]}.root -P HiggsAnalysis.CombinedLimit.OneParameterPhysicsModel:my_1d_model --PO range_param=[${lower},${upper}] --PO scaling_filename=./wpwp_${operator}_scaling_refined${year[$j]}.root --X-allow-no-background
#       
