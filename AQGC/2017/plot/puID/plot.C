...
//	latex.DrawLatex(0.21,0.84,"Preliminary");
	...
	latex.SetTextSize(0.04);
	latex.DrawLatex(0.76,0.96,Form("41.52 fb^{-1} (%d TeV)", (beamcomenergytev)));
}

void aa(string a, double limit){
//	setTDRStyle();
	string mu_file="/home/pku/anying/cms/PKU-Cluster/AQGC/2017/muon/paramsets_"+a+"_mu.txt";
	string ele_file="/home/pku/anying/cms/PKU-Cluster/AQGC/2017/ele/paramsets_"+a+"_el.txt";
	ifstream infile_mu;
	ifstream infile_ele;
...
//		weight[i]=1;
	...
	TFile *file1 = new TFile("out_aqgc_mu17.root","R"); 
	...
	TFile *file2 = new TFile("out_aqgc_ele17.root","R");
        file2->cd("");
