...
//=========  (Fri Jun  5 17:19:00 2020) by ROOT version6.06/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-206.1984,1.0625,1379.943);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(1178.277);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(1237.191);
   ...
   TH1D *unrolledsPhist__1 = new TH1D("unrolledsPhist__1","unrolled hist",1,0,1);
   unrolledsPhist__1->SetBinContent(1,2.306743);
   unrolledsPhist__1->SetBinError(1,0.6546295);
   unrolledsPhist__1->SetEntries(1);
   ...
   unrolledsPhist__1->GetXaxis()->SetBinLabel(1,"Mjj 150~500");
   ...
   TH1D *unrolledsPhist__2 = new TH1D("unrolledsPhist__2","unrolled hist",1,0,1);
   unrolledsPhist__2->SetBinContent(1,15.97241);
   unrolledsPhist__2->SetBinError(1,1.572582);
   unrolledsPhist__2->SetEntries(1);
   ...
   TH1D *unrolledsPhist__3 = new TH1D("unrolledsPhist__3","unrolled hist",1,0,1);
   unrolledsPhist__3->SetBinContent(1,3.7719);
   unrolledsPhist__3->SetBinError(1,1.030465);
   unrolledsPhist__3->SetEntries(1);
   ...
   TH1D *unrolledsPhist__4 = new TH1D("unrolledsPhist__4","unrolled hist",1,0,1);
   unrolledsPhist__4->SetEntries(1);
   ...
   TH1D *unrolledsPhist__5 = new TH1D("unrolledsPhist__5","unrolled hist",1,0,1);
   unrolledsPhist__5->SetBinContent(1,212.1677);
   unrolledsPhist__5->SetBinError(1,8.716878);
   unrolledsPhist__5->SetEntries(1);
   ...
   TH1D *unrolledsPhist__6 = new TH1D("unrolledsPhist__6","unrolled hist",1,0,1);
   unrolledsPhist__6->SetBinContent(1,345.5381);
   unrolledsPhist__6->SetBinError(1,7.907508);
   unrolledsPhist__6->SetEntries(1);
   ...
   TH1D *unrolledsPhist__7 = new TH1D("unrolledsPhist__7","unrolled hist",1,0,1);
   unrolledsPhist__7->SetBinContent(1,9.381528);
   unrolledsPhist__7->SetBinError(1,0.3791276);
   unrolledsPhist__7->SetEntries(1);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist","EWK [9.38]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist","ZA [345.54]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","non-prompt [212.17]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","VV [3.77]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","TTA [15.97]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","ST  [2.31]","lpf");
