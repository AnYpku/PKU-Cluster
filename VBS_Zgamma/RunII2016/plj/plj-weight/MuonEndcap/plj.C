...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ifstream f1;
//   f1.open("/afs/cern.ch/work/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/muendcap/step1/pljweight.txt");
//   f1.open("/afs/cern.ch/work/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/muendcap/step1/pljweight_up.txt");
   f1.open("/afs/cern.ch/work/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/muendcap/step1/pljweight_down.txt");
   Double_t scalef_f[7];
   for(Int_t i=0;i<6;i++){
      f1>>scalef_f[i];
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     if(photonet>60/*&&  photonet<400*/) {int i=6;scalef_tmp = scalef_f[i];} 
