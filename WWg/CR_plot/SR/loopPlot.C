...
//		continue;
		...
		TString tag,sample;
		if(fData.at(i).Contains("16")) {tag="16";rc.init("RoccoR2016.txt");lumiValue=35.86; }
		if(fData.at(i).Contains("17")) {tag="17";rc.init("RoccoR2017.txt");lumiValue=41.52; }
		if(fData.at(i).Contains("18")) {tag="18";rc.init("RoccoR2018.txt");lumiValue=59.7; }
...
//		continue;
		...
		TString tag;
		if(fMC.at(i).Contains("16")) {tag="16";rc.init("RoccoR2016.txt"); lumiValue=35.86;}
		if(fMC.at(i).Contains("17")) {tag="17";rc.init("RoccoR2017.txt"); lumiValue=41.52;}
		if(fMC.at(i).Contains("18")) {tag="18";rc.init("RoccoR2018.txt"); lumiValue=59.7; }
...
//		continue;
		...
		TString tag;
		if(fMCSig.at(i).Contains("16")) {tag="16";rc.init("RoccoR2016.txt"); lumiValue=35.86;}
		if(fMCSig.at(i).Contains("17")) {tag="17";rc.init("RoccoR2017.txt"); lumiValue=41.52;}
		if(fMCSig.at(i).Contains("18")) {tag="18";rc.init("RoccoR2018.txt"); lumiValue=59.7; }
