void histo_gen(){
	gStyle->SetOptStat(0);
	TFile*file=new TFile("../../2016/Mjj/hist_ZA-EWK.root");
	TFile*file1=new TFile("../../2017/Mjj/hist_ZA-EWK-pweight.root");
	TFile*file2=new TFile("../../2018/Mjj/hist_ZA-EWK-pweight.root");
...
//          hist3[i]->Draw("same hist");
      ...
      fPads2->Update();
      c1[0]->Print("unfold_Mjj_full.pdf");
