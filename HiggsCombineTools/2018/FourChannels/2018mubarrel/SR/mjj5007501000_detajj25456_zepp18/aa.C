...
//=========  (Mon Jun  8 03:45:10 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-20.28445,7.4375,135.7498);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(115.9111);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(121.7067);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.2057852);
   unrolledsPhist_stack_1->SetBinError(1,0.2057852);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,1.606219);
   unrolledsPhist_stack_2->SetBinContent(2,0.5486748);
   unrolledsPhist_stack_2->SetBinContent(3,0.3743734);
   unrolledsPhist_stack_2->SetBinContent(4,0.7857027);
   unrolledsPhist_stack_2->SetBinContent(5,0.5157959);
   unrolledsPhist_stack_2->SetBinContent(6,0.5293792);
   unrolledsPhist_stack_2->SetBinContent(7,0.2843904);
   unrolledsPhist_stack_2->SetBinError(1,0.7932273);
   unrolledsPhist_stack_2->SetBinError(2,0.4800667);
   unrolledsPhist_stack_2->SetBinError(3,0.2768858);
   unrolledsPhist_stack_2->SetBinError(4,0.3639971);
   unrolledsPhist_stack_2->SetBinError(5,0.3580293);
   unrolledsPhist_stack_2->SetBinError(6,0.3230159);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,0.7880191);
   unrolledsPhist_stack_3->SetBinContent(2,0.6985215);
   unrolledsPhist_stack_3->SetBinContent(7,1.176728);
   unrolledsPhist_stack_3->SetBinError(1,0.5572285);
   unrolledsPhist_stack_3->SetBinError(2,0.4939693);
   ...
   unrolledsPhist_stack_5->SetBinContent(7,30.92296);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,34.58604);
   unrolledsPhist_stack_6->SetBinContent(2,7.714145);
   unrolledsPhist_stack_6->SetBinContent(3,3.048883);
   unrolledsPhist_stack_6->SetBinContent(4,45.08123);
   unrolledsPhist_stack_6->SetBinContent(5,16.90795);
   unrolledsPhist_stack_6->SetBinContent(6,1.734057);
   unrolledsPhist_stack_6->SetBinContent(7,24.67856);
   unrolledsPhist_stack_6->SetBinError(1,4.910492);
   unrolledsPhist_stack_6->SetBinError(2,2.020679);
   unrolledsPhist_stack_6->SetBinError(3,1.191109);
   unrolledsPhist_stack_6->SetBinError(4,5.3625);
   unrolledsPhist_stack_6->SetBinError(5,3.375546);
   unrolledsPhist_stack_6->SetBinError(6,1.347125);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,13.15749);
   unrolledsPhist_stack_7->SetBinContent(2,10.08735);
   unrolledsPhist_stack_7->SetBinContent(3,6.376667);
   unrolledsPhist_stack_7->SetBinContent(4,2.346465);
   unrolledsPhist_stack_7->SetBinContent(5,5.560756);
   unrolledsPhist_stack_7->SetBinContent(6,9.795595);
   unrolledsPhist_stack_7->SetBinContent(7,4.301643);
   unrolledsPhist_stack_7->SetBinError(1,0.5403975);
   unrolledsPhist_stack_7->SetBinError(2,0.4743196);
   unrolledsPhist_stack_7->SetBinError(3,0.3783119);
   unrolledsPhist_stack_7->SetBinError(4,0.2284474);
   unrolledsPhist_stack_7->SetBinError(5,0.3515025);
   unrolledsPhist_stack_7->SetBinError(6,0.4683706);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [51.63]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [133.75]","lpf");
