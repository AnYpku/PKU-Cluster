...
//		if(tag[i].Contains("17")==0) continue;
		...
		TFile*f1=new TFile("unfold_2dgenMjj_recobin7_ewk_pref"+tag[i]+".root");
		TFile*f2=new TFile("unfold_2dgenMjj_recobin8_ewk_pref"+tag[i]+".root");
		TFile*f3=new TFile("unfold_2dgenMjj_recobin9_ewk_pref"+tag[i]+".root");
    
		fout[6][i]=new TFile("unfold_genMjj_recobin7_ewk_pref"+tag[i]+".root","recreate");
		for(int k=0;k<num;k++){
