void run(TString sample,TString tag){
	...
	ifstream f1("./"+sample+"_jer_uncer"+tag+".txt");
	TFile*file1;TFile*file2;TFile*file3;
	if(sample.Contains("WA")==0){
		if(sample.Contains("EWK")){
			file1 = new TFile("./root/hist_16outJEC_"+sample+"_jer16.root");
			file2 = new TFile("./root/hist_17outJEC_"+sample+"_jer17.root");
			file3 = new TFile("./root/hist_18outJEC_"+sample+"_jer18.root");
		}
		else{
			file1=new TFile("./root/hist_"+sample+"_jer16.root");
			file2=new TFile("./root/hist_"+sample+"_jer17.root");
			file3=new TFile("./root/hist_"+sample+"_jer18.root");
		}
	}
