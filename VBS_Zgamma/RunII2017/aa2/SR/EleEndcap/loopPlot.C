...
//		std::cout<<"OK"<<std::endl;
	...
	std::vector<int> fColorsMC;
        ...
        fColorsMC.push_back(kGreen-4);//ST
        fColorsMC.push_back(kGreen-10);//TTA
        fColorsMC.push_back(kBlue - 4);//VV
        fColorsMC.push_back(kBlue - 7);//WA
        fColorsMC.push_back(kOrange - 2);//plj
        fColorsMC.push_back(kRed - 7);//ZA
