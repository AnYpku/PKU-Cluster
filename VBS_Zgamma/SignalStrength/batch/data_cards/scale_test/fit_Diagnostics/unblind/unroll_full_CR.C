...
void run(TString channel){
	...
	TFile*ff1=new TFile("/home/pku/anying/cms/PKU-Cluster/Significance/CR/root/hist_"+par+"_16"+channel+".root");
	TFile*ff2=new TFile("/home/pku/anying/cms/PKU-Cluster/Significance/CR/root/hist_"+par+"_17"+channel+".root");
	TFile*ff3=new TFile("/home/pku/anying/cms/PKU-Cluster/Significance/CR/root/hist_"+par+"_18"+channel+".root");
...
//	fPads1->SetGridx();
	...
	leg1->SetTextSize(0.07);
        ...
        leg1->AddEntry(th2_ZA_sigout,   "EW out fid.");
	...
	latex.SetLineWidth(2);
        ...
        latex.DrawLatex(0.2,1.55*max,c);
	...
	nominal->GetYaxis()->SetRangeUser(0.9,1.15);
	nominal->SetLineColor(2);
	nominal->SetTitle(";m_{jj} [GeV];Data/Pred.;");
	...
	c1->SaveAs("EW_"+channel+"_fid.pdf");
}
int unroll_full_CR(){
