...
f_Data=TFile.Open(fdir+'hist_1D_MuonEG_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_HGC = TFile.Open(fdir+'hist_1D_HGC_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_WWg = TFile.Open(fdir+'hist_1D_WWG_emu_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_ZA = TFile.Open(fdir+'hist_1D_ZGJets_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_plj = TFile.Open(fdir+'hist_1D_plj_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_fakeL = TFile.Open(fdir+'hist_1D_fakeL_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_TTA = TFile.Open(fdir+'hist_1D_TTGJets_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_WA = TFile.Open(fdir+'hist_1D_WGJets_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_VV = TFile.Open(fdir+'hist_1D_VV_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_ST = TFile.Open(fdir+'hist_1D_ST_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_tZq = TFile.Open(fdir+'hist_1D_tZq_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
