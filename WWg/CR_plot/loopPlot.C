...
// Setup names of data files for trees.
	...
	std::cout << "set data imformation, we have " << nMC << "mc file"
		<< std::endl;
        std::string mc[nMC] ={"pljtest","ZZ","WZ","WW","ZGJets","TGJets","TTGJets","WGJets","tZq"};
	...
	std::string mcLabels[nmc] ={"plj","ZZ","WZ","WW","ZGJets","TGJets","TTGJets","WGJets","tZq"};
//	std::string mcLabels[nmc] ={"DY","TTJets","TTWJets","WJets","ZZ","WZ","WW","ZGJets","TGJets","TTGJets","WGJets","tZq"};
	double kFactorsMC_array[nmc] ={1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1};
//	double kFactorsMC_array[nmc] ={lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1,lumiValue1};
	...
	std::vector < std::string > fHistosMCSig;
        std::vector < TString > histName={"m_{ll}","p_{T}^{#gamma}","#eta_{#gamma}","#phi_{#gamma}","p_{T}^{l1}","#eta_{l1}","#phi_{l1}","p_{T}^{l2}","#eta_{l2}","#phi_{l2}","m_{ll#gamma}"};
...
//		continue;
	...
	// ------------------------------------------------------------------  
		...
		fColorsMC.push_back(kYellow+2);
		fColorsMC.push_back(kRed-5);
