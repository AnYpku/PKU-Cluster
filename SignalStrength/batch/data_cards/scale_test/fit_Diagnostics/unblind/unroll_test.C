...
////
        ...
        TLine* vline1 = new TLine(htot->GetBinLowEdge(4),0,htot->GetBinLowEdge(4),max*2.3);
        TLine* vline2 = new TLine(htot->GetBinLowEdge(7),0,htot->GetBinLowEdge(7),max*2.3);
	...
	for(int i=0;i<gr1->GetN();i++){
       ...
       if(channel.Contains("eleendcap"))
                nominal->GetYaxis()->SetRangeUser(0.5,3.0);
