...
int main(){
//        TChain* chain = new TChain("tnpEleIDs/fitter_tree","");
//        chain->Add("/eos/cms/store/group/phys_egamma/swmukher/ntuple_2017_v2/Run*.root");
//        TTree* tdata;
//        tdata = chain;
	TFile* fdata = TFile::Open("/eos/cms/store/group/phys_egamma/swmukher/NtupleForRecoSF/Rereco2018Data_Autumn18MC_AOD/RunABCD.root");
	TDirectory* ddata = (TDirectory*)fdata->Get("tnpEleIDs");
	TTree* tdata = (TTree*)ddata->Get("fitter_tree");
	TFile* fmc = TFile::Open("/eos/cms/store/group/phys_egamma/swmukher/NtupleForRecoSF/Rereco2018Data_Autumn18MC_AOD/DYJetsToLLM50madgraphMLM.root");
