...
//	const char *name[7]={"500~800","800~1200","1200~2000","500~800","800~1200","1200~2000","500~2000"};
	...
	hist_clone->Draw("E2");
        ...
        TLegend*l1=new TLegend(0.4,0.6,0.72,0.88);
	...
	l1->Draw();
        ...
        latex.DrawLatex(1.2,0.12,"2.5<|#Delta#eta_{jj}|<4.5");
        latex.DrawLatex(3.5,0.12,"4.5<|#Delta#eta_{jj}|<6");
        latex.DrawLatex(6.1,0.12,"|#Delta#eta_{jj}|>6");
