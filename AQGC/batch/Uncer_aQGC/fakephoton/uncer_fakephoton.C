...
void run(TString channel){
	...
	TFile* file1 = new TFile("./hist_plj_"+channel+"_16.root");
	TFile* file2 = new TFile("./hist_plj_"+channel+"_17.root");
	TFile* file3 = new TFile("./hist_plj_"+channel+"_18.root");
...
void run_year(TString channel,TString tag){
	ofstream f1("./fake_uncer_"+channel+tag+".txt");
	TFile* file1 = new TFile("./hist_plj_"+channel+"_"+tag+".root");
	TH1D* h1 = (TH1D*)file1->Get("hist");
	TH1D* h2 = (TH1D*)file1->Get("hist_up");
	TH1D* h3 = (TH1D*)file1->Get("hist_down");
