...
public :
   ...
   virtual void     Loop(TH1D*th2,TString name);
...
#ifdef interf_cxx
interf::interf(TTree *tree) : fChain(0) 
{
...
Int_t interf::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t interf::LoadTree(Long64_t entry)
{
...
void interf::Show(Long64_t entry)
{
...
Int_t interf::Cut(Long64_t entry)
{
