...
// Sun Nov  1 06:17:42 2020 by ROOT version 6.22/02
// from TTree ZPKUCandidates/ZPKU Candidates
// found on file: JESR_ZA17.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("JESR_ZA17.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("JESR_ZA17.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("JESR_ZA17.root:/treeDumper");
