...
//=========  (Mon Jan 20 17:41:24 2020) by ROOT version6.06/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-68.75,-54.16909,1056.25,362.5162);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   Double_t xAxis1[3] = {100, 500, 1000}; 
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",2, xAxis1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(325.0145);
   ...
   Double_t xAxis2[3] = {100, 500, 1000}; 
   
   TH1D *hist__1 = new TH1D("hist__1","ST		 100<leading p_{T}^{reco}<1000  reco && gen",2, xAxis2);
   hist__1->SetBinContent(1,0.4526492);
   hist__1->SetBinError(1,0.2613415);
   ...
   hs->Add(hist,"");
   Double_t xAxis3[3] = {100, 500, 1000}; 
   
   TH1D *hist__2 = new TH1D("hist__2","TTA		 100<leading p_{T}^{reco}<1000  reco && gen",2, xAxis3);
   hist__2->SetBinContent(1,4.719451);
   hist__2->SetBinContent(2,0.07521376);
   hist__2->SetBinError(1,0.7927372);
   hist__2->SetBinError(2,0.1255105);
   ...
   hs->Add(hist,"");
   Double_t xAxis4[3] = {100, 500, 1000}; 
   
   TH1D *hist__3 = new TH1D("hist__3","VV		 100<leading p_{T}^{reco}<1000  reco && gen",2, xAxis4);
   hist__3->SetBinContent(1,5.11538);
   hist__3->SetBinContent(2,0.2003533);
   hist__3->SetBinError(1,1.069463);
   hist__3->SetBinError(2,0.2003533);
   ...
   hs->Add(hist,"");
   Double_t xAxis5[3] = {100, 500, 1000}; 
   ...
   hs->Add(hist,"");
   Double_t xAxis6[3] = {100, 500, 1000}; 
   ...
   hs->Add(hist,"");
   Double_t xAxis7[3] = {100, 500, 1000}; 
   
   TH1D *hist__6 = new TH1D("hist__6","ZA		 100<leading p_{T}^{reco}<1000  reco && gen",2, xAxis7);
   hist__6->SetBinContent(1,221.1963);
   hist__6->SetBinContent(2,6.420829);
   hist__6->SetBinError(1,5.988291);
   hist__6->SetBinError(2,1.147814);
   ...
   hs->Add(hist,"");
   Double_t xAxis8[3] = {100, 500, 1000}; 
   
   TH1D *hist__7 = new TH1D("hist__7","ZA-EWK		 100<leading p_{T}^{reco}<1000  reco && gen",2, xAxis8);
   hist__7->SetBinContent(1,64.36493);
   hist__7->SetBinContent(2,4.324467);
   hist__7->SetBinError(1,0.8896275);
   hist__7->SetBinError(2,0.232188);
   ...
   hs->Add(hist,"");
   Double_t xAxis9[3] = {100, 500, 1000}; 
   
   TH1D *hist3__8 = new TH1D("hist3__8","ZA-EWK		 100<leading p_{T}^{reco}<1000 reco out of gen",2, xAxis9);
   hist3__8->SetBinContent(1,6.937076);
   hist3__8->SetBinContent(2,0.2836988);
   hist3__8->SetBinError(1,0.2919555);
   hist3__8->SetBinError(2,0.06189509);
