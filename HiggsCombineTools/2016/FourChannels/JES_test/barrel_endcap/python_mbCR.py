...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016mubarrel/CR/aa.root")
tstack = f_in.Get("hs")
...
pdf_QCD  =[1.02]
scale_QCD=[1.12]
QCDZA_scale_extra_down = [0.998]
QCDZA_scale_extra_up   = [0.999]
pdf_ewk   =[1.04]
scale_ewk =[1.00]
interf =[1.26]
...
jer_VV   =[1.27]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('muon16', 'barrel'),'w')
...
# bin error
   ...
   f.write('VBS_stat_control_%s_%s_bin_%d\tlnN\t%0.2f\t-\t-\t-\t-\t-\t-\n'%('muon16','barrel',i,ZA_sig_binerror))
   f.write('QCD_stat_control_%s_%s_bin_%d\tlnN\t-\t%0.2f\t-\t-\t-\t-\t-\n'%('muon16','barrel',i,ZA_binerror))
   f.write('non_prompt_stat_control_%s_%s_bin_%d\tlnN\t-\t-\t%0.2f\t-\t-\t-\t-\n'%('muon16','barrel',i,non_prompt_binerror))
   f.write('TTA_stat_control_%s_%s_bin_%d\tlnN\t-\t-\t-\t%0.2f\t-\t-\t-\n'%('muon16','barrel',i,TTA_binerror))
   f.write('VV_stat_control_%s_%s_bin_%d\tlnN\t-\t-\t-\t-\t%0.2f\t-\t-\n'%('muon16','barrel',i,VV_binerror))
   f.write('ST_stat_control_%s_%s_bin_%d\tlnN\t-\t-\t-\t-\t-\t%0.2f\t-\n'%('muon16','barrel',i,ST_binerror))
   f.write('WA_stat_control_%s_%s_bin_%d\tlnN\t-\t-\t-\t-\t-\t-\t%0.2f\n'%('muon16','barrel',i,WA_binerror))
