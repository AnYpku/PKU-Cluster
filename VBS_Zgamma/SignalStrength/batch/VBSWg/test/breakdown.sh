...
#     combine -M MultiDimFit --algo grid --points 50 --rMin 0.8 --rMax 2.8 -m 125 -n stat_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeParameters $NP  
     combine -M MultiDimFit --algo grid --points 50 --rMin 0.8 --rMax 2.8 -m 125 -n stat_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeParameters allConstrainedNuisances  
