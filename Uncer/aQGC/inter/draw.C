...
TString dir16="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/aQGC/inter/";
TString dir17="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/aQGC/inter/";
TString dir18="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/aQGC/inter/";

TFile*f16=new TFile(dir16+"2d_"+name1+".root");
TFile*f17=new TFile(dir17+"2d_"+name1+".root");
TFile*f18=new TFile(dir18+"2d_"+name1+".root");
TH1D*h1=(TH1D*)f16->Get("th2");
TH1D*h11=(TH1D*)f17->Get("th2");
TH1D*h111=(TH1D*)f18->Get("th2");


TFile*f2  =new TFile(dir16+"2d_"+name2+".root");
TFile*f22 =new TFile(dir17+"2d_"+name2+".root");
TFile*f222=new TFile(dir18+"2d_"+name2+".root");
TH1D*h2=(TH1D*)f2->Get("th2");
TH1D*h22=(TH1D*)f22->Get("th2");
TH1D*h222=(TH1D*)f222->Get("th2");
