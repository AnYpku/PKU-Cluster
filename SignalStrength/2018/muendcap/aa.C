...
//=========  (Mon Jun  8 04:18:37 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-13.13773,7.4375,87.92175);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(75.07276);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(78.8264);
   ...
   TTA_stack_2->SetBinContent(1,0.778243);
   TTA_stack_2->SetBinContent(2,0.1297072);
   TTA_stack_2->SetBinContent(4,-0.5188287);
   TTA_stack_2->SetBinContent(5,0.1297072);
   TTA_stack_2->SetBinError(1,0.5188287);
   TTA_stack_2->SetBinError(2,0.1297072);
   TTA_stack_2->SetBinError(4,0.3177164);
   TTA_stack_2->SetBinError(5,0.2246594);
   TTA_stack_2->SetBinError(6,0.1834336);
   ...
   VV_stack_3->SetBinContent(1,0.7849641);
   VV_stack_3->SetBinContent(4,0.4163299);
   VV_stack_3->SetBinError(1,0.5560771);
   VV_stack_3->SetBinError(4,0.4163299);
   ...
   plj_stack_5->SetBinContent(1,14.9807);
   plj_stack_5->SetBinContent(2,2.487922);
   plj_stack_5->SetBinContent(3,0.929944);
   plj_stack_5->SetBinContent(4,26.68902);
   plj_stack_5->SetBinContent(5,9.219643);
   plj_stack_5->SetBinContent(6,1.829265);
   plj_stack_5->SetBinContent(7,7.729478);
   plj_stack_5->SetBinError(1,1.846515);
   plj_stack_5->SetBinError(2,0.7505067);
   plj_stack_5->SetBinError(3,0.4652033);
   plj_stack_5->SetBinError(4,2.45948);
   plj_stack_5->SetBinError(5,1.442156);
   plj_stack_5->SetBinError(6,0.6472538);
   ...
   t_ZA_stack_6->SetBinContent(1,25.57218);
   t_ZA_stack_6->SetBinContent(2,4.512738);
   t_ZA_stack_6->SetBinContent(3,0.7521229);
   t_ZA_stack_6->SetBinContent(4,22.56369);
   t_ZA_stack_6->SetBinContent(5,2.256369);
   t_ZA_stack_6->SetBinContent(6,3.384553);
   t_ZA_stack_6->SetBinContent(7,3.760615);
   t_ZA_stack_6->SetBinError(1,3.607055);
   t_ZA_stack_6->SetBinError(2,1.842317);
   t_ZA_stack_6->SetBinError(3,0.5318312);
   t_ZA_stack_6->SetBinError(4,3.944166);
   t_ZA_stack_6->SetBinError(5,2.127325);
   t_ZA_stack_6->SetBinError(6,1.355909);
   ...
   ZA_sig_stack_7->SetBinContent(1,3.705478);
   ZA_sig_stack_7->SetBinContent(2,2.874552);
   ZA_sig_stack_7->SetBinContent(3,1.684308);
   ZA_sig_stack_7->SetBinContent(4,0.7186381);
   ZA_sig_stack_7->SetBinContent(5,2.088542);
   ZA_sig_stack_7->SetBinContent(6,2.245744);
   ZA_sig_stack_7->SetBinContent(7,0.6288083);
   ZA_sig_stack_7->SetBinError(1,0.2884711);
   ZA_sig_stack_7->SetBinError(2,0.2599637);
   ZA_sig_stack_7->SetBinError(3,0.1944871);
   ZA_sig_stack_7->SetBinError(4,0.1270385);
   ZA_sig_stack_7->SetBinError(5,0.2165717);
   ZA_sig_stack_7->SetBinError(6,0.2245744);
   ...
   ZA_sigout_stack_8->SetBinContent(1,0.8533828);
   ZA_sigout_stack_8->SetBinContent(2,0.04491488);
   ZA_sigout_stack_8->SetBinContent(3,0.06737232);
   ZA_sigout_stack_8->SetBinContent(4,0.1796595);
   ZA_sigout_stack_8->SetBinContent(5,0.202117);
   ZA_sigout_stack_8->SetBinContent(6,0.04491488);
   ZA_sigout_stack_8->SetBinContent(7,0.06737232);
   ZA_sigout_stack_8->SetBinError(1,0.138437);
   ZA_sigout_stack_8->SetBinError(2,0.03175962);
   ZA_sigout_stack_8->SetBinError(3,0.03889743);
   ZA_sigout_stack_8->SetBinError(4,0.06351923);
   ZA_sigout_stack_8->SetBinError(5,0.06737232);
   ZA_sigout_stack_8->SetBinError(6,0.03175962);
   ...
   TLegendEntry *entry=leg->AddEntry("ZA_sig_stack_7","EWK in fid.[13.95]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("t_ZA_stack_6","ZA [62.80]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("plj_stack_5","non-prompt [63.87]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("VV_stack_3","VV [1.20]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("TTA_stack_2","TTA [0.52]","lpf");
