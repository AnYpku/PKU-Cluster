...
// Setup names of data files for trees.
	...
	std::cout << "set data imformation, we have " << nDATA << "data file"
			<< std::endl;
	std::string data[nDATA] = { "Ele16","Ele17","Ele18"};
...
//				    "ST18","TTA18","VV18","plj18_weight","ZA18"};
	...
	std::vector < std::string > fHistosMCSig;
        std::vector < TString > histName={"p_{T}^{Z} [GeV]","#eta_{Z}","#phi_{Z}","m_{Z} [GeV]","p_{T}^{#gamma} [GeV]","#eta_{#gamma}","#phi_{#gamma}","#sigma_{i#etai#eta}","#gamma_{nhiso}","#gamma_{chiso}","#gamma_{phoiso}","p_{T}^{l1} [GeV]","#eta_{l1}","#phi_{l1}","p_{T}^{l2} [GeV]","#eta_{l2}","#phi_{l2}","p_{T}^{j1} [GeV]","#eta_{j1}","p_{T}^{j2} [GeV]","#eta_{j2}","m_{jj} [GeV]","m_{Z#gamma} [GeV]","nVtx","Zeppenfeld","#Delta#phi","#Delta#eta_{jj}"};
