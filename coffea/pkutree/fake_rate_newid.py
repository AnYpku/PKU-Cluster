...
HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8 = events['HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8'].array()
HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8 = events['HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8'].array()
HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8 = events['HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8'].array()
HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8 = events['HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8'].array()
...
PuppiMET_sumEt = events['PuppiMET_sumEt'].array()
...
if args.lepton=='muon':
    ...
    puppimt_filter = (PuppiMET_pt[muon_filter] < 20) & (puppimt < 20)
    ...
    puppimt_filter = (PuppiMET_pt[electron_filter] < 20) & (puppimt < 20)
    ...
    pass_filter = tight_elec_sel[loose_elec_sel][electron_filter][all_electron_filter[:,0]]==1
