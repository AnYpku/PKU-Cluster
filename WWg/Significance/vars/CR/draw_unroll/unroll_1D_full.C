...
void unroll_run(TString var,TString njets,TString title){
	...
	th2_TTA->Add(th2_TTA_17,1);th2_TTA->Add(th2_TTA_18,1);th2_TTA->Add(th2_TTA_16pre,1);
        ...
        TFile* f_TT=TFile::Open("../root/hist_1D_TTJets_"+var+"_"+njets+"_16.root");
        TH1D* th2_TT16=(TH1D*)f_TT->Get("hist_bkg");
        TH1D* th2_TT= unroll(th2_TT16,"t_TT");
        TFile* f_TT16pre=TFile::Open("../root/hist_1D_TTJets_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_TT16pre=(TH1D*)f_TT16pre->Get("hist_bkg");
        TH1D* th2_TT_16pre= unroll(th2_TT16pre,"t_TT16pre");
        TFile* f_TT17=TFile::Open("../root/hist_1D_TTJets_"+var+"_"+njets+"_17.root");
        TH1D* th2_TT17=(TH1D*)f_TT17->Get("hist_bkg");
        TH1D* th2_TT_17= unroll(th2_TT17,"t_TT17");
        TFile* f_TT18=TFile::Open("../root/hist_1D_TTJets_"+var+"_"+njets+"_18.root");
...
//        h_up->Draw("EP same");
	...
	c1->Print("aa_CR_1D_"+var+"_"+njets+"_full.pdf");
}
int unroll_1D_full(){
       vector<TString> vars={"mT_puppi"};
       vector<TString> title={"m^{WW}_{T}"};
       vector<TString> njets={"0jets"};
