...
//   nentries=100;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    if(name.Contains("EGamma"))
      ...
      BSL_emu = (channel==1 && lep1_pid==13 && lep2_pid==11 && lep1pt>20 && fabs(lep1eta)<2.4 && lep2pt>20 && fabs(lep2eta)<2.5 && lepton1_isprompt==1 && lepton2_isprompt==1 && (n_loose_ele+n_loose_mu)==2) && HLT_emu && mll>50;
      BSL_ee = (channel==2 && lep1_pid==11 && lep2_pid==11 && lep1pt>20 && fabs(lep1eta)<2.5 && lep2pt>20 && fabs(lep2eta)<2.5 && lepton1_isprompt==1 && lepton2_isprompt==1 && (n_loose_ele+n_loose_mu)==2) && HLT_ee;
      BSL_mumu = (channel==3 && lep1_pid==13 && lep2_pid==13 && lep1pt>20 && fabs(lep1eta)<2.4 && lep2pt>20 && fabs(lep2eta)<2.4 && lepton1_isprompt==1 && lepton2_isprompt==1 && (n_loose_ele+n_loose_mu)==2) && HLT_mm;
