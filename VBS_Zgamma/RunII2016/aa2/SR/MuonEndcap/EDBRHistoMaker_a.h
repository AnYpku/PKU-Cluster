...
// mc
	...
	cout << "after cut: " << numbe_out << "; actualweight" << actualWeight<<"; theWeight>0 "<<npp<<"; theWeight<0 "<<nmm<<"; (npp-nmm) = "<<npp-nmm<<"; yields = "<<(npp-nmm)*scalef*35.86<<endl;
		cout<< " result " << sum <<"; yields "<<sum*35.86<<endl;
	this->saveAllHistos(outFileName);
}
