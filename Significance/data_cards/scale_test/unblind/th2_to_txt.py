...
fdir = '/home/pku/anying/cms/PKU-Cluster/Significance/root/'
...
if sys.argv[2].find("ele") == -1:
   f_Data=TFile.Open(fdir+'hist_Muon_'+sys.argv[1]+sys.argv[2]+'.root')
else:
   f_Data=TFile.Open(fdir+'hist_Ele_'+sys.argv[1]+sys.argv[2]+'.root')
...
#   f.write('%0.3f\t%0.3f\t-\t%0.3f\t%0.3f\t%0.3f\n'%(arr['pu_ZA-EWK'][i-1],arr['pu_ZA-EWK'][i-1],arr['pu_ZA-EWK'][i-1],arr['pu_ZA-EWK'][i-1],arr['pu_ZA-EWK'][i-1]))
#
