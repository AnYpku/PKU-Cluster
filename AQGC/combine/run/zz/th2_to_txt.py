...
for i in range(1,7):
   f = open('./txt/%s_bin_%d.txt'%('chAll', i),'w')
   f.write('imax 1   number of channels\n')
   f.write('jmax 2   number of processes-1\n')
   f.write('kmax 4  number of nuisance parameters (sources of systematical uncertainties)\n')
   f.write('------------\n')
