...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2018/FourChannels/2018mubarrel/SR/CR/aa.root")
tstack = f_in.Get("hs")
...
jer_VV   =[1.05]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('muon18', 'barrel'),'w')
