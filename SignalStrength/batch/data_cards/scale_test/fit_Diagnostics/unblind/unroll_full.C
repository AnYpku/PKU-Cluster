...
void run(TString channel){
	...
	th2_ZA_sig->SetMarkerStyle(21);
        ...
        TH1F*th2_ZA_sig_out  =(TH1F*)f1->Get("hist_Sig_out_"+channel);
        TH1F*th2_ZA_sig_out17=(TH1F*)f2->Get("hist_Sig_out_"+channel);
        TH1F*th2_ZA_sig_out18=(TH1F*)f3->Get("hist_Sig_out_"+channel);
        th2_ZA_sig_out->Add(th2_ZA_sig_out17,1);
        th2_ZA_sig_out->Add(th2_ZA_sig_out18,1);

	th2_ZA_sig_out->SetFillColor(kMagenta+0);
	th2_ZA_sig_out->SetMarkerColor(kMagenta+0);
        th2_ZA_sig_out->SetLineColor(kMagenta+0);
	th2_ZA_sig_out->SetMarkerStyle(21);
...
//      TLine* line = new TLine(th2_ZA->GetXaxis()->GetXmin(),0,th2_ZA->GetXaxis()->GetXmax(),0);
	...
	leg->AddEntry(th2_ZA_sig_out,Form("EWK_{out}[%.1f] ",th2_ZA_sig_out->GetSum()) );
...
//	cmsLumi(0);
	...
	if(channel.Contains("eleendcap"))
                nominal->GetYaxis()->SetRangeUser(0.5,2.5);
