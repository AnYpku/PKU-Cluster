...
//=========  (Mon Apr 27 15:58:34 2020) by ROOT version6.06/01
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-5.021546,7.4375,33.60573);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(28.69455);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(30.12927);
   ...
   unrolledsPhist__1->SetBinContent(5,0.1753234);
   unrolledsPhist__1->SetBinError(5,0.1753234);
   ...
   unrolledsPhist__2->SetBinContent(1,0.5995905);
   unrolledsPhist__2->SetBinContent(3,-0.08708948);
   unrolledsPhist__2->SetBinContent(4,-0.0841853);
   unrolledsPhist__2->SetBinContent(5,0.08281091);
   unrolledsPhist__2->SetBinContent(6,0.1645107);
   unrolledsPhist__2->SetBinError(1,0.3452661);
   unrolledsPhist__2->SetBinError(3,0.1453072);
   unrolledsPhist__2->SetBinError(4,0.1452841);
   unrolledsPhist__2->SetBinError(5,0.08281091);
   unrolledsPhist__2->SetBinError(6,0.1163283);
   ...
   unrolledsPhist__3->SetBinContent(1,0.5391355);
   unrolledsPhist__3->SetBinError(1,0.5391355);
   ...
   unrolledsPhist__5->SetBinContent(1,6.505658);
   unrolledsPhist__5->SetBinContent(2,1.754325);
   unrolledsPhist__5->SetBinContent(3,0.522884);
   unrolledsPhist__5->SetBinContent(4,8.10133);
   unrolledsPhist__5->SetBinContent(5,3.69077);
   unrolledsPhist__5->SetBinContent(6,0.532774);
   unrolledsPhist__5->SetBinContent(7,5.347122);
   unrolledsPhist__5->SetBinError(1,1.262135);
   unrolledsPhist__5->SetBinError(2,0.666587);
   unrolledsPhist__5->SetBinError(3,0.369801);
   unrolledsPhist__5->SetBinError(4,1.438173);
   unrolledsPhist__5->SetBinError(5,0.9589966);
   unrolledsPhist__5->SetBinError(6,0.3767281);
   ...
   unrolledsPhist__6->SetBinContent(1,9.767909);
   unrolledsPhist__6->SetBinContent(2,3.113889);
   unrolledsPhist__6->SetBinContent(3,0.5028444);
   unrolledsPhist__6->SetBinContent(4,7.456682);
   unrolledsPhist__6->SetBinContent(5,3.469784);
   unrolledsPhist__6->SetBinContent(6,1.335298);
   unrolledsPhist__6->SetBinContent(7,3.676679);
   unrolledsPhist__6->SetBinError(1,1.325051);
   unrolledsPhist__6->SetBinError(2,0.671852);
   unrolledsPhist__6->SetBinError(3,0.3060315);
   unrolledsPhist__6->SetBinError(4,1.36706);
   unrolledsPhist__6->SetBinError(5,0.8244485);
   unrolledsPhist__6->SetBinError(6,0.4386473);
   ...
   unrolledsPhist__7->SetBinContent(1,2.37705);
   unrolledsPhist__7->SetBinContent(2,1.967897);
   unrolledsPhist__7->SetBinContent(3,1.404921);
   unrolledsPhist__7->SetBinContent(4,0.6995321);
   unrolledsPhist__7->SetBinContent(5,1.332343);
   unrolledsPhist__7->SetBinContent(6,2.733629);
   unrolledsPhist__7->SetBinContent(7,1.645765);
   unrolledsPhist__7->SetBinError(1,0.1707142);
   unrolledsPhist__7->SetBinError(2,0.1551726);
   unrolledsPhist__7->SetBinError(3,0.1316159);
   unrolledsPhist__7->SetBinError(4,0.09269019);
   unrolledsPhist__7->SetBinError(5,0.1276529);
   unrolledsPhist__7->SetBinError(6,0.183137);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist","EWK [12.16]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist","ZA [29.32]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","non-prompt [26.45]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","VV [0.54]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","TTA [0.68]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist","ST  [0.18]","lpf");
