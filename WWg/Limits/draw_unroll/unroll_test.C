...
//	const char *name[16]={"60-100","100-115","115-135","135-#infty","60-100","100-115","115-135","135-#infty","60-100","100-115","115-135","135-#infty","60-100","100-115","115-135","135-#infty"};
	...
	TFile* f_WWG=TFile::Open("../root/hist_WWG_emu_"+var+"_"+njets+"_"+tag+".root");
	...
	TFile* f_HGC_sig=TFile::Open("../root/hist_HGC_"+var+"_"+njets+"_"+tag+".root");
...
int unroll_test(){
       ...
       vector<TString> var={"drll"};
       vector<TString> njets={"0jets","1jets","totaljets"};
       ...
       for(int j=2;j<tags.size();j++){
	       for(int i=0;i<var.size();i++){
		       for(int k=0;k<njets.size();k++){
			       if(njets[k]=="0jets") mT_bins={50,80,120,160};
			       else if(njets[k]=="1jets") mT_bins={50,100,160};
			       else mT_bins={50,80,120,160};
