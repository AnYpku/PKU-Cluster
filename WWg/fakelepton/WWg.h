...
// Fri Jun 25 01:20:36 2021 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: WJets18_fakerate.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[182];   //[nGenPart]
   Float_t         GenPart_mass[182];   //[nGenPart]
   Float_t         GenPart_phi[182];   //[nGenPart]
   Float_t         GenPart_pt[182];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[182];   //[nGenPart]
   Int_t           GenPart_pdgId[182];   //[nGenPart]
   Int_t           GenPart_status[182];   //[nGenPart]
   Int_t           GenPart_statusFlags[182];   //[nGenPart]
   ...
   Float_t         Jet_chFPV1EF[34];   //[nJet]
   Float_t         Jet_chFPV2EF[34];   //[nJet]
   Float_t         Jet_chFPV3EF[34];   //[nJet]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("WJets18_fakerate.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("WJets18_fakerate.root");
      }
