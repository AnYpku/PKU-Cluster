...
#input_filename_e = '/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/combine/el-muon-combine/bins/paramsets_'+sys.argv[1]+'.txt'
input_filename_m = '/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/combine/el-muon-combine/bins/paramsets_'+sys.argv[1]+'.txt'
...
#	hists[l_num+6].Write()#the last six histos are electron channel ZGmass bins
