...
if sys.argv[4].find("combine")==-1:
   input_filename_e = '/home/pku/anying/cms/PKU-Cluster/AQGC/batch/fit/txt/referee/paramsets_'+sys.argv[1]+'_ele'+sys.argv[4]+'.txt'
   input_filename_m = '/home/pku/anying/cms/PKU-Cluster/AQGC/batch/fit/txt/referee/paramsets_'+sys.argv[1]+'_muon'+sys.argv[4]+'.txt'
else:
   input_filename_e = '/home/pku/anying/cms/PKU-Cluster/AQGC/batch/fit/txt/referee/paramsets_'+sys.argv[1]+'_ele.txt'
   input_filename_m = '/home/pku/anying/cms/PKU-Cluster/AQGC/batch/fit/txt/referee/paramsets_'+sys.argv[1]+'_mu.txt'
