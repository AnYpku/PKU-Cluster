...
//TFile* f1 = new TFile("./plj-hist/cutla-outDMuon_pljnew_hb.root");
...
void open(Int_t i){
    ...
    ifstream f1;
    f1.open(Form("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2017/MakeTemplate/With_sieieCorr/EndcapMuon/ZAfit/fractionfitResult_za/txt/fakerate_photon_pt%0.f_%0.f.txt",lowpt[i],highpt[i]));
//    f1.open(Form("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2017/MakeTemplate/With_sieieCorr/EndcapMuon/ZAfit/txt/fakerate_photon_pt%0.f_%0.f.txt",lowpt[i],highpt[i]));
