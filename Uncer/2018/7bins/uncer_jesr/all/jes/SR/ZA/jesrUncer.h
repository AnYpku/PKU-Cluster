...
// Thu Jul 30 23:40:45 2020 by ROOT version 6.06/09
// from TTree ZPKUCandidates/ZPKU Candidates
// found on file: cutla-outZA-JESR.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("cutla-outZA-JESR.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("cutla-outZA-JESR.root");
      }
