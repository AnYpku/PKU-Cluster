...
TFile* ffake = TFile::Open("/data/pubfs/pku_visitor/public_write/fakephoton_hist/Fake_template-DMuon18.root");
TFile* fdata = TFile::Open("/data/pubfs/pku_visitor/public_write/fakephoton_hist/Data_template-DMuon18.root");
TFile* ftrue = TFile::Open("/data/pubfs/pku_visitor/public_write/fakephoton_hist/True_template-ZA-EWK18.root");
TString name;
