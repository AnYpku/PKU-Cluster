...
fx=open('/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/2016/run/combine/test/'+sys.argv[1]+'/list_point_'+sys.argv[1]+'.txt')
num=0
x=[]
xerr=[]
data=[]
...
for line in fx:
  print num, line
  filename = '/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/2016/run/combine/test/'+sys.argv[1]+'/out/condor-'+sys.argv[1]+'.'+sys.argv[2]+'.'+str(num)+'.out'
