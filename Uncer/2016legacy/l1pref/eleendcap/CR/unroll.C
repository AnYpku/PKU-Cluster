...
//	Double_t detajj_bins[2]={2.5,6.5};
	const char *name[2]={"Mjj 150~500"};
//	const char *name[6]={"Mjj 500~800","Mjj 800~1200","Mjj 1200~2000","Mjj 500~800","Mjj 800~1200","Mjj 1200~2000"};

	TFile* f_ZA=TFile::Open(filename+".root");
...
//        t_ZA[i]->DrawNormalized("HIST");
        if(i==0) ll[i]->AddEntry(t_ZA[i],"prefiring norminal");
        else if(i==1)    ll[i]->AddEntry(t_ZA[i],"prefiring up");
        else if(i==2)    ll[i]->AddEntry(t_ZA[i],"prefiring down");
        ll[i]->Draw();
...
//          t_ZA[i]->Scale(scale_factor[i]);
          ...
          t_ZA[i]->Draw("HIST,SAME");
          if(i==0)         l2->AddEntry(t_ZA[i],"prefiring norminal");
          else if(i==1)    l2->AddEntry(t_ZA[i],"prefiring up");
          else if(i==2)    l2->AddEntry(t_ZA[i],"prefiring down");
