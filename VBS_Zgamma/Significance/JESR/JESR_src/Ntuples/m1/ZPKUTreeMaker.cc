...
//		EffectiveAreas effAreaPhotons_;
		...
		double jet1pt_unc_up[40],   jet1pt_unc_down[40];
		double jet1eta_unc_up[40],  jet1eta_unc_down[40];
		double jet1phi_unc_up[40],  jet1phi_unc_down[40];
		double jet1e_unc_up[40],    jet1e_unc_down[40];
		double jet2pt_unc_up[40],   jet2pt_unc_down[40];
		double jet2eta_unc_up[40],  jet2eta_unc_down[40];
		double jet2phi_unc_up[40],  jet2phi_unc_down[40];
		double jet2e_unc_up[40],    jet2e_unc_down[40];
...
//	outTree_->Branch("HLT_Mu8"   ,&HLT_Mu8  ,"HLT_Mu8/I"  );
	...
	outTree_->Branch("lep2_sign"      ,&lep2_sign     ,"lep2_sign/I"     );
        ...
        outTree_->Branch("jet1pt_unc_up",  jet1pt_unc_up  ,"jet1pt_unc_up[40]/D"  );
        outTree_->Branch("jet1eta_unc_up", jet1eta_unc_up ,"jet1eta_unc_up[40]/D"  );
        outTree_->Branch("jet1phi_unc_up", jet1phi_unc_up ,"jet1phi_unc_up[40]/D"  );
        outTree_->Branch("jet1e_unc_up",   jet1e_unc_up   ,"jet1e_unc_up[40]/D"  );
        outTree_->Branch("jet2pt_unc_up",  jet2pt_unc_up  ,"jet2pt_unc_up[40]/D"  );
        outTree_->Branch("jet2eta_unc_up", jet2eta_unc_up ,"jet2eta_unc_up[40]/D"  );
        outTree_->Branch("jet2phi_unc_up", jet2phi_unc_up ,"jet2phi_unc_up[40]/D"  );
        outTree_->Branch("jet2e_unc_up",   jet2e_unc_up   ,"jet2e_unc_up[40]/D"  );

        outTree_->Branch("jet1pt_unc_down",  jet1pt_unc_down  ,"jet1pt_unc_down[40]/D"  );
        outTree_->Branch("jet1eta_unc_down", jet1eta_unc_down ,"jet1eta_unc_down[40]/D"  );
        outTree_->Branch("jet1phi_unc_down", jet1phi_unc_down ,"jet1phi_unc_down[40]/D"  );
        outTree_->Branch("jet1e_unc_down",   jet1e_unc_down   ,"jet1e_unc_down[40]/D"  );
        outTree_->Branch("jet2pt_unc_down",  jet2pt_unc_down  ,"jet2pt_unc_down[40]/D"  );
        outTree_->Branch("jet2eta_unc_down", jet2eta_unc_down ,"jet2eta_unc_down[40]/D"  );
        outTree_->Branch("jet2phi_unc_down", jet2phi_unc_down ,"jet2phi_unc_down[40]/D"  );
        outTree_->Branch("jet2e_unc_down",   jet2e_unc_down   ,"jet2e_unc_down[40]/D"  );
}
...
//        Int_t jetindexphoton12_JER_down_f[2] = {-1,-1};
        Int_t jetindex_unc_up[40][2];
        Int_t jetindex_unc_down[40][2];
        for(int i=0;i<40;i++){
		for(int j=0;j<2;j++){
	...
	for(size_t i=0;i<jecAK4chs_source_.size();i++){
		...
		for (size_t ik=0; ik<ak4jets->size();ik++)
		{
			...
			if((*ak4jets)[ik].userFloat(jecAK4chs_source_[i]+"_Ptup")>tmpjetptcut) {
             ...
             jetindex_unc_down[i][0]=getjetindex2(jets_unc_down,iphoton,photoneta,photonphi);
