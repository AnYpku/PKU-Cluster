...
//=========  (Sun Jan 19 23:21:27 2020) by ROOT version6.06/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-55.78319,1.0625,373.3183);
   pad1->SetFillColor(0);
   ...
   hs_stack_1->SetMaximum(334.6991);
   ...
   ST__1->SetBinContent(1,0.601963);
   ST__1->SetBinError(1,0.3313462);
   ST__1->SetEntries(1);
   ...
   TTA__2->SetBinContent(1,4.569269);
   TTA__2->SetBinError(1,0.7325731);
   TTA__2->SetEntries(1);
   ...
   VV__3->SetBinContent(1,4.062413);
   VV__3->SetBinError(1,1.047609);
   VV__3->SetEntries(1);
   ...
   plj__5->SetBinContent(1,142.9253);
   plj__5->SetBinError(1,5.74004);
   plj__5->SetEntries(1);
   ...
   t_ZA__6->SetBinContent(1,163.0344);
   t_ZA__6->SetBinError(1,5.511333);
   ...
   ZA_sig__7->SetBinContent(1,3.567749);
   ZA_sig__7->SetBinError(1,0.2304815);
