...
//=========  (Tue Jan 21 11:44:32 2020) by ROOT version6.06/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-114.375,-45.22614,848.125,302.6672);
   pad1->SetFillColor(0);
   ...
   hs_stack_1->SetMaximum(271.3568);
   ...
   hist__1->SetBinContent(1,0.1761122);
   hist__1->SetBinContent(2,0.1738181);
   hist__1->SetBinContent(3,0.1741633);
   hist__1->SetBinError(1,0.1761122);
   hist__1->SetBinError(2,0.1738181);
   hist__1->SetBinError(3,0.1741633);
   ...
   hist__2->SetBinContent(1,3.423652);
   hist__2->SetBinContent(2,1.93956);
   hist__2->SetBinContent(3,0.1358471);
   hist__2->SetBinContent(4,0.05237657);
   hist__2->SetBinError(1,0.7232218);
   hist__2->SetBinError(2,0.5001598);
   hist__2->SetBinError(3,0.2590465);
   hist__2->SetBinError(4,0.1525443);
   ...
   hist__3->SetBinContent(1,5.352087);
   hist__3->SetBinContent(2,0.2654232);
   hist__3->SetBinContent(3,0.2715567);
   hist__3->SetBinContent(4,0.2656805);
   hist__3->SetBinError(1,1.171465);
   hist__3->SetBinError(2,0.2654232);
   hist__3->SetBinError(3,0.2715567);
   hist__3->SetBinError(4,0.2656805);
   ...
   hist__5->SetBinContent(1,6.751822);
   hist__5->SetBinError(1,1.440991);
   ...
   hist__6->SetBinContent(1,201.3503);
   hist__6->SetBinContent(2,44.5357);
   hist__6->SetBinContent(3,13.03433);
   hist__6->SetBinContent(4,4.623049);
   hist__6->SetBinError(1,6.272997);
   hist__6->SetBinError(2,2.723445);
   hist__6->SetBinError(3,1.481085);
   hist__6->SetBinError(4,0.9368993);
   ...
   hist__7->SetBinContent(1,36.1607);
   hist__7->SetBinContent(2,27.72507);
   hist__7->SetBinContent(3,10.0887);
   hist__7->SetBinContent(4,5.556598);
   hist__7->SetBinError(1,0.7154379);
   hist__7->SetBinError(2,0.6289033);
   hist__7->SetBinError(3,0.3801478);
   hist__7->SetBinError(4,0.2852675);
   ...
   hist3__8->SetBinContent(1,5.220425);
   hist3__8->SetBinContent(2,1.976509);
   hist3__8->SetBinContent(3,0.7383379);
   hist3__8->SetBinContent(4,0.4252019);
   hist3__8->SetBinError(1,0.272599);
   hist3__8->SetBinError(2,0.1677167);
   hist3__8->SetBinError(3,0.1045659);
   hist3__8->SetBinError(4,0.07766191);
