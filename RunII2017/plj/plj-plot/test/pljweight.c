...
//TFile* f1 = new TFile("./plj-hist/cutlaj-outpljnew_hb.root");
//TFile* f2 = new TFile("./plj-hist/cutlaj-outDMuon_hb.root");
TFile* f1 = new TFile("./plj-hist/cutlaj-outplj_he.root");
TFile* f2 = new TFile("./plj-hist/cutlaj-outDMuon_he.root");
TFile* f3 = new TFile("./plj-hist/cutlaj-outZA_plj_he.root");
 
TH1F* h1 = (TH1F*)f1->Get("h_cutlaj-outplj");
TH1F* h2 = (TH1F*)f2->Get("h_cutlaj-outDMuon");
TH1D* h3 = (TH1D*)f3->Get("h_cutlaj-outZA_plj");
