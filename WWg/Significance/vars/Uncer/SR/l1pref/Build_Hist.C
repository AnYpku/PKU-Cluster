...
void run(TString dir,TString name,TString cut,TString tag){
     ...
     tree->SetBranchAddress("PrefireWeight_Down", &PrefireWeight_Down);
...
//   vector<Double_t> mllg_bins   ={40,100,150,200,300};
     ...
     for(int i=0;i<tree->GetEntries();i++){
		...
		h2[1]->Fill(mT,mll,actualWeight*PrefireWeight_Up/PrefireWeight);
		h2[2]->Fill(mT,mll,actualWeight*PrefireWeight_Down/PrefireWeight);
	     }
