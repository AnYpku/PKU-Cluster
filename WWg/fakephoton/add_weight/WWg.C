...
void WWg::Loop(TString name,TString year)
{
   ...
   TFile*fout=new TFile("hist_MCprompt_"+year+name,"recreate");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      actualWeight=scalef*ele_id_scale*ele_reco_scale*muon_id_scale*muon_iso_scale*photon_id_scale*photon_veto_scale*puWeight*lumi*btag_weight*PrefireWeight;
