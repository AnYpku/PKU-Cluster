...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016elebarrel/CR/aa.root")
tstack = f_in.Get("hs")
...
jer_VV   =[1.27]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('ele16', 'barrel'),'w')
