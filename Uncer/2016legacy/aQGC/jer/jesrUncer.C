...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for(int i=0;i<3;i++){
	   th2[i] = new TH1D(Form("th2_%d",i),"ZGmass",6,ZGammabins);
	   th2[i]->Sumw2();
   }
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	   ...
	   if(  !( ( drla>0.7 && drla2>0.7 && lep == 13 && (HLT_Mu2>0||HLT_Mu5 > 0) && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep > 70. && massVlep < 110. && photonet > 100.&&( (fabs(photoneta) < 1.4442) || (fabs(photoneta)>1.566&&fabs(photoneta)<2.5)) )||
