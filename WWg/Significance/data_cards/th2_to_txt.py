...
f_EW = TFile.Open(fdir+'hist_WWG_'+sys.argv[1]+'.root')
...
# bin error
   ...
   data= ZA_sig_bincontent + ZA_bincontent+non_prompt_bincontent+fakeL_bincontent+TTA_bincontent+VV_bincontent+ST_bincontent
