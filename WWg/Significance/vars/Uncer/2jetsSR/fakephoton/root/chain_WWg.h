...
void chain_WWg::Init(TTree *tree)
{
   ...
   ExTree->Branch("ptlep1",&ptlep1,"ptlep1/F");
   ExTree->Branch("ptlep2",&ptlep2,"ptlep2/F");
   ExTree->Branch("HLT_emu1", &HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ, "HLT_emu1/B");
   ExTree->Branch("HLT_emu2", &HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL, "HLT_emu2/B");
   ExTree->Branch("HLT_emu3", &HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL, "HLT_emu3/B");
   ExTree->Branch("HLT_emu4", &HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ, "HLT_emu4/B");
   ...
   fChain->SetBranchAddress("scalef_up", &scalef_up, &b_scalef_up);
   fChain->SetBranchAddress("scalef_down", &scalef_down, &b_scalef_down);
   fChain->SetBranchAddress("mT", &mT, &b_mT);
