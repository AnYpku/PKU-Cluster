...
//	th2_ZA_sig->Scale(lumi);
	...
	th2_ZA_sigout->SetFillColor(kMagenta+0);
	th2_ZA_sigout->SetMarkerColor(kMagenta+0);
	th2_ZA_sigout->SetLineColor(kMagenta+0);
//	th2_ZA_sigout->Scale(lumi);
	th2_ZA_sigout->SetMarkerStyle(21);
	cout<<tag<<" "<<channel<<" EWK out yields "<<th2_ZA_sigout->GetBinContent(1)<<" "<<th2_ZA_sigout->GetBinContent(2)<<" "<<th2_ZA_sigout->GetBinContent(3)<<endl;
