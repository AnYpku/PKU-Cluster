...
qcd="jes_QCD=[1.46, 1.65, 1.63, 1.46, 1.65, 1.63,1.53 ]" #1d
ewk="jes=[1.02, 1.02, 1.10, 1.02, 1.02, 1.10,1.04]" #1d
#ewk="jes=[1.01,1.05,1.13,1.09,1.01,1.10,1.06]" #2d
#qcd="jes_QCD=[1.21,1.27,1.37,1.52,1.49,1.42,2.05]" #2d
run 
