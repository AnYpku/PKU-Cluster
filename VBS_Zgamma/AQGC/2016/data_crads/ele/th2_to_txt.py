...
fake=[1.411,1.400,1.000,1.000,1.342]
...
for i in range(1,6):
   f = open('./txt/%s_bin_%d.txt'%('ele16', i),'w')
...
# bin error
   ...
   f.write('------------\n')
   f.write('lumi16\tlnN\t1.02\t1.02\t-\t1.02\t#lumi\n')
