...
//=========  (Fri Jun  5 17:44:54 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-140.3474,1.0625,939.2477);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(801.9849);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(842.0841);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.2253792);
   unrolledsPhist_stack_1->SetBinError(1,0.2253792);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,7.655231);
   unrolledsPhist_stack_2->SetBinError(1,1.239877);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,7.110535);
   unrolledsPhist_stack_3->SetBinError(1,1.750593);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,169.5703);
   unrolledsPhist_stack_5->SetBinError(1,6.395624);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,211.0151);
   unrolledsPhist_stack_6->SetBinError(1,11.46273);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,5.415899);
   unrolledsPhist_stack_7->SetBinError(1,0.3534516);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [5.42]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [211.02]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [169.57]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [7.11]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [7.66]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.23]","lpf");
