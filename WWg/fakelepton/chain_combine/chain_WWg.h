...
// Sun Feb  6 21:22:09 2022 by ROOT version 6.14/09
// from TChain Events/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         CorrT1METJet_area[48];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[48];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[48];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[48];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawPt[48];   //[nCorrT1METJet]
   ...
   UInt_t          nIsoTrack;
   Float_t         IsoTrack_dxy[18];   //[nIsoTrack]
   Float_t         IsoTrack_dz[18];   //[nIsoTrack]
   Float_t         IsoTrack_eta[18];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[18];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[18];   //[nIsoTrack]
   Float_t         IsoTrack_phi[18];   //[nIsoTrack]
   Float_t         IsoTrack_pt[18];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[18];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[18];   //[nIsoTrack]
   Int_t           IsoTrack_charge[18];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[18];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[18];   //[nIsoTrack]
   Bool_t          IsoTrack_isHighPurityTrack[18];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[18];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[18];   //[nIsoTrack]
   UInt_t          nJet;
   Float_t         Jet_area[46];   //[nJet]
   Float_t         Jet_btagCSVV2[46];   //[nJet]
   Float_t         Jet_btagDeepB[46];   //[nJet]
   Float_t         Jet_btagDeepCvB[46];   //[nJet]
   Float_t         Jet_btagDeepCvL[46];   //[nJet]
   Float_t         Jet_btagDeepFlavB[46];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[46];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[46];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[46];   //[nJet]
   Float_t         Jet_chEmEF[46];   //[nJet]
   Float_t         Jet_chFPV0EF[46];   //[nJet]
   Float_t         Jet_chHEF[46];   //[nJet]
   Float_t         Jet_eta[46];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[46];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[46];   //[nJet]
   Float_t         Jet_mass[46];   //[nJet]
   Float_t         Jet_muEF[46];   //[nJet]
   Float_t         Jet_muonSubtrFactor[46];   //[nJet]
   Float_t         Jet_neEmEF[46];   //[nJet]
   Float_t         Jet_neHEF[46];   //[nJet]
   Float_t         Jet_phi[46];   //[nJet]
   Float_t         Jet_pt[46];   //[nJet]
   Float_t         Jet_puIdDisc[46];   //[nJet]
   Float_t         Jet_qgl[46];   //[nJet]
   Float_t         Jet_rawFactor[46];   //[nJet]
   Float_t         Jet_bRegCorr[46];   //[nJet]
   Float_t         Jet_bRegRes[46];   //[nJet]
   Float_t         Jet_cRegCorr[46];   //[nJet]
   Float_t         Jet_cRegRes[46];   //[nJet]
   Int_t           Jet_electronIdx1[46];   //[nJet]
   Int_t           Jet_electronIdx2[46];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[46];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[46];   //[nJet]
   Int_t           Jet_jetId[46];   //[nJet]
   Int_t           Jet_muonIdx1[46];   //[nJet]
   Int_t           Jet_muonIdx2[46];   //[nJet]
   Int_t           Jet_nElectrons[46];   //[nJet]
   Int_t           Jet_nMuons[46];   //[nJet]
   Int_t           Jet_puId[46];   //[nJet]
   UChar_t         Jet_nConstituents[46];   //[nJet]
   ...
   Float_t         Proton_multiRP_t[11];   //[nProton_multiRP]
   Float_t         Proton_multiRP_thetaX[11];   //[nProton_multiRP]
   Float_t         Proton_multiRP_thetaY[11];   //[nProton_multiRP]
   Float_t         Proton_multiRP_time[11];   //[nProton_multiRP]
   Float_t         Proton_multiRP_timeUnc[11];   //[nProton_multiRP]
   Float_t         Proton_multiRP_xi[11];   //[nProton_multiRP]
   Int_t           Proton_multiRP_arm[11];   //[nProton_multiRP]
   UInt_t          nMuon;
   ...
   Float_t         PPSLocalTrack_x[30];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_y[30];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_time[30];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_timeUnc[30];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_multiRPProtonIdx[30];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_singleRPProtonIdx[30];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_decRPId[30];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_rpType[30];   //[nPPSLocalTrack]
   ...
   Int_t           Proton_singleRP_decRPId[30];   //[nProton_singleRP]
   UInt_t          nSubJet;
   ...
   Float_t         Jet_pt_raw[46];   //[nJet]
   Float_t         Jet_pt_nom[46];   //[nJet]
   Float_t         Jet_mass_raw[46];   //[nJet]
   Float_t         Jet_mass_nom[46];   //[nJet]
   Float_t         Jet_corr_JEC[46];   //[nJet]
   Float_t         Jet_corr_JER[46];   //[nJet]
   Float_t         MET_T1_pt;
   Float_t         MET_T1_phi;
   ...
   Float_t         lepton_eta;
   Float_t         lepton_phi;
   Int_t           is_lepton_tight;
   Int_t           lepton_isprompt;
   Int_t           n_bjets;
   Float_t         mt;
   Float_t         puppimt;
   Float_t         met;
   ...
   TBranch        *b_is_lepton_tight;   //!
   TBranch        *b_lepton_isprompt;   //!
   TBranch        *b_n_bjets;   //!
   TBranch        *b_mt;   //!
   TBranch        *b_puppimt;   //!
   TBranch        *b_met;   //!
   ...
   virtual void     Loop(TString name,float number,TString year);
   virtual void     endJob();
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("tree_1.root/Events");
      chain->Add("tree_2.root/Events");
      tree = chain;
#endif // SINGLE_TREE
...
void chain_WWg::Init(TTree *tree)
{
   ...
   fout = new TFile("./rootfiles_tmp/"+m_dataset, "RECREATE");
   ...
   fChain->SetBranchAddress("is_lepton_tight", &is_lepton_tight, &b_is_lepton_tight);
   fChain->SetBranchAddress("lepton_isprompt", &lepton_isprompt, &b_lepton_isprompt);
