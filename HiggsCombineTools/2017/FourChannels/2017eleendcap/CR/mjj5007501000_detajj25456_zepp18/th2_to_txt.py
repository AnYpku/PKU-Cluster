...
jes_QCD=[1.17,1.15,1.27,1.30,1.70,1.46,1.49,1.72]
jer_QCD=[1.10,1.03,1.13,1.16,1.32,1.24,1.29,1.38]
pdf_QCD=[1.01,1.01,1.03,1.01,1.01,1.02,1.01,1.01]
scale_QCD=[1.15,1.22,1.33,1.11,1.13,1.11,1.05,1.12]
pdf_ewk=[1.04,1.04,1.04,1.04,1.04,1.04,1.05,1.04]
scale_ewk=[1.03,1.06,1.09,1.03,1.06,1.10,1.05,1.13]
QCDZA_scale_extra_down = [0.973,0.939,0.767,1.008,0.985,1.091,1.039,1.020]
QCDZA_scale_extra_up = [1.031,1.072,1.268,0.988,1.015,0.902,0.961,0.980]
...
# bin error
   ...
   f.write('JES_17\tlnN\t%0.2f\t%0.2f\t-\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%(jes[i-1],jes_QCD[i-1],jes[i-1],jes[i-1],jes[i-1],jes[i-1]))
   f.write('JER_17\tlnN\t%0.2f\t%0.2f\t-\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%(jer[i-1],jer_QCD[i-1],jer[i-1],jer[i-1],jer[i-1],jer[i-1]))
   ...
   f.write('l1prefiring\tlnN\t1.01\t1.01\t-\t1.01\t1.01\t1.01\t1.01\n')
