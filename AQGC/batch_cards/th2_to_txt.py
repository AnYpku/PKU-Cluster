...
f_TTA = TFile.Open(fdir+'hist_TTA'+sys.argv[1]+sys.argv[2]+'.root')
f_VV = TFile.Open(fdir+'hist_VV'+sys.argv[1]+sys.argv[2]+'.root')
f_ST = TFile.Open(fdir+'hist_ST'+sys.argv[1]+sys.argv[2]+'.root')

th1_ZA_sig=f_EW.Get('hist')
th1_ZA=f_ZA.Get('hist')
th1_non_prompt=f_plj.Get('hist')
th1_TTA=f_TTA.Get('hist')
th1_VV=f_VV.Get('hist')
th1_ST=f_ST.Get('hist')
genbincontent=[]
genbinerror=[]
arr={}
