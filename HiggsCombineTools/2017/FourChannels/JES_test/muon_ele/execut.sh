...
qcd="jes_QCD=[1.24, 1.17, 1.18, 1.37, 2.32, 1.48, 1.49]"
ewk="jes_EWK=[1.03, 1.05, 1.07, 1.17, 1.09, 1.10, 1.10]"
run 
...
qcd="jes_QCD=[1.26, 1.11,1.11, 1.29, 1.47, 2.12, 1.63]"
ewk="jes_EWK=[1.03, 1.05, 1.05,1.10, 1.10, 1.09, 1.14]"
run 
