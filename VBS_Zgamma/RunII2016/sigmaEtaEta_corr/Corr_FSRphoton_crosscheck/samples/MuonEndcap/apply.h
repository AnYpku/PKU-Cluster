...
#ifdef apply_cxx
apply::apply(TTree *tree) : fChain(0) 
{
...
Int_t apply::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t apply::LoadTree(Long64_t entry)
{
...
void apply::Show(Long64_t entry)
{
...
Int_t apply::Cut(Long64_t entry)
{
