...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	   ...
	   JET_up = ( (!(fabs(jet2eta_JEC_up)<3.14 && fabs(jet2eta_JEC_up)>2.65) && !(fabs(jet1eta_JEC_up)<3.14 && fabs(jet1eta_JEC_up)>2.65) &&  jet1pt_JEC_up<50 && jet2pt_JEC_up<50 && jet1pt_JEC_up>30 && jet2pt_JEC_up>30 && fabs(jet1eta_JEC_up)< 4.7 && fabs(jet2eta_JEC_up)<4.7) || (jet1pt_JEC_up>50 && jet2pt_JEC_up>50 && fabs(jet1eta_JEC_up)< 4.7 && fabs(jet2eta_JEC_up)<4.7) )  && Mjj_JER_up > 150 && drla > 0.7 && drla2 > 0.7 && drj1a_JER_up > 0.5 && drj2a_JER_up > 0.5  && drjj_JER_up> 0.5 && drj1l_JER_up > 0.5 && drj2l_JER_up > 0.5 && drj1l2_JER_up > 0.5 && drj2l2_JER_up > 0.5;

	   if( !( ( drla>0.7 && drla>0.7 && lep == 13 && HLT_Mu2 > 0 && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep > 70. && massVlep < 110. && photonet > 20.&& fabs(photoneta) < 1.4442 && Mva>100) ||
                (drla>0.7 && drla2>0.7 && lep == 11 &&  ( HLT_Ele1 > 0|| HLT_Ele2 > 0) && ptlep1 > 25. && ptlep2 > 25. && fabs(etalep1) < 2.5 && fabs(etalep2) < 2.5 && nlooseeles < 3 && nloosemus == 0 && massVlep > 70. && massVlep < 110. && photonet > 20. &&( fabs(photoneta) < 1.4442 /*( fabs(photoneta)<2.5&&fabs(photoneta)>1.566 )*/ )  && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && drj1a>0.5 &&drj2a>0.5 && drj1l>0.5 && drj2l>0.5 && drjj>0.5 && Mva>100 ) ) )
		   continue;
...
//	   cout<<"scalef = "<<scalef<<"; pileupWeight = "<<pileupWeight<<"; actualWeight = "<<actualWeight<<endl;
	   for(int i=0;i<3;i++){
		   if(JET_JER[i] && Mjj_JER[i]<500 && deltaeta_JER[i]<6.5 ){ 
...
void jesrUncer::makefile(TString filename){
        TFile *file = new TFile("2d_"+filename+"_jer.root","RECREATE");
        TH2D* h2[3];
        Loop(h2);
        cout<<"OK"<<endl;
        file->cd();
