...
do 
   ...
   cd -
   cp ../txt_referee/all_${year[$j]}.txt ./
...
#       
       ...
       combine os_mll_${operator}_${year[$j]}.root -M MultiDimFit -P param --floatOtherPOIs=0 --algo none --cminDefaultMinimizerStrategy=2  -n bestfit1_${operator}_${year[$j]} -m 125 --saveWorkspace
       
       combine os_mll_${operator}_${year[$j]}.root -M MultiDimFit -P param --floatOtherPOIs=0 --algo none --cminDefaultMinimizerStrategy=2  -n bestfit2_${operator}_${year[$j]} -m 125 --saveWorkspace
       
       combine  -M MultiDimFit -P param --floatOtherPOIs=0 --algo=grid --points=100  higgsCombinebestfit1_${operator}_${year[$j]}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeParameters $NP1 --cminDefaultMinimizerStrategy=2  -n stat_${year[$j]} -m 125
#       
