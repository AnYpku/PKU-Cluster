...
int main(){
        ...
        TTree* tdata;
        tdata = chain;
//	TFile* fdata = TFile::Open("/eos/cms/store/group/phys_egamma/swmukher/ntuple_2017_v2/");
//	TDirectory* ddata = (TDirectory*)fdata->Get("tnpEleIDs");
//	TTree* tdata = (TTree*)ddata->Get("fitter_tree");
	TFile* fmc = TFile::Open("/eos/cms/store/group/phys_egamma/swmukher/ntuple_2017_v2/DY1JetsToLLM50madgraphMLM.root");
