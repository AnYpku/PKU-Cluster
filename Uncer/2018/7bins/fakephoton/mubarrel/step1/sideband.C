...
void open(double lowpt,double highpt,TString name1,TString name2,TString name3){
	...
	ifstream f1,f2,f3;
        f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2018/MakeTemplate/With_sieieCorr/BarrelMuon/ZAfit/txt/fakerate_"+name1+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
        f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2018/MakeTemplate/With_sieieCorr/BarrelMuon/ZAfit/txt/fakerate_"+name2+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
        f3.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2018/MakeTemplate/With_sieieCorr/BarrelMuon/ZAfit/txt/fakerate_"+name3+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
	if(!f1.is_open()){cout<<"can not open the file!!!!!!!!!!!!!!!!!!!!!!!!!!!!With_sieieCorr/!!!!!!!!!!!!!!!!!!!!!!!"<<endl;}
