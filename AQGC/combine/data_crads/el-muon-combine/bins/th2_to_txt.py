...
#       f.write('fake_%s_%s\tlnN\t-\t-\t-\t-\t#0. uncertainty on all_full\n'%('ele','full'))
#   else: 
#       f.write('fake_%s_%s\tlnN\t-\t%0.2f\t-\t-\t#0. uncertainty on all_full\n'%('ele','full',fake[i-1]))
   f.write('VBS_stat_%s_%s_bin_%d\tlnN\t%0.2f\t-\t-\t-\n'%('all','full',i,ZA_sig_binerror))
   f.write('QCD_stat_%s_%s_bin_%d\tlnN\t-\t%0.2f\t-\t-\n'%('all','full',i,ZA_binerror))
   f.write('non_prompt_stat_%s_%s_bin_%d\tlnN\t-\t-\t%0.2f\t-\n'%('all','full',i,non_prompt_binerror))
   f.write('others_stat_%s_%s_bin_%d\tlnN\t-\t-\t-\t%0.2f\n'%('all','full',i,others_binerror))
...
#   f.write('all16_trigger\tlnN\t1.02\t1.02\t-\t1.02\n')
#   f.write('all16_efficiency\tlnN\t1.023\t1.023\t-\t1.023\n')
