...
dir16="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Unfolding/data_card/2016/photonet/"
dir17="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Unfolding/data_card/2017/photonet/"
dir18="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Unfolding/data_card/2018/photonet/"
...
for i in range(1,5):
   f = open('./txt/%s_bin_%d.txt'%('photonet', i),'w')
...
# bin error
   ...
   f.write('bin\trecobin%i\trecobin%i\trecobin%i\trecobin%i\trecobin%i\trecobin%i\trecobin%i\trecobin%i\trecobin%i\trecobin%i\trecobin%i\n'%(i,i,i,i,i,i,i,i,i,i,i))
   f.write('process\tgenbin1\tgenbin2\tgenbin3\tgenbin4\tQCD\tnon_prompt\tTTA\tVV\tST\tWA\tSig_out\n')
...
#   f.write('rate\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%(genbincontent[0],genbincontent[1],genbincontent[2],genbincontent[3],genbincontent[4],genbincontent[5],ZA_bincontent, non_prompt_bincontent, TTA_bincontent, VV_bincontent, ST_bincontent, WA_bincontent))
   f.write('rate\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%(genbin[0],genbin[1],genbin[2],genbin[3],ZA_bincontent, non_prompt_bincontent, TTA_bincontent, VV_bincontent, ST_bincontent, WA_bincontent,ZA_sig_out_bincontent))
   f.write('------------\n')
