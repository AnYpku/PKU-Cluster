...
//=========  (Mon Jun  8 04:03:21 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-7.017136,7.4375,46.96083);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(40.09792);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(42.10282);
   ...
   ST_stack_1->SetBinContent(5,0.1924304);
   ST_stack_1->SetBinError(5,0.1924304);
   ...
   TTA_stack_2->SetBinContent(1,0.5360723);
   TTA_stack_2->SetBinContent(2,0.08934538);
   TTA_stack_2->SetBinContent(3,-0.1786908);
   TTA_stack_2->SetBinContent(4,-0.1786908);
   TTA_stack_2->SetBinContent(5,0.08934538);
   TTA_stack_2->SetBinContent(6,0.08934538);
   TTA_stack_2->SetBinError(1,0.4555738);
   TTA_stack_2->SetBinError(2,0.1547507);
   TTA_stack_2->SetBinError(3,0.1263534);
   TTA_stack_2->SetBinError(4,0.1786908);
   TTA_stack_2->SetBinError(5,0.1547507);
   TTA_stack_2->SetBinError(6,0.08934538);
   ...
   VV_stack_3->SetBinContent(1,0.5936915);
   VV_stack_3->SetBinError(1,0.5936915);
   ...
   plj_stack_5->SetBinContent(1,8.500648);
   plj_stack_5->SetBinContent(2,1.754325);
   plj_stack_5->SetBinContent(3,0.522884);
   plj_stack_5->SetBinContent(4,11.41443);
   plj_stack_5->SetBinContent(5,3.947267);
   plj_stack_5->SetBinContent(6,1.055658);
   plj_stack_5->SetBinContent(7,3.658462);
   plj_stack_5->SetBinError(1,1.430519);
   plj_stack_5->SetBinError(2,0.666587);
   plj_stack_5->SetBinError(3,0.369801);
   plj_stack_5->SetBinError(4,1.708958);
   plj_stack_5->SetBinError(5,0.992706);
   plj_stack_5->SetBinError(6,0.5278985);
   ...
   t_ZA_stack_6->SetBinContent(1,14.31176);
   t_ZA_stack_6->SetBinContent(2,3.842973);
   t_ZA_stack_6->SetBinContent(3,0.1325163);
   t_ZA_stack_6->SetBinContent(4,10.6013);
   t_ZA_stack_6->SetBinContent(5,3.57794);
   t_ZA_stack_6->SetBinContent(6,1.192647);
   t_ZA_stack_6->SetBinContent(7,3.842973);
   t_ZA_stack_6->SetBinError(1,1.644484);
   t_ZA_stack_6->SetBinError(2,0.8275641);
   t_ZA_stack_6->SetBinError(3,0.2963155);
   t_ZA_stack_6->SetBinError(4,1.707353);
   t_ZA_stack_6->SetBinError(5,0.9827673);
   t_ZA_stack_6->SetBinError(6,0.5463787);
   ...
   ZA_sig_stack_7->SetBinContent(1,2.26755);
   ZA_sig_stack_7->SetBinContent(2,1.759069);
   ZA_sig_stack_7->SetBinContent(3,1.030705);
   ZA_sig_stack_7->SetBinContent(4,0.4397673);
   ZA_sig_stack_7->SetBinContent(5,1.278074);
   ZA_sig_stack_7->SetBinContent(6,1.374273);
   ZA_sig_stack_7->SetBinContent(7,0.3847964);
   ZA_sig_stack_7->SetBinError(1,0.1765285);
   ZA_sig_stack_7->SetBinError(2,0.1590836);
   ZA_sig_stack_7->SetBinError(3,0.1190155);
   ZA_sig_stack_7->SetBinError(4,0.07774061);
   ZA_sig_stack_7->SetBinError(5,0.1325301);
   ZA_sig_stack_7->SetBinError(6,0.1374273);
   ...
   ZA_sigout_stack_8->SetBinContent(1,0.5222236);
   ZA_sigout_stack_8->SetBinContent(2,0.02748545);
   ZA_sigout_stack_8->SetBinContent(3,0.04122818);
   ZA_sigout_stack_8->SetBinContent(4,0.1099418);
   ZA_sigout_stack_8->SetBinContent(5,0.1236845);
   ZA_sigout_stack_8->SetBinContent(6,0.02748545);
   ZA_sigout_stack_8->SetBinContent(7,0.04122818);
   ZA_sigout_stack_8->SetBinError(1,0.08471586);
   ZA_sigout_stack_8->SetBinError(2,0.01943515);
   ZA_sigout_stack_8->SetBinError(3,0.0238031);
   ZA_sigout_stack_8->SetBinError(4,0.0388703);
   ZA_sigout_stack_8->SetBinError(5,0.04122818);
   ZA_sigout_stack_8->SetBinError(6,0.01943515);
   ...
   TLegendEntry *entry=leg->AddEntry("ZA_sig_stack_7","EWK in fid.[8.53]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("t_ZA_stack_6","ZA [37.50]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("plj_stack_5","non-prompt [30.85]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("TTA_stack_2","TTA [0.45]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("ST_stack_1","ST  [0.19]","lpf");
