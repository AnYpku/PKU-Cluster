...
rm *.txt
rm *.root
cp -f /home/pku/anying/cms/PKU-Cluster/WWg/Significance/data_cards/SR/test/txt/*.txt .
cp -f /home/pku/anying/cms/PKU-Cluster/WWg/Significance/data_cards/CR/test/txt/*.txt .
years="\
18
"
#16
