		...
		if (  tformula->EvalInstance() ){
			if(lep==13){
				...
				for(int i=0;i<3;i++){
					...
					if(Mjj>=500&&detajj>=6)th1[i]->Fill(6.5,muon_weight[i]);//6~7 6~infi 800~1200
				}
			}
			if(lep==11){
				...
				for(int i=0;i<3;i++){
					...
					if(Mjj>=500&&detajj>=6)th1[i]->Fill(6.5,ele_weight[i]);//6~7 6~infi 800~1200                        
				}
			}
			if(photonet>0){
				...
				for(int i=0;i<3;i++){
					...
					if(Mjj>=500&&detajj>=6)th1[i]->Fill(6.5,photon_weight[i]);//6~7 6~infi 800~1200                        
				}
			}
		}
