...
//      cout<<genlep<<endl;
      ...
      SignalRegion = Mjj>500 && detajj>2.5 && Mva>100; /*&& zepp<2.4* && delta_phi>1.9;*/
...
//      Gen =  GenLEPele  && GenPhoton && GenJet && GenDr && GenSignalRegion;
      ...
      if( (name.Contains("Muon")==1 || name.Contains("Data")==1/*||name.Contains("Pesudo")==1*/) && Reco){
