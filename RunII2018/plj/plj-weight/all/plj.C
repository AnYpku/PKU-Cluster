...
void plj::Loop(TString name)
{
   ...
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/7bins/fakephoton/elebarrel/step1/pljweight"+name+".txt");
   f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/7bins/fakephoton/eleendcap/step1/pljweight"+name+".txt");
   f3.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/7bins/fakephoton/mubarrel/step1/pljweight"+name+".txt");
   f4.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/7bins/fakephoton/muendcap/step1/pljweight"+name+".txt");
