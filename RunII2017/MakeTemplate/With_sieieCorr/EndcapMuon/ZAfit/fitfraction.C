...
TFile* fdata = TFile::Open("../root/Data_template2-DMuon17.root");
TFile* ffake = TFile::Open("../root/Fake_template2-DMuon17.root");
TFile* ftrue = TFile::Open("../root/True_template2-ZA17.root");
//TFile* ftrue = TFile::Open("../root/True_template2-cutlep-outZA-EWK.root");
//TFile* ftrue = TFile::Open("../root/True_template2-cutlep-outTTA.root");
...
//            double chi2ToNdf = chi2;
		double chi2ToNdf = chi2/Ndf;
	        ...
	        real_window = mcp1->IntegralAndError(0,mcp1->FindFixBin(0.0272),real_window_Error);
