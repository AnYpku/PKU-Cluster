...
int selection_unc(){
	...
	TH1D*h1=run("18","outEGamma","ele","(("+cut_ele+")&& is_lepton_tight==1)",ptbins.size()-1,ptbins[0],ptbins[ptbins.size()-1]);
	TH1D*h2=run("18","outEGamma","ele","(("+cut_ele+")&& is_lepton_tight==0)",ptbins.size()-1,ptbins[0],ptbins[ptbins.size()-1]);
	TH1D*h3=run("18","outWJets","ele","(("+cut_elemc+")&& is_lepton_tight==1)" ,ptbins.size()-1,ptbins[0],ptbins[ptbins.size()-1]);
	TH1D*h4=run("18","outWJets","ele","(("+cut_elemc+")&& is_lepton_tight==0)" ,ptbins.size()-1,ptbins[0],ptbins[ptbins.size()-1]);
        h1->Write("data_tight");
        h2->Write("data_fake");
        h3->Write("mc_tight");
        h4->Write("mc_fake");
