...
// Wed Oct 19 20:56:21 2022 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: DYJets_preVFP16.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         boostedTau_rawMVAoldDMdR032017v2[6];   //[nboostedTau]
   Int_t           boostedTau_charge[6];   //[nboostedTau]
   Int_t           boostedTau_decayMode[6];   //[nboostedTau]
   Int_t           boostedTau_jetIdx[6];   //[nboostedTau]
   Int_t           boostedTau_rawAntiEleCat2018[6];   //[nboostedTau]
   ...
   UChar_t         boostedTau_idMVAoldDMdR032017v2[6];   //[nboostedTau]
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[268];   //[nGenPart]
   Float_t         GenPart_mass[268];   //[nGenPart]
   Float_t         GenPart_phi[268];   //[nGenPart]
   Float_t         GenPart_pt[268];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[268];   //[nGenPart]
   Int_t           GenPart_pdgId[268];   //[nGenPart]
   Int_t           GenPart_status[268];   //[nGenPart]
   Int_t           GenPart_statusFlags[268];   //[nGenPart]
   ...
   Int_t           IsoTrack_charge[23];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[23];   //[nIsoTrack]
   ...
   UInt_t          nJet;
   Float_t         Jet_area[54];   //[nJet]
   Float_t         Jet_btagCSVV2[54];   //[nJet]
   Float_t         Jet_btagDeepB[54];   //[nJet]
   Float_t         Jet_btagDeepCvB[54];   //[nJet]
   Float_t         Jet_btagDeepCvL[54];   //[nJet]
   Float_t         Jet_btagDeepFlavB[54];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[54];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[54];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[54];   //[nJet]
   Float_t         Jet_chEmEF[54];   //[nJet]
   Float_t         Jet_chFPV0EF[54];   //[nJet]
   Float_t         Jet_chHEF[54];   //[nJet]
   Float_t         Jet_eta[54];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[54];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[54];   //[nJet]
   Float_t         Jet_mass[54];   //[nJet]
   Float_t         Jet_muEF[54];   //[nJet]
   Float_t         Jet_muonSubtrFactor[54];   //[nJet]
   Float_t         Jet_neEmEF[54];   //[nJet]
   Float_t         Jet_neHEF[54];   //[nJet]
   Float_t         Jet_phi[54];   //[nJet]
   Float_t         Jet_pt[54];   //[nJet]
   Float_t         Jet_puIdDisc[54];   //[nJet]
   Float_t         Jet_qgl[54];   //[nJet]
   Float_t         Jet_rawFactor[54];   //[nJet]
   Float_t         Jet_bRegCorr[54];   //[nJet]
   Float_t         Jet_bRegRes[54];   //[nJet]
   Float_t         Jet_cRegCorr[54];   //[nJet]
   Float_t         Jet_cRegRes[54];   //[nJet]
   Int_t           Jet_electronIdx1[54];   //[nJet]
   Int_t           Jet_electronIdx2[54];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[54];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[54];   //[nJet]
   Int_t           Jet_jetId[54];   //[nJet]
   Int_t           Jet_muonIdx1[54];   //[nJet]
   Int_t           Jet_muonIdx2[54];   //[nJet]
   Int_t           Jet_nElectrons[54];   //[nJet]
   Int_t           Jet_nMuons[54];   //[nJet]
   Int_t           Jet_puId[54];   //[nJet]
   UChar_t         Jet_nConstituents[54];   //[nJet]
   ...
   Int_t           PV_npvs;
   Int_t           PV_npvsGood;
   Int_t           boostedTau_genPartIdx[6];   //[nboostedTau]
   ...
   Float_t         GenVtx_t0;
   Int_t           Jet_genJetIdx[54];   //[nJet]
   Int_t           Jet_hadronFlavour[54];   //[nJet]
   Int_t           Jet_partonFlavour[54];   //[nJet]
   ...
   Float_t         Muon_corrected_pt[17];   //[nMuon]
   Float_t         puWeight;
   Float_t         puWeightUp;
   Float_t         puWeightDown;
   Float_t         vjj_mu_effWgt;
   Float_t         vjj_mu_effWgtUp;
   Float_t         vjj_mu_effWgtDn;
   UInt_t          vjj_nmus;
   UChar_t         vjj_mus[3];   //[vjj_nmus]
   Float_t         vjj_ele_effWgt;
   Float_t         vjj_ele_effWgtUp;
   Float_t         vjj_ele_effWgtDn;
   UInt_t          vjj_neles;
   UChar_t         vjj_eles[1];   //[vjj_neles]
   Float_t         vjj_photon_effWgt;
   Float_t         vjj_photon_effWgtUp;
   Float_t         vjj_photon_effWgtDn;
   UInt_t          vjj_nphotons;
   UChar_t         vjj_photons[1];   //[vjj_nphotons]
   Float_t         vjj_loosePhoton_effWgt;
   Float_t         vjj_loosePhoton_effWgtUp;
   Float_t         vjj_loosePhoton_effWgtDn;
   UInt_t          vjj_nloosePhotons;
   UChar_t         vjj_loosePhotons[4];   //[vjj_nloosePhotons]
   Float_t         vjj_qglqWgt_jets;
   Float_t         vjj_qglgWgt_jets;
   UInt_t          vjj_njets;
   UChar_t         vjj_jets[11];   //[vjj_njets]
   Float_t         vjj_qglqWgt_looseJets;
   Float_t         vjj_qglgWgt_looseJets;
   UInt_t          vjj_nlooseJets;
   UChar_t         vjj_looseJets[11];   //[vjj_nlooseJets]
   Float_t         vjj_trigWgt;
   Float_t         vjj_trigWgtUp;
   Float_t         vjj_trigWgtDn;
   Float_t         vjj_trigHighPtWgt;
   Float_t         vjj_trigHighPtWgtUp;
   Float_t         vjj_trigHighPtWgtDn;
   Float_t         vjj_effWgt;
   Float_t         vjj_effWgtUp;
   Float_t         vjj_effWgtDn;
   Float_t         vjj_qglqWgt;
   Float_t         vjj_qglgWgt;
   Float_t         vjj_v_pt;
   Float_t         vjj_v_eta;
   ...
   Float_t         vjj_v_ystar;
   Float_t         vjj_lead_pt;
   Float_t         vjj_lead_eta;
   Float_t         vjj_lead_phi;
   Float_t         vjj_lead_m;
   Float_t         vjj_lead_qgl;
   Float_t         vjj_lead_dr2v;
   Float_t         vjj_lead_dphiv;
   Float_t         vjj_lead_detav;
   Float_t         vjj_sublead_pt;
   Float_t         vjj_sublead_eta;
   Float_t         vjj_sublead_phi;
   Float_t         vjj_sublead_m;
   Float_t         vjj_sublead_qgl;
   Float_t         vjj_sublead_dr2v;
   Float_t         vjj_sublead_dphiv;
   Float_t         vjj_sublead_detav;
   Float_t         vjj_sublead_isloosePU;
   Float_t         vjj_j_maxAbsEta;
   Float_t         vjj_j_minAbsEta;
   Float_t         vjj_jj_pt;
   Float_t         vjj_jj_eta;
   Float_t         vjj_jj_phi;
   Float_t         vjj_jj_m;
   Float_t         vjj_jj_dr2v;
   Float_t         vjj_jj_scalarht;
   Float_t         vjj_jj_deta;
   Float_t         vjj_jj_dphi;
   Float_t         vjj_jj_sumabseta;
   Float_t         vjj_vjj_pt;
   Float_t         vjj_vjj_eta;
   Float_t         vjj_vjj_phi;
   Float_t         vjj_vjj_m;
   Float_t         vjj_vjj_dphi;
   Float_t         vjj_vjj_deta;
   Float_t         vjj_vjj_scalarht;
   Float_t         vjj_vjj_isotropy;
   Float_t         vjj_vjj_circularity;
   Float_t         vjj_vjj_sphericity;
   Float_t         vjj_vjj_aplanarity;
   Float_t         vjj_vjj_C;
   Float_t         vjj_vjj_D;
   Float_t         vjj_centj_pt;
   Float_t         vjj_centj_eta;
   Float_t         vjj_centj_phi;
   Float_t         vjj_centj_m;
   Float_t         vjj_centj_ystar;
   Float_t         vjj_centj_dr2v;
   Float_t         vjj_htsoft;
   Float_t         vjj_centhtsoft;
   Float_t         genvjj_leadlep_pt;
   Float_t         genvjj_subleadlep_pt;
   Float_t         genvjj_leadlep_eta;
   Float_t         genvjj_subleadlep_eta;
   Float_t         genvjj_leadlep_phi;
   Float_t         genvjj_subleadlep_phi;
   Float_t         vjj_a_mvaID_WP80;
   Float_t         vjj_a_mvaID_WP90;
   Float_t         vjj_a_cutBased;
   Float_t         vjj_a_r9;
   Float_t         vjj_a_sieie;
   Float_t         vjj_a_hoe;
   Float_t         vjj_a_pfRelIso03_all;
   Float_t         vjj_a_pfRelIso03_chg;
   Int_t           vjj_fs;
   Int_t           vjj_trig;
   Int_t           vjj_nextraj;
   Int_t           vjj_ncentj;
   Int_t           vjj_lead_flav;
   Int_t           vjj_sublead_flav;
   UInt_t          nwgt;
   Bool_t          vjj_isGood;
   Float_t         genvjj_trigHighPtWgt;
   Float_t         genvjj_trigHighPtWgtUp;
   Float_t         genvjj_trigHighPtWgtDn;
   Float_t         genvjj_v_pt;
   Float_t         genvjj_v_eta;
   Float_t         genvjj_v_phi;
   Float_t         genvjj_v_m;
   Float_t         genvjj_v_ystar;
   Float_t         genvjj_lead_pt;
   Float_t         genvjj_lead_eta;
   Float_t         genvjj_lead_phi;
   Float_t         genvjj_lead_m;
   Float_t         genvjj_lead_dr2v;
   Float_t         genvjj_lead_dphiv;
   Float_t         genvjj_lead_detav;
   Float_t         genvjj_sublead_pt;
   Float_t         genvjj_sublead_eta;
   Float_t         genvjj_sublead_phi;
   Float_t         genvjj_sublead_m;
   Float_t         genvjj_sublead_dr2v;
   Float_t         genvjj_sublead_dphiv;
   Float_t         genvjj_sublead_detav;
   Float_t         genvjj_sublead_isloosePU;
   Float_t         genvjj_j_maxAbsEta;
   Float_t         genvjj_j_minAbsEta;
   Float_t         genvjj_jj_pt;
   Float_t         genvjj_jj_eta;
   Float_t         genvjj_jj_phi;
   Float_t         genvjj_jj_m;
   Float_t         genvjj_jj_dr2v;
   Float_t         genvjj_jj_scalarht;
   Float_t         genvjj_jj_deta;
   Float_t         genvjj_jj_dphi;
   Float_t         genvjj_jj_sumabseta;
   Float_t         genvjj_vjj_pt;
   Float_t         genvjj_vjj_eta;
   Float_t         genvjj_vjj_phi;
   Float_t         genvjj_vjj_m;
   Float_t         genvjj_vjj_dphi;
   Float_t         genvjj_vjj_deta;
   Float_t         genvjj_vjj_scalarht;
   Float_t         genvjj_vjj_isotropy;
   Float_t         genvjj_vjj_circularity;
   Float_t         genvjj_vjj_sphericity;
   Float_t         genvjj_vjj_aplanarity;
   Float_t         genvjj_vjj_C;
   Float_t         genvjj_vjj_D;
   Float_t         genvjj_centj_pt;
   Float_t         genvjj_centj_eta;
   Float_t         genvjj_centj_phi;
   Float_t         genvjj_centj_m;
   Float_t         genvjj_centj_ystar;
Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("vjj_mu_effWgt", &vjj_mu_effWgt, &b_vjj_mu_effWgt);
   fChain->SetBranchAddress("vjj_mu_effWgtUp", &vjj_mu_effWgtUp, &b_vjj_mu_effWgtUp);
   fChain->SetBranchAddress("vjj_mu_effWgtDn", &vjj_mu_effWgtDn, &b_vjj_mu_effWgtDn);
   fChain->SetBranchAddress("vjj_nmus", &vjj_nmus, &b_vjj_nmus);
   fChain->SetBranchAddress("vjj_mus", vjj_mus, &b_vjj_mus);
   fChain->SetBranchAddress("vjj_ele_effWgt", &vjj_ele_effWgt, &b_vjj_ele_effWgt);
   fChain->SetBranchAddress("vjj_ele_effWgtUp", &vjj_ele_effWgtUp, &b_vjj_ele_effWgtUp);
   fChain->SetBranchAddress("vjj_ele_effWgtDn", &vjj_ele_effWgtDn, &b_vjj_ele_effWgtDn);
   fChain->SetBranchAddress("vjj_neles", &vjj_neles, &b_vjj_neles);
   fChain->SetBranchAddress("vjj_eles", vjj_eles, &b_vjj_eles);
   fChain->SetBranchAddress("vjj_photon_effWgt", &vjj_photon_effWgt, &b_vjj_photon_effWgt);
   fChain->SetBranchAddress("vjj_photon_effWgtUp", &vjj_photon_effWgtUp, &b_vjj_photon_effWgtUp);
   fChain->SetBranchAddress("vjj_photon_effWgtDn", &vjj_photon_effWgtDn, &b_vjj_photon_effWgtDn);
   fChain->SetBranchAddress("vjj_nphotons", &vjj_nphotons, &b_vjj_nphotons);
   fChain->SetBranchAddress("vjj_photons", vjj_photons, &b_vjj_photons);
   fChain->SetBranchAddress("vjj_loosePhoton_effWgt", &vjj_loosePhoton_effWgt, &b_vjj_loosePhoton_effWgt);
   fChain->SetBranchAddress("vjj_loosePhoton_effWgtUp", &vjj_loosePhoton_effWgtUp, &b_vjj_loosePhoton_effWgtUp);
   fChain->SetBranchAddress("vjj_loosePhoton_effWgtDn", &vjj_loosePhoton_effWgtDn, &b_vjj_loosePhoton_effWgtDn);
   fChain->SetBranchAddress("vjj_nloosePhotons", &vjj_nloosePhotons, &b_vjj_nloosePhotons);
   fChain->SetBranchAddress("vjj_loosePhotons", vjj_loosePhotons, &b_vjj_loosePhotons);
   fChain->SetBranchAddress("vjj_qglqWgt_jets", &vjj_qglqWgt_jets, &b_vjj_qglqWgt_jets);
   fChain->SetBranchAddress("vjj_qglgWgt_jets", &vjj_qglgWgt_jets, &b_vjj_qglgWgt_jets);
   fChain->SetBranchAddress("vjj_njets", &vjj_njets, &b_vjj_njets);
   fChain->SetBranchAddress("vjj_jets", vjj_jets, &b_vjj_jets);
   fChain->SetBranchAddress("vjj_qglqWgt_looseJets", &vjj_qglqWgt_looseJets, &b_vjj_qglqWgt_looseJets);
   fChain->SetBranchAddress("vjj_qglgWgt_looseJets", &vjj_qglgWgt_looseJets, &b_vjj_qglgWgt_looseJets);
   fChain->SetBranchAddress("vjj_nlooseJets", &vjj_nlooseJets, &b_vjj_nlooseJets);
   fChain->SetBranchAddress("vjj_looseJets", vjj_looseJets, &b_vjj_looseJets);
   fChain->SetBranchAddress("vjj_trigWgt", &vjj_trigWgt, &b_vjj_trigWgt);
   fChain->SetBranchAddress("vjj_trigWgtUp", &vjj_trigWgtUp, &b_vjj_trigWgtUp);
   fChain->SetBranchAddress("vjj_trigWgtDn", &vjj_trigWgtDn, &b_vjj_trigWgtDn);
   fChain->SetBranchAddress("vjj_trigHighPtWgt", &vjj_trigHighPtWgt, &b_vjj_trigHighPtWgt);
   fChain->SetBranchAddress("vjj_trigHighPtWgtUp", &vjj_trigHighPtWgtUp, &b_vjj_trigHighPtWgtUp);
   fChain->SetBranchAddress("vjj_trigHighPtWgtDn", &vjj_trigHighPtWgtDn, &b_vjj_trigHighPtWgtDn);
   fChain->SetBranchAddress("vjj_effWgt", &vjj_effWgt, &b_vjj_effWgt);
   fChain->SetBranchAddress("vjj_effWgtUp", &vjj_effWgtUp, &b_vjj_effWgtUp);
   fChain->SetBranchAddress("vjj_effWgtDn", &vjj_effWgtDn, &b_vjj_effWgtDn);
   fChain->SetBranchAddress("vjj_qglqWgt", &vjj_qglqWgt, &b_vjj_qglqWgt);
   fChain->SetBranchAddress("vjj_qglgWgt", &vjj_qglgWgt, &b_vjj_qglgWgt);
   fChain->SetBranchAddress("vjj_v_pt", &vjj_v_pt, &b_vjj_v_pt);
   fChain->SetBranchAddress("vjj_v_eta", &vjj_v_eta, &b_vjj_v_eta);
   fChain->SetBranchAddress("vjj_v_phi", &vjj_v_phi, &b_vjj_v_phi);
   fChain->SetBranchAddress("vjj_v_m", &vjj_v_m, &b_vjj_v_m);
   fChain->SetBranchAddress("vjj_v_ystar", &vjj_v_ystar, &b_vjj_v_ystar);
   fChain->SetBranchAddress("vjj_lead_pt", &vjj_lead_pt, &b_vjj_lead_pt);
   fChain->SetBranchAddress("vjj_lead_eta", &vjj_lead_eta, &b_vjj_lead_eta);
   fChain->SetBranchAddress("vjj_lead_phi", &vjj_lead_phi, &b_vjj_lead_phi);
   fChain->SetBranchAddress("vjj_lead_m", &vjj_lead_m, &b_vjj_lead_m);
   fChain->SetBranchAddress("vjj_lead_qgl", &vjj_lead_qgl, &b_vjj_lead_qgl);
   fChain->SetBranchAddress("vjj_lead_dr2v", &vjj_lead_dr2v, &b_vjj_lead_dr2v);
   fChain->SetBranchAddress("vjj_lead_dphiv", &vjj_lead_dphiv, &b_vjj_lead_dphiv);
   fChain->SetBranchAddress("vjj_lead_detav", &vjj_lead_detav, &b_vjj_lead_detav);
   fChain->SetBranchAddress("vjj_sublead_pt", &vjj_sublead_pt, &b_vjj_sublead_pt);
   fChain->SetBranchAddress("vjj_sublead_eta", &vjj_sublead_eta, &b_vjj_sublead_eta);
   fChain->SetBranchAddress("vjj_sublead_phi", &vjj_sublead_phi, &b_vjj_sublead_phi);
   fChain->SetBranchAddress("vjj_sublead_m", &vjj_sublead_m, &b_vjj_sublead_m);
   fChain->SetBranchAddress("vjj_sublead_qgl", &vjj_sublead_qgl, &b_vjj_sublead_qgl);
   fChain->SetBranchAddress("vjj_sublead_dr2v", &vjj_sublead_dr2v, &b_vjj_sublead_dr2v);
   fChain->SetBranchAddress("vjj_sublead_dphiv", &vjj_sublead_dphiv, &b_vjj_sublead_dphiv);
   fChain->SetBranchAddress("vjj_sublead_detav", &vjj_sublead_detav, &b_vjj_sublead_detav);
   fChain->SetBranchAddress("vjj_sublead_isloosePU", &vjj_sublead_isloosePU, &b_vjj_sublead_isloosePU);
   fChain->SetBranchAddress("vjj_j_maxAbsEta", &vjj_j_maxAbsEta, &b_vjj_j_maxAbsEta);
   fChain->SetBranchAddress("vjj_j_minAbsEta", &vjj_j_minAbsEta, &b_vjj_j_minAbsEta);
   fChain->SetBranchAddress("vjj_jj_pt", &vjj_jj_pt, &b_vjj_jj_pt);
   fChain->SetBranchAddress("vjj_jj_eta", &vjj_jj_eta, &b_vjj_jj_eta);
   fChain->SetBranchAddress("vjj_jj_phi", &vjj_jj_phi, &b_vjj_jj_phi);
   fChain->SetBranchAddress("vjj_jj_m", &vjj_jj_m, &b_vjj_jj_m);
   fChain->SetBranchAddress("vjj_jj_dr2v", &vjj_jj_dr2v, &b_vjj_jj_dr2v);
   fChain->SetBranchAddress("vjj_jj_scalarht", &vjj_jj_scalarht, &b_vjj_jj_scalarht);
   fChain->SetBranchAddress("vjj_jj_deta", &vjj_jj_deta, &b_vjj_jj_deta);
   fChain->SetBranchAddress("vjj_jj_dphi", &vjj_jj_dphi, &b_vjj_jj_dphi);
   fChain->SetBranchAddress("vjj_jj_sumabseta", &vjj_jj_sumabseta, &b_vjj_jj_sumabseta);
   fChain->SetBranchAddress("vjj_vjj_pt", &vjj_vjj_pt, &b_vjj_vjj_pt);
   fChain->SetBranchAddress("vjj_vjj_eta", &vjj_vjj_eta, &b_vjj_vjj_eta);
   fChain->SetBranchAddress("vjj_vjj_phi", &vjj_vjj_phi, &b_vjj_vjj_phi);
   fChain->SetBranchAddress("vjj_vjj_m", &vjj_vjj_m, &b_vjj_vjj_m);
   fChain->SetBranchAddress("vjj_vjj_dphi", &vjj_vjj_dphi, &b_vjj_vjj_dphi);
   fChain->SetBranchAddress("vjj_vjj_deta", &vjj_vjj_deta, &b_vjj_vjj_deta);
   fChain->SetBranchAddress("vjj_vjj_scalarht", &vjj_vjj_scalarht, &b_vjj_vjj_scalarht);
   fChain->SetBranchAddress("vjj_vjj_isotropy", &vjj_vjj_isotropy, &b_vjj_vjj_isotropy);
   fChain->SetBranchAddress("vjj_vjj_circularity", &vjj_vjj_circularity, &b_vjj_vjj_circularity);
   fChain->SetBranchAddress("vjj_vjj_sphericity", &vjj_vjj_sphericity, &b_vjj_vjj_sphericity);
   fChain->SetBranchAddress("vjj_vjj_aplanarity", &vjj_vjj_aplanarity, &b_vjj_vjj_aplanarity);
   fChain->SetBranchAddress("vjj_vjj_C", &vjj_vjj_C, &b_vjj_vjj_C);
   fChain->SetBranchAddress("vjj_vjj_D", &vjj_vjj_D, &b_vjj_vjj_D);
   fChain->SetBranchAddress("vjj_centj_pt", &vjj_centj_pt, &b_vjj_centj_pt);
   fChain->SetBranchAddress("vjj_centj_eta", &vjj_centj_eta, &b_vjj_centj_eta);
   fChain->SetBranchAddress("vjj_centj_phi", &vjj_centj_phi, &b_vjj_centj_phi);
   fChain->SetBranchAddress("vjj_centj_m", &vjj_centj_m, &b_vjj_centj_m);
   fChain->SetBranchAddress("vjj_centj_ystar", &vjj_centj_ystar, &b_vjj_centj_ystar);
   fChain->SetBranchAddress("vjj_centj_dr2v", &vjj_centj_dr2v, &b_vjj_centj_dr2v);
   fChain->SetBranchAddress("vjj_htsoft", &vjj_htsoft, &b_vjj_htsoft);
   fChain->SetBranchAddress("vjj_centhtsoft", &vjj_centhtsoft, &b_vjj_centhtsoft);
   fChain->SetBranchAddress("genvjj_leadlep_pt", &genvjj_leadlep_pt, &b_genvjj_leadlep_pt);
   fChain->SetBranchAddress("genvjj_subleadlep_pt", &genvjj_subleadlep_pt, &b_genvjj_subleadlep_pt);
   fChain->SetBranchAddress("genvjj_leadlep_eta", &genvjj_leadlep_eta, &b_genvjj_leadlep_eta);
   fChain->SetBranchAddress("genvjj_subleadlep_eta", &genvjj_subleadlep_eta, &b_genvjj_subleadlep_eta);
   fChain->SetBranchAddress("genvjj_leadlep_phi", &genvjj_leadlep_phi, &b_genvjj_leadlep_phi);
   fChain->SetBranchAddress("genvjj_subleadlep_phi", &genvjj_subleadlep_phi, &b_genvjj_subleadlep_phi);
   fChain->SetBranchAddress("vjj_a_mvaID_WP80", &vjj_a_mvaID_WP80, &b_vjj_a_mvaID_WP80);
   fChain->SetBranchAddress("vjj_a_mvaID_WP90", &vjj_a_mvaID_WP90, &b_vjj_a_mvaID_WP90);
   fChain->SetBranchAddress("vjj_a_cutBased", &vjj_a_cutBased, &b_vjj_a_cutBased);
   fChain->SetBranchAddress("vjj_a_r9", &vjj_a_r9, &b_vjj_a_r9);
   fChain->SetBranchAddress("vjj_a_sieie", &vjj_a_sieie, &b_vjj_a_sieie);
   fChain->SetBranchAddress("vjj_a_hoe", &vjj_a_hoe, &b_vjj_a_hoe);
   fChain->SetBranchAddress("vjj_a_pfRelIso03_all", &vjj_a_pfRelIso03_all, &b_vjj_a_pfRelIso03_all);
   fChain->SetBranchAddress("vjj_a_pfRelIso03_chg", &vjj_a_pfRelIso03_chg, &b_vjj_a_pfRelIso03_chg);
   fChain->SetBranchAddress("vjj_fs", &vjj_fs, &b_vjj_fs);
   fChain->SetBranchAddress("vjj_trig", &vjj_trig, &b_vjj_trig);
   fChain->SetBranchAddress("vjj_nextraj", &vjj_nextraj, &b_vjj_nextraj);
   fChain->SetBranchAddress("vjj_ncentj", &vjj_ncentj, &b_vjj_ncentj);
   fChain->SetBranchAddress("vjj_lead_flav", &vjj_lead_flav, &b_vjj_lead_flav);
   fChain->SetBranchAddress("vjj_sublead_flav", &vjj_sublead_flav, &b_vjj_sublead_flav);
   fChain->SetBranchAddress("nwgt", &nwgt, &b_nwgt);
   fChain->SetBranchAddress("vjj_isGood", &vjj_isGood, &b_vjj_isGood);
   fChain->SetBranchAddress("genvjj_trigHighPtWgt", &genvjj_trigHighPtWgt, &b_genvjj_trigHighPtWgt);
   fChain->SetBranchAddress("genvjj_trigHighPtWgtUp", &genvjj_trigHighPtWgtUp, &b_genvjj_trigHighPtWgtUp);
   fChain->SetBranchAddress("genvjj_trigHighPtWgtDn", &genvjj_trigHighPtWgtDn, &b_genvjj_trigHighPtWgtDn);
   fChain->SetBranchAddress("genvjj_v_pt", &genvjj_v_pt, &b_genvjj_v_pt);
   fChain->SetBranchAddress("genvjj_v_eta", &genvjj_v_eta, &b_genvjj_v_eta);
   fChain->SetBranchAddress("genvjj_v_phi", &genvjj_v_phi, &b_genvjj_v_phi);
   fChain->SetBranchAddress("genvjj_v_m", &genvjj_v_m, &b_genvjj_v_m);
   fChain->SetBranchAddress("genvjj_v_ystar", &genvjj_v_ystar, &b_genvjj_v_ystar);
   fChain->SetBranchAddress("genvjj_lead_pt", &genvjj_lead_pt, &b_genvjj_lead_pt);
   fChain->SetBranchAddress("genvjj_lead_eta", &genvjj_lead_eta, &b_genvjj_lead_eta);
   fChain->SetBranchAddress("genvjj_lead_phi", &genvjj_lead_phi, &b_genvjj_lead_phi);
   fChain->SetBranchAddress("genvjj_lead_m", &genvjj_lead_m, &b_genvjj_lead_m);
   fChain->SetBranchAddress("genvjj_lead_dr2v", &genvjj_lead_dr2v, &b_genvjj_lead_dr2v);
   fChain->SetBranchAddress("genvjj_lead_dphiv", &genvjj_lead_dphiv, &b_genvjj_lead_dphiv);
   fChain->SetBranchAddress("genvjj_lead_detav", &genvjj_lead_detav, &b_genvjj_lead_detav);
   fChain->SetBranchAddress("genvjj_sublead_pt", &genvjj_sublead_pt, &b_genvjj_sublead_pt);
   fChain->SetBranchAddress("genvjj_sublead_eta", &genvjj_sublead_eta, &b_genvjj_sublead_eta);
   fChain->SetBranchAddress("genvjj_sublead_phi", &genvjj_sublead_phi, &b_genvjj_sublead_phi);
   fChain->SetBranchAddress("genvjj_sublead_m", &genvjj_sublead_m, &b_genvjj_sublead_m);
   fChain->SetBranchAddress("genvjj_sublead_dr2v", &genvjj_sublead_dr2v, &b_genvjj_sublead_dr2v);
   fChain->SetBranchAddress("genvjj_sublead_dphiv", &genvjj_sublead_dphiv, &b_genvjj_sublead_dphiv);
   fChain->SetBranchAddress("genvjj_sublead_detav", &genvjj_sublead_detav, &b_genvjj_sublead_detav);
   fChain->SetBranchAddress("genvjj_sublead_isloosePU", &genvjj_sublead_isloosePU, &b_genvjj_sublead_isloosePU);
   fChain->SetBranchAddress("genvjj_j_maxAbsEta", &genvjj_j_maxAbsEta, &b_genvjj_j_maxAbsEta);
   fChain->SetBranchAddress("genvjj_j_minAbsEta", &genvjj_j_minAbsEta, &b_genvjj_j_minAbsEta);
   fChain->SetBranchAddress("genvjj_jj_pt", &genvjj_jj_pt, &b_genvjj_jj_pt);
   fChain->SetBranchAddress("genvjj_jj_eta", &genvjj_jj_eta, &b_genvjj_jj_eta);
   fChain->SetBranchAddress("genvjj_jj_phi", &genvjj_jj_phi, &b_genvjj_jj_phi);
   fChain->SetBranchAddress("genvjj_jj_m", &genvjj_jj_m, &b_genvjj_jj_m);
   fChain->SetBranchAddress("genvjj_jj_dr2v", &genvjj_jj_dr2v, &b_genvjj_jj_dr2v);
   fChain->SetBranchAddress("genvjj_jj_scalarht", &genvjj_jj_scalarht, &b_genvjj_jj_scalarht);
   fChain->SetBranchAddress("genvjj_jj_deta", &genvjj_jj_deta, &b_genvjj_jj_deta);
   fChain->SetBranchAddress("genvjj_jj_dphi", &genvjj_jj_dphi, &b_genvjj_jj_dphi);
   fChain->SetBranchAddress("genvjj_jj_sumabseta", &genvjj_jj_sumabseta, &b_genvjj_jj_sumabseta);
   fChain->SetBranchAddress("genvjj_vjj_pt", &genvjj_vjj_pt, &b_genvjj_vjj_pt);
   fChain->SetBranchAddress("genvjj_vjj_eta", &genvjj_vjj_eta, &b_genvjj_vjj_eta);
   fChain->SetBranchAddress("genvjj_vjj_phi", &genvjj_vjj_phi, &b_genvjj_vjj_phi);
   fChain->SetBranchAddress("genvjj_vjj_m", &genvjj_vjj_m, &b_genvjj_vjj_m);
   fChain->SetBranchAddress("genvjj_vjj_dphi", &genvjj_vjj_dphi, &b_genvjj_vjj_dphi);
   fChain->SetBranchAddress("genvjj_vjj_deta", &genvjj_vjj_deta, &b_genvjj_vjj_deta);
   fChain->SetBranchAddress("genvjj_vjj_scalarht", &genvjj_vjj_scalarht, &b_genvjj_vjj_scalarht);
   fChain->SetBranchAddress("genvjj_vjj_isotropy", &genvjj_vjj_isotropy, &b_genvjj_vjj_isotropy);
   fChain->SetBranchAddress("genvjj_vjj_circularity", &genvjj_vjj_circularity, &b_genvjj_vjj_circularity);
   fChain->SetBranchAddress("genvjj_vjj_sphericity", &genvjj_vjj_sphericity, &b_genvjj_vjj_sphericity);
   fChain->SetBranchAddress("genvjj_vjj_aplanarity", &genvjj_vjj_aplanarity, &b_genvjj_vjj_aplanarity);
   fChain->SetBranchAddress("genvjj_vjj_C", &genvjj_vjj_C, &b_genvjj_vjj_C);
   fChain->SetBranchAddress("genvjj_vjj_D", &genvjj_vjj_D, &b_genvjj_vjj_D);
   fChain->SetBranchAddress("genvjj_centj_pt", &genvjj_centj_pt, &b_genvjj_centj_pt);
   fChain->SetBranchAddress("genvjj_centj_eta", &genvjj_centj_eta, &b_genvjj_centj_eta);
   fChain->SetBranchAddress("genvjj_centj_phi", &genvjj_centj_phi, &b_genvjj_centj_phi);
   fChain->SetBranchAddress("genvjj_centj_m", &genvjj_centj_m, &b_genvjj_centj_m);
   fChain->SetBranchAddress("genvjj_centj_ystar", &genvjj_centj_ystar, &b_genvjj_centj_ystar);
   fChain->SetBranchAddress("genvjj_centj_dr2v", &genvjj_centj_dr2v, &b_genvjj_centj_dr2v);
   fChain->SetBranchAddress("genvjj_htsoft", &genvjj_htsoft, &b_genvjj_htsoft);
   fChain->SetBranchAddress("genvjj_centhtsoft", &genvjj_centhtsoft, &b_genvjj_centhtsoft);
   fChain->SetBranchAddress("genvjj_nwgt", &genvjj_nwgt, &b_genvjj_nwgt);
   fChain->SetBranchAddress("genvjj_fs", &genvjj_fs, &b_genvjj_fs);
   fChain->SetBranchAddress("genvjj_trig", &genvjj_trig, &b_genvjj_trig);
   fChain->SetBranchAddress("genvjj_nextraj", &genvjj_nextraj, &b_genvjj_nextraj);
   fChain->SetBranchAddress("genvjj_ncentj", &genvjj_ncentj, &b_genvjj_ncentj);
   fChain->SetBranchAddress("genvjj_lead_flav", &genvjj_lead_flav, &b_genvjj_lead_flav);
   fChain->SetBranchAddress("genvjj_sublead_flav", &genvjj_sublead_flav, &b_genvjj_sublead_flav);
   fChain->SetBranchAddress("genvjj_wgt", genvjj_wgt, &b_genvjj_wgt);
   fChain->SetBranchAddress("genvjj_isGood", &genvjj_isGood, &b_genvjj_isGood);
   fChain->SetBranchAddress("genvjj_hasPromptPhoton", &genvjj_hasPromptPhoton, &b_genvjj_hasPromptPhoton);
   Notify();
}
