...
//	   Mjj_JEC[0] = Mjj;deltaeta_JEC[0] = deltaeta;
	   ...
	   deltaeta_JER[2]= deltaeta_JER_down;
           ...
           if(lep==13)
		   actualWeight = scalef* pileupWeight  *muon1_id_scale*muon2_id_scale*muon1_iso_scale*muon2_iso_scale*photon_id_scale;
           if(lep==11)
		   actualWeight = scalef* pileupWeight  *ele1_id_scale*ele2_id_scale*ele1_reco_scale*ele2_reco_scale*photon_id_scale;
