...
qcd="jes_QCD=[1.12, 1.05, 1.00, 1.14, 1.20, 1.26, 1.33]"
ewk="jes_EWK=[1.03, 1.03, 1.04, 1.15, 1.02, 1.03, 1.03]"
run 
...
qcd="jes_QCD=[1.08, 1.13, 1.27, 1.20, 1.48, 1.16, 1.34]"
ewk="jes_EWK=[1.02, 1.01, 1.05, 1.00, 1.03, 1.05, 1.04]"
run 
...
qcd="jes_QCD=[1.02, 1.01, 1.05, 1.00, 1.03, 1.05, 1.04]"
ewk="jes_EWK=[1.02, 1.01, 1.05, 1.00, 1.03, 1.05, 1.04]"
run 
