...
do
    ...
    do
      python2.6 draw_1d_limit_plot.py f${operator[$i]} "F_{${operator[$i]}} / #Lambda^{4} (TeV^{-4})"  "expected 95% confidence limit" ../higgs_root/higgsCombinenominal.MultiDimFit.mH125.expected.f${operator[$i]}_${year[$j]}.root "expected 2#DeltaNLL" 
