...
//=========  (Fri Jun  5 17:43:56 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-225.7867,1.0625,1511.034);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(1290.21);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(1354.72);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,1.103969);
   unrolledsPhist_stack_1->SetBinError(1,0.5009204);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,7.21925);
   unrolledsPhist_stack_2->SetBinError(1,1.674191);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,9.491767);
   unrolledsPhist_stack_3->SetBinError(1,2.047695);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,286.4738);
   unrolledsPhist_stack_5->SetBinError(1,8.072984);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,333.1874);
   unrolledsPhist_stack_6->SetBinError(1,14.6287);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,7.628781);
   unrolledsPhist_stack_7->SetBinError(1,0.4247345);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [7.63]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [333.19]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [286.47]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [9.49]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [7.22]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [1.10]","lpf");
