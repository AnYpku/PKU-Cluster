...
//=========  (Sun Jan 19 19:41:37 2020) by ROOT version6.10/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-224.8934,1.0625,1505.056);
   pad1->SetFillColor(0);
   ...
   ST_stack_1->SetBinContent(1,3.733208);
   ST_stack_1->SetBinError(1,0.9319797);
   ...
   TTA_stack_2->SetBinContent(1,37.11099);
   TTA_stack_2->SetBinError(1,3.49112);
   ...
   VV_stack_3->SetBinContent(1,16.52079);
   VV_stack_3->SetBinError(1,2.592146);
   ...
   plj_stack_5->SetBinContent(1,468.1684);
   plj_stack_5->SetBinError(1,12.01285);
   ...
   t_ZA_stack_6->SetBinContent(1,740.2997);
   t_ZA_stack_6->SetBinError(1,20.99182);
   ...
   ZA_sig_stack_7->SetBinContent(1,19.27191);
   ZA_sig_stack_7->SetBinError(1,0.6539386);
