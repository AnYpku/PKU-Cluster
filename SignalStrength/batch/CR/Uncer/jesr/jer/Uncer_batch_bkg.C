...
void run(TString dir, TString sample,TString cut1[num],int kk,TString tag,bool turn){
     ...
     for(int j=0;j<kk;j++){
	     ...
	     th1[j] = new TH1D(th1name[j],th1name[j],1,0,1);
	     th1[j]->Sumw2(); 
     }
...
//             cout<<detajj_new<<" "<<Mjj_new<<"; "<<detajj_JER_up<<" "<<Mjj_JER_up<<"; "<<detajj_JER_down<<" "<<Mjj_JER_down<<endl;
     ...
     if(sample.Contains("EWK")&&turn==1)
	     fout=new TFile("./hist_"+sample+"out_jer"+tag+"CR.root","recreate");
     else 
	     fout=new TFile("./hist_"+sample+"_jer"+tag+"CR.root","recreate");
     fout->cd();
     for(int i=0;i<kk;i++){
	     th1[i]->Write();
     }
...
int Uncer_batch_bkg(){
	...
	TString JET_new ="jet1pt_new> 30 && jet2pt_new > 30 && fabs(jet1eta_new)< 4.7 && fabs(jet2eta_new)<4.7 && Mjj_new > 150 && Mjj_new<400 && drla > 0.7 && drla2 > 0.7 && drj1a_new > 0.5 && drj2a_new > 0.5 && ("+drjj_new+") && drj1l_new > 0.5 && drj2l_new > 0.5 && drj1l2_new > 0.5 && drj2l2_new > 0.5";
	TString JET_down="jet1pt_JER_down> 30 && jet2pt_JER_down > 30 && fabs(jet1eta_JER_down)< 4.7 && fabs(jet2eta_JER_down)<4.7 && Mjj_JER_down>150 && Mjj_JER_down<400 && drla > 0.7 && drla2 > 0.7 && drj1a_JER_down > 0.5 && drj2a_JER_down > 0.5  && ("+drjj_JER_down+")&& drj1l_JER_down > 0.5 && drj2l_JER_down > 0.5 && drj1l2_JER_down > 0.5 && drj2l2_JER_down > 0.5 ";
	TString JET_up="jet1pt_JER_up> 30 && jet2pt_JER_up > 30 && fabs(jet1eta_JER_up)< 4.7 && fabs(jet2eta_JER_up)<4.7 && Mjj_JER_up>150 && Mjj_JER_up<400 && drla > 0.7 && drla2 > 0.7 && drj1a_JER_up > 0.5 && drj2a_JER_up > 0.5  && ("+drjj_JER_up+") && drj1l_JER_up > 0.5 && drj2l_JER_up > 0.5 && drj1l2_JER_up > 0.5 && drj2l2_JER_up > 0.5";
	...
	for(int i=0;i<tags.size();i++){
		if(tags[i].Contains("17")){
			...
			JET_up="( (!(fabs(jet2eta_JER_up)<3.14 && fabs(jet2eta_JER_up)>2.65) && !(fabs(jet1eta_JER_up)<3.14 && fabs(jet1eta_JER_up)>2.65) &&  jet1pt_JER_up<50 && jet2pt_JER_up<50 && jet1pt_JER_up>30 && jet2pt_JER_up>30 && fabs(jet1eta_JER_up)< 4.7 && fabs(jet2eta_JER_up)<4.7) || (jet1pt_JER_up>50 && jet2pt_JER_up>50 && fabs(jet1eta_JER_up)< 4.7 && fabs(jet2eta_JER_up)<4.7) )";
			JET_down="( (!(fabs(jet2eta_JER_down)<3.14 && fabs(jet2eta_JER_down)>2.65) && !(fabs(jet1eta_JER_down)<3.14 && fabs(jet1eta_JER_down)>2.65) &&  jet1pt_JER_down<50 && jet2pt_JER_down<50 && jet1pt_JER_down>30 && jet2pt_JER_down>30 && fabs(jet1eta_JER_down)< 4.7 && fabs(jet2eta_JER_down)<4.7) || (jet1pt_JER_down>50 && jet2pt_JER_down>50 && fabs(jet1eta_JER_down)< 4.7 && fabs(jet2eta_JER_down)<4.7) )";
		}
		else{
			GenJet = "genjet1pt>30 && genjet2pt>30 && fabs(genjet1eta)<4.7 && fabs(genjet2eta)<4.7";
			JET_new ="jet1pt_new> 30 && jet2pt_new > 30 && fabs(jet1eta_new)< 4.7 && fabs(jet2eta_new)<4.7 && Mjj_new>150 && Mjj_new<400 && drla > 0.7 && drla2 > 0.7 && drj1a_new > 0.5 && drj2a_new > 0.5 && ("+drjj_new+") && drj1l_new > 0.5 && drj2l_new > 0.5 && drj1l2_new > 0.5 && drj2l2_new > 0.5";
			JET_down="jet1pt_JER_down> 30 && jet2pt_JER_down > 30 && fabs(jet1eta_JER_down)< 4.7 && fabs(jet2eta_JER_down)<4.7 && Mjj_JER_down > 150 && Mjj_JER_down<400 && drla > 0.7 && drla2 > 0.7 && drj1a_JER_down > 0.5 && drj2a_JER_down > 0.5  && ("+drjj_JER_down+")&& drj1l_JER_down > 0.5 && drj2l_JER_down > 0.5 && drj1l2_JER_down > 0.5 && drj2l2_JER_down > 0.5";
			JET_up="jet1pt_JER_up> 30 && jet2pt_JER_up > 30 && fabs(jet1eta_JER_up)< 4.7 && fabs(jet2eta_JER_up)<4.7 && Mjj_JER_up > 150 && Mjj_JER_up<400 && drla > 0.7 && drla2 > 0.7 && drj1a_JER_up > 0.5 && drj2a_JER_up > 0.5  && ("+drjj_JER_up+") && drj1l_JER_up > 0.5 && drj2l_JER_up > 0.5 && drj1l2_JER_up > 0.5 && drj2l2_JER_up > 0.5";
		}
