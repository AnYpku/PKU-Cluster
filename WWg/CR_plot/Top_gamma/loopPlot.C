...
//		continue;
		...
		sprintf(buffer, "./output-slimmed-rootfiles/histos_"+isChannel+channel+"_%s"+tag+".root", mc[i].c_str());
...
//		continue;
	...
	if (nMC > 0) {
		...
		sprintf(buffer, "./output-slimmed-rootfiles/histos_"+isChannel+channel+"_%s"+tag+".root", mc[0].c_str());
