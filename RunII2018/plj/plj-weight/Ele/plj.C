...
void plj::Loop(TString name)
{
   ...
   ifstream f1,f2;
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/fakephoton/elebarrel/step1/pljweight"+name+".txt");
   f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/fakephoton/eleendcap/step1/pljweight"+name+".txt");
