void fX0_parameterization_el(int index,vector<double>ZGbin){
        ...
        TString dir6="/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/2016/ele/hist/hist_ele_"; 
        TString dir7="/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/2017/ele/hist/hist_ele_"; 
        TString dir8="/afs/cern.ch/user/y/yian/work/PKU-Cluster/AQGC/2018/ele/hist/hist_ele_"; 
...
//      ParamSetf.open("paramsets_fT0_mu.txt");
        if(index==1) {ParamSetf.open("paramsets_fM0_el.txt"); }
        if(index==2) {ParamSetf.open("paramsets_fM1_el.txt"); }
        if(index==3) {ParamSetf.open("paramsets_fM2_el.txt"); }
        if(index==4) {ParamSetf.open("paramsets_fM3_el.txt"); }
        if(index==5) {ParamSetf.open("paramsets_fM4_el.txt"); }
        if(index==6) {ParamSetf.open("paramsets_fM5_el.txt"); }
        if(index==7) {ParamSetf.open("paramsets_fM6_el.txt"); }
        if(index==8) {ParamSetf.open("paramsets_fM7_el.txt"); }
        if(index==9) {ParamSetf.open("paramsets_fT0_el.txt"); }
        if(index==10){ParamSetf.open("paramsets_fT1_el.txt");}
        if(index==11){ParamSetf.open("paramsets_fT2_el.txt");}
        if(index==12){ParamSetf.open("paramsets_fT5_el.txt");}
        if(index==13){ParamSetf.open("paramsets_fT6_el.txt");}
        if(index==14){ParamSetf.open("paramsets_fT7_el.txt");}
        if(index==15){ParamSetf.open("paramsets_fT8_el.txt");}
        if(index==16){ParamSetf.open("paramsets_fT9_el.txt");}


	const int num=ZGbin.size()-1;
	TFile* fout = new TFile("signal_proc_el__"+name+".root", "RECREATE");
...
for(int i=1;i<17;i++){
	...
	fX0_parameterization_el(i,ZGbin);
}
