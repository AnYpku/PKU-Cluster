...
//=========  (Thu Nov 14 01:35:02 2019) by ROOT version6.06/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-51.25,-57.64891,423.75,385.8042);
   pad1->SetFillColor(0);
   ...
   hs_stack_1->SetMaximum(345.8935);
   ...
   hist__2->SetBinContent(1,1.533322);
   hist__2->SetBinContent(2,2.486469);
   hist__2->SetBinContent(3,1.07747);
   hist__2->SetBinContent(4,0.3729703);
   hist__2->SetBinContent(5,0.1243234);
   hist__2->SetBinError(1,0.5258292);
   hist__2->SetBinError(2,0.690962);
   hist__2->SetBinError(3,0.3974895);
   hist__2->SetBinError(4,0.2153345);
   hist__2->SetBinError(5,0.09266523);
   ...
   hist__3->SetBinContent(1,1.475552);
   hist__3->SetBinContent(2,7.377759);
   hist__3->SetBinContent(3,7.595646);
   hist__3->SetBinContent(4,3.16899);
   hist__3->SetBinContent(5,1.475552);
   hist__3->SetBinError(1,1.475552);
   hist__3->SetBinError(2,3.299434);
   hist__3->SetBinError(3,3.402462);
   hist__3->SetBinError(4,2.246105);
   hist__3->SetBinError(5,1.475552);
   ...
   hist__5->SetBinContent(1,94.07178);
   hist__5->SetBinContent(2,163.9712);
   hist__5->SetBinContent(3,59.46386);
   hist__5->SetBinContent(4,31.50302);
   hist__5->SetBinContent(5,12.61878);
   hist__5->SetBinError(1,6.401755);
   hist__5->SetBinError(2,8.401654);
   hist__5->SetBinError(3,5.011904);
   hist__5->SetBinError(4,3.58839);
   hist__5->SetBinError(5,2.349455);
   ...
   hist__6->SetBinContent(1,42.61325);
   hist__6->SetBinContent(2,120.0108);
   hist__6->SetBinContent(3,56.09093);
   hist__6->SetBinContent(4,38.64923);
   hist__6->SetBinContent(5,20.41472);
   hist__6->SetBinError(1,2.565155);
   hist__6->SetBinError(2,4.386251);
   hist__6->SetBinError(3,3.217337);
   hist__6->SetBinError(4,2.557486);
   hist__6->SetBinError(5,1.827325);
