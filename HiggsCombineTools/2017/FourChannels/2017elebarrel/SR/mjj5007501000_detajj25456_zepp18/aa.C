...
//=========  (Mon Jun  8 03:37:22 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-5.626603,7.4375,37.65496);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(32.15202);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(33.75962);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,-0.001241482);
   unrolledsPhist_stack_2->SetBinContent(2,-0.01168971);
   unrolledsPhist_stack_2->SetBinContent(3,-0.001403348);
   unrolledsPhist_stack_2->SetBinContent(4,0.135689);
   unrolledsPhist_stack_2->SetBinContent(5,0.04942046);
   unrolledsPhist_stack_2->SetBinContent(6,0.06116582);
   unrolledsPhist_stack_2->SetBinContent(7,0.04657929);
   unrolledsPhist_stack_2->SetBinError(1,0.2539499);
   unrolledsPhist_stack_2->SetBinError(2,0.1482324);
   unrolledsPhist_stack_2->SetBinError(3,0.05950731);
   unrolledsPhist_stack_2->SetBinError(4,0.08218267);
   unrolledsPhist_stack_2->SetBinError(5,0.1204979);
   unrolledsPhist_stack_2->SetBinError(6,0.08454203);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,0.2944972);
   unrolledsPhist_stack_3->SetBinContent(3,0.2761711);
   unrolledsPhist_stack_3->SetBinContent(4,0.1952689);
   unrolledsPhist_stack_3->SetBinError(1,0.2920027);
   unrolledsPhist_stack_3->SetBinError(3,0.2761711);
   unrolledsPhist_stack_3->SetBinError(4,0.1952689);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,6.552417);
   unrolledsPhist_stack_5->SetBinContent(2,1.492421);
   unrolledsPhist_stack_5->SetBinContent(4,3.089224);
   unrolledsPhist_stack_5->SetBinContent(5,3.000098);
   unrolledsPhist_stack_5->SetBinContent(6,0.511474);
   unrolledsPhist_stack_5->SetBinContent(7,3.09674);
   unrolledsPhist_stack_5->SetBinError(1,1.531755);
   unrolledsPhist_stack_5->SetBinError(2,0.7066766);
   unrolledsPhist_stack_5->SetBinError(4,1.03909);
   unrolledsPhist_stack_5->SetBinError(5,1.09278);
   unrolledsPhist_stack_5->SetBinError(6,0.3636583);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,10.77229);
   unrolledsPhist_stack_6->SetBinContent(2,3.855935);
   unrolledsPhist_stack_6->SetBinContent(3,0.2102463);
   unrolledsPhist_stack_6->SetBinContent(4,6.84991);
   unrolledsPhist_stack_6->SetBinContent(5,1.917846);
   unrolledsPhist_stack_6->SetBinContent(6,0.6996761);
   unrolledsPhist_stack_6->SetBinContent(7,2.632504);
   unrolledsPhist_stack_6->SetBinError(1,1.427944);
   unrolledsPhist_stack_6->SetBinError(2,0.7159842);
   unrolledsPhist_stack_6->SetBinError(3,0.3594929);
   unrolledsPhist_stack_6->SetBinError(4,1.161066);
   unrolledsPhist_stack_6->SetBinError(5,0.5715904);
   unrolledsPhist_stack_6->SetBinError(6,0.2901696);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,4.555845);
   unrolledsPhist_stack_7->SetBinContent(2,4.043273);
   unrolledsPhist_stack_7->SetBinContent(3,2.201982);
   unrolledsPhist_stack_7->SetBinContent(4,0.4410519);
   unrolledsPhist_stack_7->SetBinContent(5,1.703082);
   unrolledsPhist_stack_7->SetBinContent(6,3.208426);
   unrolledsPhist_stack_7->SetBinContent(7,1.213496);
   unrolledsPhist_stack_7->SetBinError(1,0.2609385);
   unrolledsPhist_stack_7->SetBinError(2,0.2427289);
   unrolledsPhist_stack_7->SetBinError(3,0.1717191);
   unrolledsPhist_stack_7->SetBinError(4,0.08288765);
   unrolledsPhist_stack_7->SetBinError(5,0.1597748);
   unrolledsPhist_stack_7->SetBinError(6,0.208616);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [17.37]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [26.94]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [17.74]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [0.77]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [0.28]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.00]","lpf");
