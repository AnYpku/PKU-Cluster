...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2018/FourChannels/2018eleendcap/SR/mjj5007501000_detajj25456_zepp18/aa.root")
tstack = f_in.Get("hs")
...
jes=[1.05,1.09,1.12,1.20,1.01,1.11,1.06]
jes_QCD=[1.18,1.23,1.45,1.69,1.80,1.13,2.31]
