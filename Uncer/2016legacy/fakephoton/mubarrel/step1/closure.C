...
TString dir =  "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/pesudo/mubarrel/txt/";
TString dir1 = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/pesudo/mubarrel/roofit/txt/";
...
//    cout<<fixed<<setprecision(0)<<lpt[i]<<"~"<<fixed<<setprecision(3)<<hpt[i]<<"\t"<<fabs(FakeNumber-fitFake_number)/FakeNumber<<endl;
 ...
 void run_calculate(Int_t a,Int_t b){
	...
	if(lowchiso[j]==8) low = lowchiso[j];
