...
int d_hist(){
	TH2D* h0    = run("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016elebarrel/output-slimmed-rootfiles/optimal_2016SR_plj_elebarrel.root",0);
	TH2D* hup   = run("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016elebarrel/output-slimmed-rootfiles/optimal_2016SR_plj_elebarrel_up.root",1);
	TH2D* hdown = run("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016elebarrel/output-slimmed-rootfiles/optimal_2016SR_plj_elebarrel_down.root",2);
