...
//=========  (Fri Jun  5 00:26:23 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-116.8341,1.0625,781.8897);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(667.6234);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(701.0045);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.569197);
   unrolledsPhist_stack_1->SetBinError(1,0.3289588);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,5.628916);
   unrolledsPhist_stack_2->SetBinError(1,1.125945);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,9.129708);
   unrolledsPhist_stack_3->SetBinError(1,3.315123);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,128.1106);
   unrolledsPhist_stack_5->SetBinError(1,5.666047);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,185.6601);
   unrolledsPhist_stack_6->SetBinError(1,6.152173);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,4.713167);
   unrolledsPhist_stack_7->SetBinError(1,0.2409483);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [4.71]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [185.66]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [128.11]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [9.13]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [5.63]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.57]","lpf");
