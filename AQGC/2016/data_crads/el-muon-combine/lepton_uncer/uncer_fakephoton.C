...
//	ofstream f1("./"+var+"_"+particle+"_"+type+"_"+tag+".txt");
	ofstream f2("./txt/Mva_"+particle+"_"+type+"_"+tag+".txt");
	TFile* file = new TFile("./Mva"+particle+"_"+type+"_2d_"+tag+".root");
	cout<<particle+"_"+type+tag+".root"<<endl;
	TH1D* h1 = (TH1D*)file->Get("Mva_0");
	TH1D* h2 = (TH1D*)file->Get("Mva_1");
	TH1D* h3 = (TH1D*)file->Get("Mva_2");
