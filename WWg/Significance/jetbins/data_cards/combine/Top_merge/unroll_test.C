...
//        fPads1->SetTopMargin(0.12);
	...
	TLegend* leg2 = new TLegend(0.17, 0.6, 0.31, 0.9);
        leg->SetFillColor(0);
        leg1->SetFillColor(0);
        leg2->SetFillColor(0);
...
//		latex.DrawLatex(24.5, 1.2*max,"m_{#font[12]{ll}}>160");
		...
		latex.DrawLatex(0.5,1.6*max,"20<m_{#font[12]{ll}}<80");
		latex.DrawLatex(4.2,1.6*max,"80<m_{#font[12]{ll}}<140");
		latex.DrawLatex(8.6,1.6*max,"m_{#font[12]{ll}}>140");
