...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ifstream f1;
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/fakephoton/barrel/step1/pljweight_down.txt");
//   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/fakephoton/barrel/step1/pljweight_up.txt");
