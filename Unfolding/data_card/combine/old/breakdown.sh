...
do
    ...
    do
      ...
      python plot1DScan.py higgsCombine.${filename}_rBin${i}.MultiDimFit.mH125.root --others 'higgsCombine.freezeAll.MultiDimFit.mH125.root:FreezeAll:2' -o freeze_${filename}_rBin${i} --breakdown Syst,Stat --POI r_Bin${i}
    done
done
