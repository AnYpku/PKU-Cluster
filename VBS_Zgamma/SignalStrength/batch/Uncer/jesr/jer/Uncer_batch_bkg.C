...
//             cout<<detajj_new<<" "<<Mjj_new<<"; "<<detajj_JER_up<<" "<<Mjj_JER_up<<"; "<<detajj_JER_down<<" "<<Mjj_JER_down<<endl;
		     ...
		     for(int ik=0;ik<3;ik++){
			    if (  !(tformula[ik]->EvalInstance() && (delta_phi_JER[ik]>1.9 && zepp_JER[ik]<2.4)) )
				    continue;
			    if(k%20000==0)cout<<"actualWeight "<<actualWeight<<endl;
			    if(Mjj_JER[ik]>=500 && Mjj_JER[ik]<800&&detajj_JER[ik]>=2.5&&detajj_JER[ik]<4.5)
				    th1[ik]->Fill(0.5,weight[ik]);//0~1, 2.5~4.5 and 500~800
			    if(Mjj_JER[ik]>=800 &&Mjj_JER[ik]<1200&&detajj_JER[ik]>=2.5&&detajj_JER[ik]<4.5)
				    th1[ik]->Fill(1.5,weight[ik]);//1~2 2.5~4.5 and 800~1200
			    if(Mjj_JER[ik]>=1200&&detajj_JER[ik]>=2.5&&detajj_JER[ik]<4.5)
				    th1[ik]->Fill(2.5,weight[ik]);//2~3 2.5~4.5 1200~2000
			    if(Mjj_JER[ik]>=500 &&Mjj_JER[ik]<800&&detajj_JER[ik]>=4.5&&detajj_JER[ik]<6)
				    th1[ik]->Fill(3.5,weight[ik]);//3~4 4.5~6 500~800 
			    if(Mjj_JER[ik]>=800 &&Mjj_JER[ik]<1200&&detajj_JER[ik]>=4.5&&detajj_JER[ik]<6)
				    th1[ik]->Fill(4.5,weight[ik]);//4~5 4.5~6 800~1200
			    if(Mjj_JER[ik]>=1200&&detajj_JER[ik]>=4.5&&detajj_JER[ik]<6)
				    th1[ik]->Fill(5.5,weight[ik]);//5~6 6~infi 500~800
			    if(Mjj_JER[ik]>=500 &&Mjj_JER[ik]<800&&detajj_JER[ik]>=6)
				    th1[ik]->Fill(6.5,weight[ik]);//6~7 6~infi 800~1200
			    if(Mjj_JER[ik]>=800 &&Mjj_JER[ik]<1200&&detajj_JER[ik]>=6)
				    th1[ik]->Fill(7.5,weight[ik]);//7~8 6~infi800~1200
			    if(Mjj_JER[ik]>=1200&&detajj_JER[ik]>=6)
