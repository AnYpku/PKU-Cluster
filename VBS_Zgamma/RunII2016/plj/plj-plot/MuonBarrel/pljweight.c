...
void open(Int_t i){
    ...
    ifstream f1;
    f1.open(Form("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/BarrelMuon/ZAfit/txt/fakerate_ZA_pt%0.f_%0.f.txt",lowpt[i],highpt[i]));
