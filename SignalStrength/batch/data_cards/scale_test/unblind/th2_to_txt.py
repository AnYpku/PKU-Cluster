...
f_ZA_interf = TFile.Open(fdir+'hist_ZA_interf_'+sys.argv[1]+sys.argv[2]+'.root')
...
#
   ...
   if arr['scale_muR1'][i-1]>1.000:
      f.write('theory group = pdf_EW pdf_QCD Scale_EW Scale_muF1 Scale_muR1 Scale_muFmuR \n')
   else:
      f.write('theory group = pdf_EW pdf_QCD Scale_EW Scale_muF1 Scale_muFmuR \n')
#
   f.write('photon_id\tlnN\t')
   f.write('%0.3f\t%0.3f\t-\t%0.3f\t%0.3f\t%0.3f\t%0.3f\n'%(arr['photon_ZA-EWK_ID'][i-1],arr['photon_ZA_ID'][i-1],arr['photon_TTA_ID'][i-1],arr['photon_VV_ID'][i-1],arr['photon_ST_ID'][i-1],arr['photon_ZA-EWK_ID'][i-1]))
#
   if sys.argv[2].find("ele") == -1: 
      f.write('mu_eff\tlnN\t')
      f.write('%0.3f\t%0.3f\t-\t%0.3f\t%0.3f\t%0.3f\t%0.3f\n'%(arr['muon_ZA-EWK_all'][i-1],arr['muon_ZA_all'][i-1],arr['muon_TTA_all'][i-1],arr['muon_VV_all'][i-1],arr['muon_ST_all'][i-1],arr['muon_ZA-EWK_all'][i-1]))
      ...
      f.write('egamma group = photon_id\n')
#   
   else: 
      f.write('ele_reco\tlnN\t')
      f.write('%0.3f\t%0.3f\t-\t%0.3f\t%0.3f\t%0.3f\t%0.3f\n'%(arr['ele_ZA-EWK_reco'][i-1],arr['ele_ZA_reco'][i-1],arr['ele_TTA_reco'][i-1],arr['ele_VV_reco'][i-1],arr['ele_ST_reco'][i-1],arr['ele_ZA-EWK_reco'][i-1]))
#
      f.write('ele_ID\tlnN\t')
      f.write('%0.3f\t%0.3f\t-\t%0.3f\t%0.3f\t%0.3f\t%0.3f\n'%(arr['ele_ZA-EWK_ID'][i-1],arr['ele_ZA_ID'][i-1],arr['ele_TTA_ID'][i-1],arr['ele_VV_ID'][i-1],arr['ele_ST_ID'][i-1],arr['ele_ZA-EWK_ID'][i-1]))
