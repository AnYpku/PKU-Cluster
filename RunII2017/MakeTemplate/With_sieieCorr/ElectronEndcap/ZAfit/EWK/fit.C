...
TString name ;
TFile* fdata = TFile::Open("../../root/Data_template3-Data.root");
TFile* ffake = TFile::Open("../../root/Fake_template3-Data.root");
TFile* ftrue = TFile::Open("../../root/True_template3-ZA.root");
//TFile* ftrue = TFile::Open("../../root/True_template3-ZA-EWK.root");
...
//	RooRealVar nTrue("true number", "true number",800,0, nData);
	...
	Double_t nDataInWindow = hdata->IntegralAndError(0,sieie_bin,nDataInWindowErr);
