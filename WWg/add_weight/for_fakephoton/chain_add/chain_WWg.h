...
// Mon Jun  7 16:32:58 2021 by ROOT version 6.12/07
// from TChain Events/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         CorrT1METJet_area[52];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[52];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[52];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[52];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawPt[52];   //[nCorrT1METJet]
   ...
   Float_t         Jet_btagDeepCvB[47];   //[nJet]
   Float_t         Jet_btagDeepCvL[47];   //[nJet]
   Float_t         Jet_btagDeepFlavB[47];   //[nJet]
   Float_t         Jet_btagDeepFlavC[47];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[47];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[47];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[47];   //[nJet]
   Float_t         Jet_chEmEF[47];   //[nJet]
   Float_t         Jet_chFPV0EF[47];   //[nJet]
   Float_t         Jet_chFPV1EF[47];   //[nJet]
   Float_t         Jet_chFPV2EF[47];   //[nJet]
   Float_t         Jet_chFPV3EF[47];   //[nJet]
   Float_t         Jet_chHEF[47];   //[nJet]
   Float_t         Jet_eta[47];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[47];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[47];   //[nJet]
   Float_t         Jet_mass[47];   //[nJet]
   Float_t         Jet_muEF[47];   //[nJet]
   Float_t         Jet_muonSubtrFactor[47];   //[nJet]
   Float_t         Jet_neEmEF[47];   //[nJet]
   Float_t         Jet_neHEF[47];   //[nJet]
   Float_t         Jet_phi[47];   //[nJet]
   Float_t         Jet_pt[47];   //[nJet]
   Float_t         Jet_puIdDisc[47];   //[nJet]
   Float_t         Jet_qgl[47];   //[nJet]
   Float_t         Jet_rawFactor[47];   //[nJet]
   Float_t         Jet_bRegCorr[47];   //[nJet]
   Float_t         Jet_bRegRes[47];   //[nJet]
   Float_t         Jet_cRegCorr[47];   //[nJet]
   Float_t         Jet_cRegRes[47];   //[nJet]
   Int_t           Jet_electronIdx1[47];   //[nJet]
   Int_t           Jet_electronIdx2[47];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[47];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[47];   //[nJet]
   ...
   Float_t         lumi;
   Int_t           channel;
   Char_t          pass_selection1;
   Char_t          pass_selection2;
   Int_t           photon_selection;
   Int_t           njets_fake;
   Int_t           njets_fake_template;
   Int_t           lep1_pid;
   Int_t           lep2_pid;
   Float_t         lep1pt;
   Float_t         lep2pt;
   ...
   Float_t         photoneta_f;
   Float_t         photonphi_f;
   Float_t         photonchiso_f;
   Float_t         photonsieie_f;
   Int_t           photon_isprompt_f;
   Int_t           photon_gen_matching_f;
   Float_t         mll;
   Float_t         ptll;
   Float_t         mt;
   Float_t         met;
   ...
   TBranch        *b_lumi;   //!
   TBranch        *b_channel;   //!
   TBranch        *b_pass_selection1;   //!
   TBranch        *b_pass_selection2;   //!
   TBranch        *b_photon_selection;   //!
   TBranch        *b_njets_fake;   //!
   TBranch        *b_njets_fake_template;   //!
   TBranch        *b_lep1_pid;   //!
   TBranch        *b_lep2_pid;   //!
   TBranch        *b_lep1pt;   //!
   TBranch        *b_lep2pt;   //!
   ...
   TBranch        *b_photon_isprompt_f;   //!
   TBranch        *b_photon_gen_matching_f;   //!
   TBranch        *b_mll;   //!
   TBranch        *b_ptll;   //!
   TBranch        *b_mt;   //!
   TBranch        *b_met;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("tree_156.root/Events");
      chain->Add("tree_151.root/Events");
      tree = chain;
#endif // SINGLE_TREE
...
void chain_WWg::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("pass_selection1", &pass_selection1, &b_pass_selection1);
   fChain->SetBranchAddress("pass_selection2", &pass_selection2, &b_pass_selection2);
   ...
   fChain->SetBranchAddress("njets_fake_template", &njets_fake_template, &b_njets_fake_template);
   ...
   fChain->SetBranchAddress("photon_isprompt_f", &photon_isprompt_f, &b_photon_isprompt_f);
   fChain->SetBranchAddress("photon_gen_matching_f", &photon_gen_matching_f, &b_photon_gen_matching_f);
