...
//=========  (Mon Jun  8 03:35:37 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-9.970782,7.4375,66.72754);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(56.9759);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(59.82469);
   ...
   unrolledsPhist_stack_1->SetBinContent(2,0.04928282);
   unrolledsPhist_stack_1->SetBinContent(4,0.002895215);
   unrolledsPhist_stack_1->SetBinError(2,0.04928282);
   unrolledsPhist_stack_1->SetBinError(4,0.002895215);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,1.29857);
   unrolledsPhist_stack_2->SetBinContent(2,0.242554);
   unrolledsPhist_stack_2->SetBinContent(3,0.05196177);
   unrolledsPhist_stack_2->SetBinContent(4,0.09163568);
   unrolledsPhist_stack_2->SetBinContent(5,0.09330381);
   unrolledsPhist_stack_2->SetBinContent(6,-0.1097527);
   unrolledsPhist_stack_2->SetBinContent(7,0.0630644);
   unrolledsPhist_stack_2->SetBinError(1,0.3830929);
   unrolledsPhist_stack_2->SetBinError(2,0.2122998);
   unrolledsPhist_stack_2->SetBinError(3,0.09381654);
   unrolledsPhist_stack_2->SetBinError(4,0.1277117);
   unrolledsPhist_stack_2->SetBinError(5,0.1256453);
   unrolledsPhist_stack_2->SetBinError(6,0.06993588);
   ...
   unrolledsPhist_stack_3->SetBinContent(5,0.02140887);
   unrolledsPhist_stack_3->SetBinError(5,0.02140887);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,13.21153);
   unrolledsPhist_stack_5->SetBinContent(2,2.324085);
   unrolledsPhist_stack_5->SetBinContent(3,2.532974);
   unrolledsPhist_stack_5->SetBinContent(4,6.820781);
   unrolledsPhist_stack_5->SetBinContent(5,4.815868);
   unrolledsPhist_stack_5->SetBinContent(6,1.349079);
   unrolledsPhist_stack_5->SetBinContent(7,6.545768);
   unrolledsPhist_stack_5->SetBinError(1,2.215681);
   unrolledsPhist_stack_5->SetBinError(2,0.8782096);
   unrolledsPhist_stack_5->SetBinError(3,0.9321355);
   unrolledsPhist_stack_5->SetBinError(4,1.516736);
   unrolledsPhist_stack_5->SetBinError(5,1.29723);
   unrolledsPhist_stack_5->SetBinError(6,0.6502266);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,17.84063);
   unrolledsPhist_stack_6->SetBinContent(2,3.548611);
   unrolledsPhist_stack_6->SetBinContent(3,1.286795);
   unrolledsPhist_stack_6->SetBinContent(4,6.349224);
   unrolledsPhist_stack_6->SetBinContent(5,1.354336);
   unrolledsPhist_stack_6->SetBinContent(6,0.7025752);
   unrolledsPhist_stack_6->SetBinContent(7,3.94248);
   unrolledsPhist_stack_6->SetBinError(1,1.814791);
   unrolledsPhist_stack_6->SetBinError(2,0.8083404);
   unrolledsPhist_stack_6->SetBinError(3,0.4051577);
   unrolledsPhist_stack_6->SetBinError(4,1.305976);
   unrolledsPhist_stack_6->SetBinError(5,0.6331238);
   unrolledsPhist_stack_6->SetBinError(6,0.5474951);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,6.943002);
   unrolledsPhist_stack_7->SetBinContent(2,5.018049);
   unrolledsPhist_stack_7->SetBinContent(3,3.441122);
   unrolledsPhist_stack_7->SetBinContent(4,0.5485503);
   unrolledsPhist_stack_7->SetBinContent(5,2.276559);
   unrolledsPhist_stack_7->SetBinContent(6,4.635552);
   unrolledsPhist_stack_7->SetBinContent(7,1.629871);
   unrolledsPhist_stack_7->SetBinError(1,0.3203735);
   unrolledsPhist_stack_7->SetBinError(2,0.2686748);
   unrolledsPhist_stack_7->SetBinError(3,0.2128766);
   unrolledsPhist_stack_7->SetBinError(4,0.09242983);
   unrolledsPhist_stack_7->SetBinError(5,0.1844487);
   unrolledsPhist_stack_7->SetBinError(6,0.2535387);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [24.49]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [35.02]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [37.60]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [0.02]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [1.73]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.05]","lpf");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.76,0.92,"41.522 fb^{-1} (13 TeV)");
tex->SetNDC();
