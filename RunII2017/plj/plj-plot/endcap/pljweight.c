...
Double_t lowpt[ptnumber]= {20,30,40,50,60,100};//i
Double_t highpt[ptnumber]={30,40,50,60,100,400};
Double_t bin_data[ptnumber],bin_plj[ptnumber],bin_za[ptnumber];
Double_t weight[ptnumber];
//TFile* f1 = new TFile("./plj-hist/cutla-outplj_rawnew_hb.root");
//TFile* f2 = new TFile("./plj-hist/cutla-outData_hb.root");
TFile* f1 = new TFile("./plj-hist/cutla-outplj_raw_he.root");
TFile* f2 = new TFile("./plj-hist/cutla-outData_he.root");
TFile* f3 = new TFile("./plj-hist/cutla-outZA_plj_he.root");
 
TH1F* h1 = (TH1F*)f1->Get("h_cutla-outplj_raw");
...
const char *name[ptnumber]={"20~30","30~40","40~50","50~60","60~100","100~400"};
for(Int_t i=0;i<ptnumber;i++){
