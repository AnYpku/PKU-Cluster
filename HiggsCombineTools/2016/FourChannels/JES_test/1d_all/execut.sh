...
qcd="jes_QCD=[1.07, 1.09, 1.14, 1.19, 1.24, 1.21, 1.35]" #2d
ewk="jes_EWK=[1.02, 1.01, 1.05, 1.06, 1.02, 1.04, 1.04]" #2d
#qcd="jes_QCD=[1.14, 1.19, 1.22, 1.14, 1.19, 1.22,1.17]" #1d
#ewk="jes_EWK=[1.02, 1.01, 1.04, 1.02, 1.01, 1.04,1.02]" #1d 
run 
