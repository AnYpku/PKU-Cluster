...
#qcd="jes_QCD=[1.21, 1.11, 1.21, 1.33, 1.94, 1.43, 1.56]" #2d
ewk="jes_EWK=[1.00, 1.05, 1.06, 1.16, 1.10, 1.09, 1.11]" #2d 
qcd="jes_QCD=[1.29, 1.47, 1.54, 1.29, 1.47, 1.54,1.37]" #1d
#ewk="jes_EWK=[1.01, 1.05, 1.08, 1.01, 1.05, 1.08,1.04]" #1d
run 
