...
//=========  (Fri Jun  5 00:14:31 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-162.4922,1.0625,1087.448);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(928.527);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(974.9533);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.8912392);
   unrolledsPhist_stack_1->SetBinError(1,0.4009722);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,12.60605);
   unrolledsPhist_stack_2->SetBinError(1,1.742524);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,5.301049);
   unrolledsPhist_stack_3->SetBinError(1,2.158413);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,123.5973);
   unrolledsPhist_stack_5->SetBinError(1,6.732128);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,314.2223);
   unrolledsPhist_stack_6->SetBinError(1,8.12732);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,7.645568);
   unrolledsPhist_stack_7->SetBinError(1,0.3127109);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [7.65]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [314.22]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [123.60]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [5.30]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [12.61]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.89]","lpf");
