...
void run(TString var, vector<double> Err,TString title){
	TFile*file1=new TFile(var+"_unfold_ewk_scale16.root");
	TFile*file2=new TFile(var+"_unfold_ewk_scale17.root");
	TFile*file3=new TFile(var+"_unfold_ewk_scale18.root");
