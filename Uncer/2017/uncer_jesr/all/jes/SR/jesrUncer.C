...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Double_t delta_phi_new,delta_phi_JEC_up,delta_phi_JEC_down,delta_phi;
   Double_t mjj_bins[4]={500,800,1200, 2000};
   Double_t deltaeta_bins[4]={2.5,4.5,6,6.5};
   mjj_JEC_down = new TH1D("h_down","mjj_JEC_down",3,0,3);
   mjj_JEC_up = new TH1D("h_up","mjj_JEC_up",3,0,3);
   for(int i=0;i<3;i++){
   ...
   TLorentzVector jet1p4_new, jet2p4_new;
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	   ...
	   JET = ( (!(fabs(jet2eta)<3.14 && fabs(jet2eta)>2.65) && !(fabs(jet1eta)<3.14 && fabs(jet1eta)>2.65) &&  jet1pt<50 && jet2pt<50 && jet1pt>30 && jet2pt>30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7) || (jet1pt>50 && jet2pt>50 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7) )/*jet1pt>30 && jet2pt>30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7*/ &&  Mjj > 500 && drla > 0.7 && drla2 > 0.7 && drj1a > 0.5 && drj2a > 0.5 && drjj> 0.5 && drj1l > 0.5 && drj2l > 0.5 && drj1l2 > 0.5 && drj2l2 > 0.5 && deltaeta>2.5&&zepp<2.4 && delta_phi>1.9;;
           ...
           jet1p4.SetPtEtaPhiE(jet1pt_JEC_up, jet1eta_JEC_up, jet1phi_JEC_up, jet1e_JEC_up);
           jet2p4.SetPtEtaPhiE(jet2pt_JEC_up, jet2eta_JEC_up, jet2phi_JEC_up, jet2e_JEC_up);
           delta_phi_JEC_up=fabs((Zp4+photonp4).Phi()-(jet1p4+jet2p4).Phi());

           jet1p4.SetPtEtaPhiE(jet1pt_JEC_down, jet1eta_JEC_down, jet1phi_JEC_down, jet1e_JEC_down);
           jet2p4.SetPtEtaPhiE(jet2pt_JEC_down, jet2eta_JEC_down, jet2phi_JEC_down, jet2e_JEC_down);
           delta_phi_JEC_down=fabs((Zp4+photonp4).Phi()-(jet1p4+jet2p4).Phi());
	   ...
	   JET_new = ( (!(fabs(jet2eta_new)<3.14 && fabs(jet2eta_new)>2.65) && !(fabs(jet1eta_new)<3.14 && fabs(jet1eta_new)>2.65) &&  jet1pt_new<50 && jet2pt_new<50 && jet1pt_new>30 && jet2pt_new>30 && fabs(jet1eta_new)< 4.7 && fabs(jet2eta_new)<4.7) || (jet1pt_new>50 && jet2pt_new>50 && fabs(jet1eta_new)< 4.7 && fabs(jet2eta_new)<4.7) )/*jet1pt_new>30 && jet2pt_new>30 && fabs(jet1eta_new)< 4.7 && fabs(jet2eta_new)<4.7*/ && Mjj_new > 500 && drla > 0.7 && drla2 > 0.7 && drj1a_new > 0.5 && drj2a_new > 0.5 && drjj_new> 0.5 && drj1l_new > 0.5 && drj2l_new > 0.5 && drj1l2_new > 0.5 && drj2l2_new > 0.5 && deltaeta_new >2.5&& zepp_new<2.4 && delta_phi_new>1.9;
;
	   JET_down = ( (!(fabs(jet2eta_JEC_down)<3.14 && fabs(jet2eta_JEC_down)>2.65) && !(fabs(jet1eta_JEC_down)<3.14 && fabs(jet1eta_JEC_down)>2.65) &&  jet1pt_JEC_down<50 && jet2pt_JEC_down<50 && jet1pt_JEC_down>30 && jet2pt_JEC_down>30 && fabs(jet1eta_JEC_down)< 4.7 && fabs(jet2eta_JEC_down)<4.7) || (jet1pt_JEC_down>50 && jet2pt_JEC_down>50 && fabs(jet1eta_JEC_down)< 4.7 && fabs(jet2eta_JEC_down)<4.7) )/*jet1pt_JEC_down>30 && jet2pt_JEC_down>30 && fabs(jet1eta_JEC_down)< 4.7 && fabs(jet2eta_JEC_down)<4.7*/ && Mjj_JEC_down > 500 && drla > 0.7 && drla2 > 0.7 && drj1a_JEC_down > 0.5 && drj2a_JEC_down > 0.5  && drjj_JEC_down> 0.5 && drj1l_JEC_down > 0.5 && drj2l_JEC_down > 0.5 && drj1l2_JEC_down > 0.5 && drj2l2_JEC_down > 0.5 && deltaeta_JEC_down>2.5&&zepp_JEC_down<2.4 && delta_phi_JEC_down>1.9;
	   JET_up = ( (!(fabs(jet2eta_JEC_up)<3.14 && fabs(jet2eta_JEC_up)>2.65) && !(fabs(jet1eta_JEC_up)<3.14 && fabs(jet1eta_JEC_up)>2.65) &&  jet1pt_JEC_up<50 && jet2pt_JEC_up<50 && jet1pt_JEC_up>30 && jet2pt_JEC_up>30 && fabs(jet1eta_JEC_up)< 4.7 && fabs(jet2eta_JEC_up)<4.7) || (jet1pt_JEC_up>50 && jet2pt_JEC_up>50 && fabs(jet1eta_JEC_up)< 4.7 && fabs(jet2eta_JEC_up)<4.7) )/*jet1pt_JEC_up>30 && jet2pt_JEC_up>30 && fabs(jet1eta_JEC_up)< 4.7 && fabs(jet2eta_JEC_up)<4.7*/ && Mjj_JEC_up > 500 && drla > 0.7 && drla2 > 0.7 && drj1a_JEC_up > 0.5 && drj2a_JEC_up > 0.5  && drjj_JEC_up> 0.5 && drj1l_JEC_up > 0.5 && drj2l_JEC_up > 0.5 && drj1l2_JEC_up > 0.5 && drj2l2_JEC_up > 0.5 && deltaeta_JEC_up>2.5&& zepp_JEC_up<2.4 && delta_phi_JEC_up>1.9;

           if(  !( ( drla>0.7 && drla2>0.7 && lep == 13 && (HLT_Mu1>0||HLT_Mu2 > 0||HLT_Mu3>0) && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep > 70. && massVlep < 110. && photonet > 20.&&( (fabs(photoneta) < 1.4442) || (fabs(photoneta)>1.566&&fabs(photoneta)<2.5)) && Mva>100)||
...
//	   cout<<"scalef = "<<scalef<<"; pileupWeight = "<<pileupWeight<<"; actualWeight = "<<actualWeight<<endl;
	   ...
	   if(JET_down==1) {
		   if(Mjj_JEC_down>=500&&Mjj_JEC_down<2000&&deltaeta_JEC_down>=2.5&&deltaeta_JEC_down<6.5) mjj_JEC_down->Fill(0.5,actualWeight);//0~1, 2.5~4.5 and 500~800
	   }
	   if(JET_up==1) {
		   if(Mjj_JEC_up>=500&&Mjj_JEC_up<2000&&deltaeta_JEC_up>=2.5&&deltaeta_JEC_up<6.5) mjj_JEC_up->Fill(0.5,actualWeight);//0~1, 2.5~4.5 and 500~800
	   }
