...
//   TH1D*th1[kk];
     ...
     for(int k=0;k<tree->GetEntries();k++){
	     ...
	     if(vec_branchname.Contains("Mjj")==0)
		     ...
		     if(variables[vec_branchname]>500 && variables[vec_branchname]<800 && detajj>2.5 && detajj<4.5)
			     th1->Fill(0.5,actualWeight);
		     if(variables[vec_branchname]>800 && variables[vec_branchname]<1200 && detajj>2.5 && detajj<4.5)
			     th1->Fill(1.5,actualWeight);
		     if(variables[vec_branchname]>1200 && detajj>2.5 && detajj<4.5)
			     th1->Fill(2.5,actualWeight);
		     if(variables[vec_branchname]>500 && variables[vec_branchname]<800 && detajj>4.5 && detajj<6)
			     th1->Fill(3.5,actualWeight);
		     if(variables[vec_branchname]>800 && variables[vec_branchname]<1200 && detajj>4.5 && detajj<6)
			     th1->Fill(4.5,actualWeight);
		     if(variables[vec_branchname]>1200 && detajj>4.5 && detajj<6)
			     th1->Fill(5.5,actualWeight);
		     if(variables[vec_branchname]>1200 && detajj>6)
			     th1->Fill(6.5,actualWeight);
	     }
     }
//     file->Close();
     return th1;
