...
void WWg::Init(TTree *tree)
{
   ...
   ExTree->Branch("ele_id_scale",&ele_id_scale,"ele_id_scale/D");
   ExTree->Branch("ele_reco_scale",&ele_reco_scale,"ele_reco_scale/D");
   ExTree->Branch("muon_id_scale",&muon_id_scale,"muon_id_scale/D");
