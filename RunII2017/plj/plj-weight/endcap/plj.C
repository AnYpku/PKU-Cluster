...
//   f1.open("/home/pku/anying/cms/Uncer/2017/fakephoton/endcap/step1/pljweight.txt");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     if(photonet<30&&photonet>20)         {int i=0;  scalef_tmp =scalef_f[i];}
     if(photonet>30 &&  photonet<40)      {int i=1;scalef_tmp =scalef_f[i];}
     if(photonet>40 &&  photonet<50)      {int i=2;scalef_tmp =scalef_f[i];}
     if(photonet>50 &&  photonet<60)      {int i=3;scalef_tmp =scalef_f[i];}
     if(photonet>60 &&  photonet<100)     {int i=4;scalef_tmp =scalef_f[i];}
     if(photonet>100/*&&  photonet<400*/) {int i=5;scalef_tmp =scalef_f[i];} 
