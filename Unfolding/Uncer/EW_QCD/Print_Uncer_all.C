...
int Print_Uncer_all(){
	...
	vector<TString> recovars={"ptlep1","photonet","jet1pt","Mjj"};
		...
		for(int j=0;j<tag.size();j++){
			...
			TString f_Sigout_pdf  ="/home/pku/anying/cms/PKU-Cluster/Unfolding/Uncer/pdf/EW_QCD/"+recovars[i]+"_uncer.txt";
			...
			TString f_photon_ID ="/home/pku/anying/cms/PKU-Cluster/Unfolding/Uncer/lepton_uncer/"+recovars[i]+"_photon_ID_"+tag[j]+".txt";
                        ...
                        TString f_puId_eff_sigout="/home/pku/anying/cms/PKU-Cluster/Unfolding/Uncer/puIdSF/EW_QCD/"+recovars[i]+"_uncer_eff"+tag[j]+".txt";
                        TString f_puId_mis_sigout="/home/pku/anying/cms/PKU-Cluster/Unfolding/Uncer/puIdSF/EW_QCD/"+recovars[i]+"_uncer_mis"+tag[j]+".txt";
                        TString f_puId_eff_sig="/home/pku/anying/cms/PKU-Cluster/Unfolding/Uncer/puIdSF/EW_QCD/"+genvars[i]+"_uncer_eff"+tag[j]+".txt";
			...
			run(recovars[i],genvars[i],tag[j],f_jes_sigout);
			run(recovars[i],genvars[i],tag[j],f_jer_sigout);
