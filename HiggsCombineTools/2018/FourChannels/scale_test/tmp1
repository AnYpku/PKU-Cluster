...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2018/FourChannels/2018eleendcap/SR/CR/aa.root")
tstack = f_in.Get("hs")
...
jer_VV   =[1.10]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('ele18', 'endcap'),'w')
