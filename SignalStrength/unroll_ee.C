...
void cmsLumi(bool channel) 
{
        ...
        latex.DrawLatex(0.76,0.92,Form("136 fb^{-1} (%d TeV)", (beamcomenergytev)));
}
...
//        Double_t mlla_bins[5]={90, 130, 170, 210, 240};
	...
	TFile* f_ZA=TFile::Open("./2016/eleendcap/hist_ZA.root");
	TFile* f_ZA17=TFile::Open("./2017/eleendcap/hist_ZA.root");
	TFile* f_ZA18=TFile::Open("./2018/eleendcap/hist_ZA.root");
	TH2D* th2_ZA=(TH2D*)f_ZA->Get("hist_bkg");
	TH2D* th2_ZA17=(TH2D*)f_ZA17->Get("hist_bkg");
	TH2D* th2_ZA18=(TH2D*)f_ZA18->Get("hist_bkg");
...
//	const char *name[9]={"Mjj 500~600","Mjj 600~800","Mjj 800~2000","Mjj 500~600","Mjj 600~800","Mjj 800~2000","Mjj 500~600","Mjj 600~800","Mjj 800~2000"};
	...
	TFile* f_ZA_sig=TFile::Open("./2016/eleendcap/hist_ZA-EWK.root");
	TFile* f_ZA_sig17=TFile::Open("./2017/eleendcap/hist_ZA-EWK.root");
	TFile* f_ZA_sig18=TFile::Open("./2018/eleendcap/hist_ZA-EWK.root");
        TH2D* th2_ZA_sig=(TH2D*)f_ZA_sig->Get("hist_sig");
        TH2D* th2_ZA_sig17=(TH2D*)f_ZA_sig17->Get("hist_sig");
        TH2D* th2_ZA_sig18=(TH2D*)f_ZA_sig18->Get("hist_sig");
...
//	t_ZA_sigout->Scale(lumi);
	...
	TFile* f_WA=TFile::Open("./2016/eleendcap/hist_WA.root");
	TFile* f_WA17=TFile::Open("./2017/eleendcap/hist_WA.root");
	TFile* f_WA18=TFile::Open("./2018/eleendcap/hist_WA.root");
        TH2D* th2_WA=(TH2D*)f_WA->Get("hist_bkg");
        TH2D* th2_WA17=(TH2D*)f_WA17->Get("hist_bkg");
        TH2D* th2_WA18=(TH2D*)f_WA18->Get("hist_bkg");
...
//	t_WA->Scale(lumi);
	...
	TFile* f_VV=TFile::Open("./2016/eleendcap/hist_VV.root");
	TFile* f_VV17=TFile::Open("./2017/eleendcap/hist_VV.root");
	TFile* f_VV18=TFile::Open("./2018/eleendcap/hist_VV.root");
        TH2D* th2_VV=(TH2D*)f_VV->Get("hist_bkg");
        TH2D* th2_VV17=(TH2D*)f_VV17->Get("hist_bkg");
        TH2D* th2_VV18=(TH2D*)f_VV18->Get("hist_bkg");
...
//	t_VV->Scale(lumi);
	...
	TFile* f_TTA=TFile::Open("./2016/eleendcap/hist_TTA.root");
	TFile* f_TTA17=TFile::Open("./2017/eleendcap/hist_TTA.root");
	TFile* f_TTA18=TFile::Open("./2018/eleendcap/hist_TTA.root");
        TH2D* th2_TTA=(TH2D*)f_TTA->Get("hist_bkg");
        TH2D* th2_TTA17=(TH2D*)f_TTA17->Get("hist_bkg");
        TH2D* th2_TTA18=(TH2D*)f_TTA18->Get("hist_bkg");
...
//	t_TTA->Scale(lumi);
	...
	TFile* f_ST=TFile::Open("./2016/eleendcap/hist_ST.root");
	TFile* f_ST17=TFile::Open("./2017/eleendcap/hist_ST.root");
	TFile* f_ST18=TFile::Open("./2018/eleendcap/hist_ST.root");
        TH2D* th2_ST=(TH2D*)f_ST->Get("hist_bkg");
        TH2D* th2_ST17=(TH2D*)f_ST17->Get("hist_bkg");
        TH2D* th2_ST18=(TH2D*)f_ST18->Get("hist_bkg");
...
//	t_ST->Scale(lumi);
	...
	TFile* f_plj=TFile::Open("./2016/eleendcap/hist_plj_eleendcap.root");
	TFile* f_plj17=TFile::Open("./2017/eleendcap/hist_plj_eleendcap.root");
	TFile* f_plj18=TFile::Open("./2018/eleendcap/hist_plj_eleendcap.root");
        TH2D* th2_plj=(TH2D*)f_plj->Get("hist_bkg");
        TH2D* th2_plj17=(TH2D*)f_plj17->Get("hist_bkg");
        TH2D* th2_plj18=(TH2D*)f_plj18->Get("hist_bkg");
