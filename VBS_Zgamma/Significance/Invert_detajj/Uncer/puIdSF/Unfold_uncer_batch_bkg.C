...
void run( TString sample,vector<TString> vec_branchname,vector<vector<double>> bins,TString cut1,TString tag,TString type){
     ...
     TFile*file;
     if(sample.Contains("EWK")) file=new TFile("/home/pku/anying/cms/rootfiles/20"+tag+"/cutla-out"+sample+tag+".root");
...
//     tree->SetBranchStatus("*",0);
     ...
     Double_t puIdweight,puIdweight_effUp,puIdweight_effDn,puIdweight_misUp,puIdweight_misDn;
     ...
     for(int k=0;k<tree->GetEntries();k++){
	     ...
	     if(tag.Contains("18")) {
		     ...
		     puIdweight_effUp=puIdweight_L_effUp;
		     puIdweight_effDn=puIdweight_L_effDn;
		     puIdweight_misUp=puIdweight_L_misUp;
		     puIdweight_misDn=puIdweight_L_misDn;
	     }
	     if(tag.Contains("17")){
		     puIdweight=puIdweight_T;
		     puIdweight_effUp=puIdweight_T_effUp;
		     puIdweight_effDn=puIdweight_T_effDn;
		     puIdweight_misUp=puIdweight_T_misUp;
		     puIdweight_misDn=puIdweight_T_misDn;
	     }
	     if(tag.Contains("16")){
		     puIdweight=puIdweight_M;
		     puIdweight_effUp=puIdweight_M_effUp;
		     puIdweight_effDn=puIdweight_M_effDn;
		     puIdweight_misUp=puIdweight_M_misUp;
		     puIdweight_misDn=puIdweight_M_misDn;
	     }
     ...
     for(int j=0;j<kk;j++){
	     if(name.Contains("EWK")==1){
		     fout[j]= new TFile("hist_"+vec_branchname[j]+"_"+sample+"_"+type+tag+".root","recreate");
	     }
	     else{
		     fout[j]= new TFile("hist_"+vec_branchname[j]+"_"+sample+"_"+type+tag+".root","recreate");
	     }
