...
//      ParamSetf.open("paramsets_fT0_mu.txt");
        if(index==1) {ParamSetf.open("paramsets_fM0_mu.txt"); }
        if(index==2) {ParamSetf.open("paramsets_fM1_mu.txt"); }
        if(index==3) {ParamSetf.open("paramsets_fM2_mu.txt"); }
        if(index==4) {ParamSetf.open("paramsets_fM3_mu.txt"); }
        if(index==5) {ParamSetf.open("paramsets_fM4_mu.txt"); }
        if(index==6) {ParamSetf.open("paramsets_fM5_mu.txt"); }
        if(index==7) {ParamSetf.open("paramsets_fM6_mu.txt"); }
        if(index==8) {ParamSetf.open("paramsets_fM7_mu.txt"); }
        if(index==9) {ParamSetf.open("paramsets_fT0_mu.txt"); }
        if(index==10) {ParamSetf.open("paramsets_fT1_mu.txt");}
        if(index==11) {ParamSetf.open("paramsets_fT2_mu.txt");}
        if(index==12) {ParamSetf.open("paramsets_fT5_mu.txt");}
        if(index==13){ParamSetf.open("paramsets_fT6_mu.txt");}
        if(index==14){ParamSetf.open("paramsets_fT7_mu.txt");}
        if(index==15){ParamSetf.open("paramsets_fT8_mu.txt");}
        if(index==16){ParamSetf.open("paramsets_fT9_mu.txt");}

	TFile* fout = new TFile("signal_proc_mu__"+name+".root", "RECREATE");
...
for(int i=1;i<17;i++){
	...
	fX0_parameterization_mu(i,ZGbin);
}
