#!/bin/bash/
cp /home/pku/anying/cms/PKU-Cluster/SignalStrength/batch/data_cards/scale_test/txt/*16*.txt ./
cp /home/pku/anying/cms/PKU-Cluster/SignalStrength/batch/data_cards/scale_test/txt/*17*.txt ./
cp /home/pku/anying/cms/PKU-Cluster/SignalStrength/batch/data_cards/scale_test/txt/*18*.txt ./
