...
//=========  (Mon Jun  8 04:18:12 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-3.021017,7.4375,20.21758);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(17.26295);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(18.1261);
   ...
   ST_stack_1->SetBinContent(2,0.1741633);
   ST_stack_1->SetBinError(2,0.1741633);
   ...
   TTA_stack_2->SetBinContent(1,0.17785);
   TTA_stack_2->SetBinContent(2,0.04958908);
   TTA_stack_2->SetBinContent(4,-0.0007618087);
   TTA_stack_2->SetBinContent(5,0.0475407);
   TTA_stack_2->SetBinContent(6,0.04556206);
   TTA_stack_2->SetBinContent(7,0.04583635);
   TTA_stack_2->SetBinError(1,0.1451144);
   TTA_stack_2->SetBinError(2,0.1038313);
   TTA_stack_2->SetBinError(4,0.066515);
   TTA_stack_2->SetBinError(5,0.08003973);
   TTA_stack_2->SetBinError(6,0.04556206);
   ...
   VV_stack_3->SetBinContent(4,0.2671262);
   VV_stack_3->SetBinError(4,0.2671262);
   ...
   plj_stack_5->SetBinContent(1,4.747351);
   plj_stack_5->SetBinContent(2,1.157407);
   plj_stack_5->SetBinContent(3,0.626209);
   plj_stack_5->SetBinContent(4,2.56301);
   plj_stack_5->SetBinContent(5,0.836363);
   plj_stack_5->SetBinContent(6,0.8437627);
   plj_stack_5->SetBinContent(7,1.009383);
   plj_stack_5->SetBinError(1,0.9732453);
   plj_stack_5->SetBinError(2,0.4562294);
   plj_stack_5->SetBinError(3,0.3641932);
   plj_stack_5->SetBinError(4,0.7200667);
   plj_stack_5->SetBinError(5,0.3804443);
   plj_stack_5->SetBinError(6,0.3991787);
   ...
   t_ZA_stack_6->SetBinContent(1,4.865704);
   t_ZA_stack_6->SetBinContent(2,3.175687);
   t_ZA_stack_6->SetBinContent(3,0.3674578);
   t_ZA_stack_6->SetBinContent(4,2.709106);
   t_ZA_stack_6->SetBinContent(5,1.797834);
   t_ZA_stack_6->SetBinContent(6,0.3448001);
   t_ZA_stack_6->SetBinContent(7,1.001562);
   t_ZA_stack_6->SetBinError(1,0.9686602);
   t_ZA_stack_6->SetBinError(2,0.6809455);
   t_ZA_stack_6->SetBinError(3,0.2680273);
   t_ZA_stack_6->SetBinError(4,0.7648749);
   t_ZA_stack_6->SetBinError(5,0.5028039);
   t_ZA_stack_6->SetBinError(6,0.2995281);
   ...
   ZA_sig_stack_7->SetBinContent(1,1.30543);
   ZA_sig_stack_7->SetBinContent(2,1.146753);
   ZA_sig_stack_7->SetBinContent(3,0.7950937);
   ZA_sig_stack_7->SetBinContent(4,0.08424479);
   ZA_sig_stack_7->SetBinContent(5,0.6243805);
   ZA_sig_stack_7->SetBinContent(6,0.9960187);
   ZA_sig_stack_7->SetBinContent(7,0.1408354);
   ZA_sig_stack_7->SetBinError(1,0.1361254);
   ZA_sig_stack_7->SetBinError(2,0.1274728);
   ZA_sig_stack_7->SetBinError(3,0.1062651);
   ZA_sig_stack_7->SetBinError(4,0.03440005);
   ZA_sig_stack_7->SetBinError(5,0.09414367);
   ZA_sig_stack_7->SetBinError(6,0.1208707);
   ...
   ZA_sigout_stack_8->SetBinContent(1,0.4123017);
   ZA_sigout_stack_8->SetBinContent(2,0.08619342);
   ZA_sigout_stack_8->SetBinContent(3,0.05732057);
   ZA_sigout_stack_8->SetBinContent(4,0.04255145);
   ZA_sigout_stack_8->SetBinContent(5,0.2416709);
   ZA_sigout_stack_8->SetBinContent(6,0.05698234);
   ZA_sigout_stack_8->SetBinContent(7,0.08565068);
   ZA_sigout_stack_8->SetBinError(1,0.07658253);
   ZA_sigout_stack_8->SetBinError(2,0.03520707);
   ZA_sigout_stack_8->SetBinError(3,0.0286624);
   ZA_sigout_stack_8->SetBinError(4,0.02456828);
   ZA_sigout_stack_8->SetBinError(5,0.05862426);
   ZA_sigout_stack_8->SetBinError(6,0.02849469);
   ...
   TLegendEntry *entry=leg->AddEntry("ZA_sig_stack_7","EWK in fid.[5.09]","lpf");
   ...
   entry=leg->AddEntry("ZA_sigout_stack_8","EWK out fid. [0.98]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("t_ZA_stack_6","ZA [14.26]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("plj_stack_5","non-prompt [11.78]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("VV_stack_3","VV [0.27]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("TTA_stack_2","TTA [0.37]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("ST_stack_1","ST  [0.17]","lpf");
