...
//=========  (Fri Jun  5 17:20:56 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-134.4709,1.0625,899.9207);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(768.4052);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(806.8255);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.9261921);
   unrolledsPhist_stack_1->SetBinError(1,0.4214144);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,9.707866);
   unrolledsPhist_stack_2->SetBinError(1,1.246859);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,4.28173);
   unrolledsPhist_stack_3->SetBinError(1,1.129817);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,134.0466);
   unrolledsPhist_stack_5->SetBinError(1,7.103332);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,229.488);
   unrolledsPhist_stack_6->SetBinError(1,6.423506);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,5.75228);
   unrolledsPhist_stack_7->SetBinError(1,0.2960429);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [5.75]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [229.49]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [134.05]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [4.28]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [9.71]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.93]","lpf");
