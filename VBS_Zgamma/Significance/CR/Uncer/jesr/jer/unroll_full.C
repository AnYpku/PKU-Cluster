...
void unroll_name(TString filename){
	...
	TFile* fout = new TFile("aa_"+filename+"_jer.root","RECREATE");
	Double_t ZA_scale= 1;
	std::ostringstream strs;
	std::string lumivalue = strs.str();

	TFile* f_ZA;TFile* f_ZA1;TFile* f_ZA2;
	f_ZA=new TFile("./hist_"+filename+"_jer16.root");
	f_ZA1=new TFile("./hist_"+filename+"_jer17.root");
	f_ZA2=new TFile("./hist_"+filename+"_jer18.root");
