...
//=========  (Tue Apr 28 11:11:01 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.3125,-4.267673,7.4375,28.56058);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(24.3867);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",7,0,7);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(25.60604);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,0.2937586);
   unrolledsPhist_stack_2->SetBinContent(2,0.1746269);
   unrolledsPhist_stack_2->SetBinContent(4,-0.03662542);
   unrolledsPhist_stack_2->SetBinContent(5,0.0629988);
   unrolledsPhist_stack_2->SetBinError(1,0.1361725);
   unrolledsPhist_stack_2->SetBinError(2,0.1087975);
   unrolledsPhist_stack_2->SetBinError(4,0.03662542);
   unrolledsPhist_stack_2->SetBinError(5,0.08815343);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,0.8508199);
   unrolledsPhist_stack_3->SetBinContent(2,0.1544792);
   unrolledsPhist_stack_3->SetBinError(1,0.4920824);
   unrolledsPhist_stack_3->SetBinError(2,0.1544792);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,6.437834);
   unrolledsPhist_stack_5->SetBinContent(2,1.286143);
   unrolledsPhist_stack_5->SetBinContent(4,6.503285);
   unrolledsPhist_stack_5->SetBinContent(5,2.4795);
   unrolledsPhist_stack_5->SetBinContent(6,0.762287);
   unrolledsPhist_stack_5->SetBinContent(7,3.060958);
   unrolledsPhist_stack_5->SetBinError(1,1.265081);
   unrolledsPhist_stack_5->SetBinError(2,0.5752906);
   unrolledsPhist_stack_5->SetBinError(4,1.277757);
   unrolledsPhist_stack_5->SetBinError(5,0.7858349);
   unrolledsPhist_stack_5->SetBinError(6,0.4401667);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,7.046498);
   unrolledsPhist_stack_6->SetBinContent(2,1.829451);
   unrolledsPhist_stack_6->SetBinContent(3,0.3530391);
   unrolledsPhist_stack_6->SetBinContent(4,3.193608);
   unrolledsPhist_stack_6->SetBinContent(5,1.610783);
   unrolledsPhist_stack_6->SetBinContent(6,0.6014088);
   unrolledsPhist_stack_6->SetBinContent(7,0.9784482);
   unrolledsPhist_stack_6->SetBinError(1,0.9989183);
   unrolledsPhist_stack_6->SetBinError(2,0.5376323);
   unrolledsPhist_stack_6->SetBinError(3,0.2718359);
   unrolledsPhist_stack_6->SetBinError(4,0.785333);
   unrolledsPhist_stack_6->SetBinError(5,0.4675971);
   unrolledsPhist_stack_6->SetBinError(6,0.331177);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,2.189506);
   unrolledsPhist_stack_7->SetBinContent(2,1.424987);
   unrolledsPhist_stack_7->SetBinContent(3,0.861272);
   unrolledsPhist_stack_7->SetBinContent(4,0.2921835);
   unrolledsPhist_stack_7->SetBinContent(5,0.7159342);
   unrolledsPhist_stack_7->SetBinContent(6,1.928402);
   unrolledsPhist_stack_7->SetBinContent(7,0.7567885);
   unrolledsPhist_stack_7->SetBinError(1,0.1799745);
   unrolledsPhist_stack_7->SetBinError(2,0.1386932);
   unrolledsPhist_stack_7->SetBinError(3,0.1081443);
   unrolledsPhist_stack_7->SetBinError(4,0.06537902);
   unrolledsPhist_stack_7->SetBinError(5,0.1029023);
   unrolledsPhist_stack_7->SetBinError(6,0.1628304);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [8.17]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [15.61]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [20.53]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [1.01]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [0.49]","lpf");
