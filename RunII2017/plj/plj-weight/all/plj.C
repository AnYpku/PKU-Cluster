...
void plj::Loop(TString flag)
{
   ...
   f1.open("/home/pku/anying/cms/PKU-Cluster/FakePhoton/txt/pljweight"+flag+"_mubarrel17.txt");
   f2.open("/home/pku/anying/cms/PKU-Cluster/FakePhoton/txt/pljweight"+flag+"_muendcap17.txt");
   f3.open("/home/pku/anying/cms/PKU-Cluster/FakePhoton/txt/pljweight"+flag+"_elebarrel17.txt");
   f4.open("/home/pku/anying/cms/PKU-Cluster/FakePhoton/txt/pljweight"+flag+"_eleendcap17.txt");
