...
TH1D* run( TString sample,TString tag,TString vec_branchname,vector<double> bins,TString cut1){
     ...
     double muon1_id_scale,muon2_id_scale,muon1_iso_scale,muon2_iso_scale,ele1_id_scale,ele2_id_scale,ele1_reco_scale,ele2_reco_scale,photon_id_scale,photon_veto_scale,pileupWeight,prefWeight,muon_hlt_scale,ele_hlt_scale,puIdweight_T,puIdweight_L,puIdweight_M,puIdweight;
     Double_t scalef;
     int lep;
