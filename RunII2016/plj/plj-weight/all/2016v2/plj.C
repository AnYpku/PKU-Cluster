...
void plj::Loop(TString name)
{
   ...
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016/fakephoton/elebarrel/step1/pljweight"+name+".txt");
   f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016/fakephoton/eleendcap/step1/pljweight"+name+".txt");
   f3.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016/fakephoton/mubarrel/step1/pljweight"+name+".txt");
   f4.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016/fakephoton/muendcap/step1/pljweight"+name+".txt");
   Double_t scalef_f1[9];
   Double_t scalef_f2[9];
   Double_t scalef_f3[9];
   Double_t scalef_f4[9];
   for(Int_t i=0;i<9;i++){
      f1>>scalef_f1[i];
      f2>>scalef_f2[i];
      f3>>scalef_f3[i];
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(lep==11 && fabs(photoneta)<1.4442){
	      ...
	      if(photonet>60 &&  photonet<80)      {int i=6;scalef_tmp = scalef_f1[i];}
	      if(photonet>80 &&  photonet<120)     {int i=7;scalef_tmp = scalef_f1[i];}
	      if(photonet>120)                     {int i=8;scalef_tmp = scalef_f1[i];}
      }

      if(lep==11 && fabs(photoneta)>1.566 && fabs(photoneta)<2.5){
	      if(photonet>20 &&  photonet<25)      {int i=0;scalef_tmp = scalef_f2[i];}
	      if(photonet>25 &&  photonet<50)      {int i=1;scalef_tmp = scalef_f2[i];}
	      if(photonet>50 &&  photonet<80)      {int i=2;scalef_tmp = scalef_f2[i];}
	      if(photonet>80/*&&  photonet<400*/)  {int i=3;scalef_tmp = scalef_f2[i];}
      }
      ...
      if(lep==13 && fabs(photoneta)<1.4442){
	      ...
	      if(photonet>50 &&  photonet<65)      {int i=5;scalef_tmp = scalef_f3[i];}
	      if(photonet>65 &&  photonet<100)     {int i=6;scalef_tmp = scalef_f3[i];}
	      if(photonet>100 &&  photonet<120)    {int i=7;scalef_tmp = scalef_f3[i];}
	      if(photonet>125)                     {int i=8;scalef_tmp = scalef_f3[i];}
      }
      ...
      if(lep==13 && fabs(photoneta)>1.566 && fabs(photoneta)<2.5){
	      ...
	      if(photonet>30 &&  photonet<35)      {int i=2;scalef_tmp = scalef_f4[i];}
	      if(photonet>35 &&  photonet<40)      {int i=3;scalef_tmp = scalef_f4[i];}
	      if(photonet>40 &&  photonet<50)      {int i=4;scalef_tmp = scalef_f4[i];}
	      if(photonet>50 &&  photonet<65)      {int i=5;scalef_tmp = scalef_f4[i];}
	      if(photonet>65 &&  photonet<100)     {int i=6;scalef_tmp = scalef_f4[i];}
	      if(photonet>100/*&&  photonet<400*/) {int i=7;scalef_tmp = scalef_f4[i];}
      }
