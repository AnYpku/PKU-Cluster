...
//=========  (Mon Jan 20 14:06:40 2020) by ROOT version6.06/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-51.25,-115.3263,423.75,771.7992);
   pad1->SetFillColor(0);
   ...
   hs_stack_1->SetMaximum(691.9579);
   ...
   hist__1->SetBinContent(1,0.5547167);
   hist__1->SetBinError(1,0.3202658);
   ...
   hist__2->SetBinContent(1,4.351321);
   hist__2->SetBinContent(2,0.6630584);
   hist__2->SetBinContent(3,0.290088);
   hist__2->SetBinContent(4,0.290088);
   hist__2->SetBinError(1,0.7873818);
   hist__2->SetBinError(2,0.3612756);
   hist__2->SetBinError(3,0.3540733);
   hist__2->SetBinError(4,0.3016961);
   ...
   hist__3->SetBinContent(1,21.0935);
   hist__3->SetBinError(1,5.644688);
   ...
   hist__5->SetBinContent(1,346.3024);
   hist__5->SetBinContent(2,11.89194);
   hist__5->SetBinContent(3,2.58388);
   hist__5->SetBinContent(4,0.850449);
   hist__5->SetBinError(1,12.22681);
   hist__5->SetBinError(2,2.152823);
   hist__5->SetBinError(3,0.8482069);
   hist__5->SetBinError(4,0.4866659);
   ...
   hist__6->SetBinContent(1,219.4087);
   hist__6->SetBinContent(2,26.85626);
   hist__6->SetBinContent(3,19.82012);
   hist__6->SetBinContent(4,11.69387);
   hist__6->SetBinError(1,6.010105);
   hist__6->SetBinError(2,2.182464);
   hist__6->SetBinError(3,1.767217);
   hist__6->SetBinError(4,1.429249);
   ...
   hist__7->SetBinContent(1,59.99289);
   hist__7->SetBinContent(2,11.3298);
   hist__7->SetBinContent(3,7.776128);
   hist__7->SetBinContent(4,5.376412);
   hist__7->SetBinError(1,0.8869604);
   hist__7->SetBinError(2,0.3854478);
   hist__7->SetBinError(3,0.3193273);
   hist__7->SetBinError(4,0.2655221);
   ...
   hist3__8->SetBinContent(1,7.304052);
   hist3__8->SetBinContent(2,1.127735);
   hist3__8->SetBinContent(3,0.6425468);
   hist3__8->SetBinContent(4,0.3409432);
   hist3__8->SetBinError(1,0.3094826);
   hist3__8->SetBinError(2,0.1216068);
   hist3__8->SetBinError(3,0.0917924);
   hist3__8->SetBinError(4,0.06686446);
