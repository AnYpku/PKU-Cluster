#!/bin/bash
rm *.txt
cp -f /home/pku/anying/cms/PKU-Cluster/WWg/Significance/finebins/data_cards/SR/Top_merge/txt/*.txt .
cp -f /home/pku/anying/cms/PKU-Cluster/WWg/Significance/finebins/data_cards/CR/Top_merge/txt/*.txt .
years="\
18
17
"
