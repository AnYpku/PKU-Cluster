...
TH2D* hist_2d_mc(std::string filename){
	...
	std::string file = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2016_"+filename+".root";
	...
	Double_t detajj_bins[2]={0,6.5};
        TString cut="ZGmass>100 && lep==13 && fabs(photoneta)>1.566 && fabs(photoneta)<2.5 && Mjj<400 && Mjj>150";
