...
TString dir16="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/aQGC/jer/";
TFile*f1;
if(name.Contains("EWK"))
	f1=new TFile(dir16+"Mva_"+name+"_jer.root");
else
	f1=new TFile(dir16+"Mva_"+name+"_v3_jer.root");

TH1D*h1=(TH1D*)f1->Get("th2_0");
TH1D*h2=(TH1D*)f1->Get("th2_1");
TH1D*h3=(TH1D*)f1->Get("th2_2");

TString dir17="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/aQGC/jer/";
TFile*ff1=new TFile(dir17+"Mva_"+name+"_jer.root");

TH1D*hh1=(TH1D*)ff1->Get("th2_0");
TH1D*hh2=(TH1D*)ff1->Get("th2_1");
TH1D*hh3=(TH1D*)ff1->Get("th2_2");

TString dir18="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/aQGC/jer/";
TFile*fff1=new TFile(dir18+"Mva_"+name+"_jer.root");
