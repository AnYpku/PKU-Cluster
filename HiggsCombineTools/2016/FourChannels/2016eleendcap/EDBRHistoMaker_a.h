...
//data
		actualWeight=0;
                if(  (drla>0.7 && drla2>0.7 && lep == 11  && ptlep1 > 25. && ptlep2 > 25. && fabs(etalep1) < 2.5 && fabs(etalep2) < 2.5 && nlooseeles < 3 && nloosemus == 0 && massVlep > 70. && massVlep < 110. && photonet > 20. &&( /*(fabs(photoneta) < 1.4442) ||*/ ( fabs(photoneta)<2.5&&fabs(photoneta)>1.566 ) )  && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && drj1a>0.5 &&drj2a>0.5 && drj1l>0.5 && drj2l>0.5 && drjj>0.5 && ZGmass>100 && Mjj>500 && detajj>2.5 && zepp<2.4 && delta_phi>1.9) /*|| () */
		  ) {
			//if(Mjj<400) 
...
//			continue;
		...
		if(lep==13)
			actualWeight = scalef*(muon1_id_scale*muon2_id_scale*muon1_iso_scale*muon2_iso_scale);//mc
		if(lep==11)
		...
		int iswjets = 0;
                ...
                if(lep==13)
                        actualWeight = scalef*(muon1_id_scale*muon2_id_scale*muon1_iso_scale*muon2_iso_scale);//mc
                if(lep==11)
                        actualWeight = scalef*(ele1_id_scale*ele2_id_scale*ele1_reco_scale*ele2_reco_scale);
		actualWeight = actualWeight*photon_id_scale;
                if(filename.Contains("plj")) 
                     actualWeight = scalef;
// mc
                if(  (drla>0.7 && drla2>0.7 && lep == 11 &&  /*( HLT_Mu1 > 0||HLT_Mu2>0) &&*/ ptlep1 > 25. && ptlep2 > 25. && fabs(etalep1) < 2.5 && fabs(etalep2) < 2.5 && nlooseeles < 3 && nloosemus == 0 && massVlep > 70. && massVlep < 110. && photonet > 20. &&( /*(fabs(photoneta) < 1.4442) ||*/ ( fabs(photoneta)<2.5&&fabs(photoneta)>1.566 ) )  && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && drj1a>0.5 &&drj2a>0.5 && drj1l>0.5 && drj2l>0.5 && drjj>0.5 && ZGmass>100 &&  Mjj>500 && detajj>2.5 && delta_phi>1.9 && zepp<2.4) 
