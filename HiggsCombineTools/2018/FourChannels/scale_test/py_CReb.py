...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2018/FourChannels/2018elebarrel/SR/CR/aa.root")
tstack = f_in.Get("hs")
...
pdf_QCD  =[1.02]
scale_QCD_band3=[1.143]
scale_QCD_band2=[1.141]
...
jer_VV   =[1.05]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('ele18', 'barrel'),'w')
