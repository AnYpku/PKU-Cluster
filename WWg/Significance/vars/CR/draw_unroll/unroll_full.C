...
void unroll_run(TString var,TString njets){
	setTDRStyle();
	TFile* f_ZA=TFile::Open("../root/hist_ZGJets_"+var+"_"+njets+"_16.root");
	TH1D* th2_ZA16=(TH1D*)f_ZA->Get("hist_bkg");
        TH1D* th2_ZA= unroll(th2_ZA16,"t_ZA");
	TFile* f_ZA16pre=TFile::Open("../root/hist_ZGJets_"+var+"_"+njets+"_16pre.root");
	TH1D* th2_ZA16pre=(TH1D*)f_ZA16pre->Get("hist_bkg");
        TH1D* th2_ZA_16pre= unroll(th2_ZA16pre,"t_ZA16pre");
	TFile* f_ZA17=TFile::Open("../root/hist_ZGJets_"+var+"_"+njets+"_17.root");
	TH1D* th2_ZA17=(TH1D*)f_ZA17->Get("hist_bkg");
        TH1D* th2_ZA_17= unroll(th2_ZA17,"t_ZA17");
	TFile* f_ZA18=TFile::Open("../root/hist_ZGJets_"+var+"_"+njets+"_18.root");
	...
	TFile* f_WA=TFile::Open("../root/hist_WGJets_"+var+"_"+njets+"_16.root");
	TH1D* th2_WA16=(TH1D*)f_WA->Get("hist_bkg");
        TH1D* th2_WA= unroll(th2_WA16,"t_WA");
	TFile* f_WA16pre=TFile::Open("../root/hist_WGJets_"+var+"_"+njets+"_16pre.root");
	TH1D* th2_WA16pre=(TH1D*)f_WA16pre->Get("hist_bkg");
        TH1D* th2_WA_16pre= unroll(th2_WA16pre,"t_WA16pre");
	TFile* f_WA17=TFile::Open("../root/hist_WGJets_"+var+"_"+njets+"_17.root");
	TH1D* th2_WA17=(TH1D*)f_WA17->Get("hist_bkg");
        TH1D* th2_WA_17= unroll(th2_WA17,"t_WA17");
	TFile* f_WA18=TFile::Open("../root/hist_WGJets_"+var+"_"+njets+"_18.root");
...
//	const char *name[16]={"60-100","100-115","115-135","135-#infty","60-100","100-115","115-135","135-#infty","60-100","100-115","115-135","135-#infty","60-100","100-115","115-135","135-#infty"};
	...
	TFile* f_ZA_sig=TFile::Open("../root/hist_WWG_emu_tot_"+var+"_"+njets+"_16.root");
        TH1D* th2_ZA_sig16=(TH1D*)f_ZA_sig->Get("hist_sig");
        TH1D* th2_ZA_sig= unroll(th2_ZA_sig16,"t_ZA_sig");
	TFile* f_ZA_sig16pre=TFile::Open("../root/hist_WWG_emu_tot_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_ZA_sig16pre=(TH1D*)f_ZA_sig16pre->Get("hist_sig");
        TH1D* th2_ZA_sig_16pre= unroll(th2_ZA_sig16pre,"t_ZA_sig16pre");
	TFile* f_ZA_sig17=TFile::Open("../root/hist_WWG_emu_tot_"+var+"_"+njets+"_17.root");
        TH1D* th2_ZA_sig17=(TH1D*)f_ZA_sig17->Get("hist_sig");
        TH1D* th2_ZA_sig_17= unroll(th2_ZA_sig17,"t_ZA_sig17");
	TFile* f_ZA_sig18=TFile::Open("../root/hist_WWG_emu_tot_"+var+"_"+njets+"_18.root");
	...
	TFile* f_VV=TFile::Open("../root/hist_VV_"+var+"_"+njets+"_16.root");
        TH1D* th2_VV16=(TH1D*)f_VV->Get("hist_bkg");
        TH1D* th2_VV= unroll(th2_VV16,"t_VV");
	TFile* f_VV16pre=TFile::Open("../root/hist_VV_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_VV16pre=(TH1D*)f_VV16pre->Get("hist_bkg");
        TH1D* th2_VV_16pre= unroll(th2_VV16pre,"t_VV16pre");
	TFile* f_VV17=TFile::Open("../root/hist_VV_"+var+"_"+njets+"_17.root");
        TH1D* th2_VV17=(TH1D*)f_VV17->Get("hist_bkg");
        TH1D* th2_VV_17= unroll(th2_VV17,"t_VV17");
	TFile* f_VV18=TFile::Open("../root/hist_VV_"+var+"_"+njets+"_18.root");
	...
	TFile* f_TTA=TFile::Open("../root/hist_TTGJets_"+var+"_"+njets+"_16.root");
        TH1D* th2_TTA16=(TH1D*)f_TTA->Get("hist_bkg");
        TH1D* th2_TTA= unroll(th2_TTA16,"t_TTA");
	TFile* f_TTA16pre=TFile::Open("../root/hist_TTGJets_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_TTA16pre=(TH1D*)f_TTA16pre->Get("hist_bkg");
        TH1D* th2_TTA_16pre= unroll(th2_TTA16pre,"t_TTA16pre");
	TFile* f_TTA17=TFile::Open("../root/hist_TTGJets_"+var+"_"+njets+"_17.root");
        TH1D* th2_TTA17=(TH1D*)f_TTA17->Get("hist_bkg");
        TH1D* th2_TTA_17= unroll(th2_TTA17,"t_TTA17");
	TFile* f_TTA18=TFile::Open("../root/hist_TTGJets_"+var+"_"+njets+"_18.root");
	...
	th2_TTA->Add(th2_TTA_17,1);th2_TTA->Add(th2_TTA_18,1);th2_TTA->Add(th2_TTA_16pre,1);
        ...
        TFile* f_TT=TFile::Open("../root/hist_TTJets_"+var+"_"+njets+"_16.root");
        TH1D* th2_TT16=(TH1D*)f_TT->Get("hist_bkg");
        TH1D* th2_TT= unroll(th2_TT16,"t_TT");
        TFile* f_TT16pre=TFile::Open("../root/hist_TTJets_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_TT16pre=(TH1D*)f_TT16pre->Get("hist_bkg");
        TH1D* th2_TT_16pre= unroll(th2_TT16pre,"t_TT16pre");
        TFile* f_TT17=TFile::Open("../root/hist_TTJets_"+var+"_"+njets+"_17.root");
        TH1D* th2_TT17=(TH1D*)f_TT17->Get("hist_bkg");
        TH1D* th2_TT_17= unroll(th2_TT17,"t_TT17");
        TFile* f_TT18=TFile::Open("../root/hist_TTJets_"+var+"_"+njets+"_18.root");
        TH1D* th2_TT18=(TH1D*)f_TT18->Get("hist_bkg");
        TH1D* th2_TT_18= unroll(th2_TT18,"t_TT18");
        th2_TT->Add(th2_TT_17,1);th2_TT->Add(th2_TT_18,1);th2_TT->Add(th2_TT_16pre,1);
	th2_TTA->Add(th2_TT);
	...
	TFile* f_ST=TFile::Open("../root/hist_ST_"+var+"_"+njets+"_16.root");
        TH1D* th2_ST16=(TH1D*)f_ST->Get("hist_bkg");
        TH1D* th2_ST= unroll(th2_ST16,"t_ST");
	TFile* f_ST16pre=TFile::Open("../root/hist_ST_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_ST16pre=(TH1D*)f_ST16pre->Get("hist_bkg");
        TH1D* th2_ST_16pre= unroll(th2_ST16pre,"t_ST16pre");
	TFile* f_ST17=TFile::Open("../root/hist_ST_"+var+"_"+njets+"_17.root");
        TH1D* th2_ST17=(TH1D*)f_ST17->Get("hist_bkg");
        TH1D* th2_ST_17= unroll(th2_ST17,"t_ST17");
	TFile* f_ST18=TFile::Open("../root/hist_ST_"+var+"_"+njets+"_18.root");
	...
	TFile* f_plj=TFile::Open("../root/hist_plj_"+var+"_"+njets+"_16.root");
        TH1D* th2_plj16=(TH1D*)f_plj->Get("hist_bkg");
        TH1D* th2_plj= unroll(th2_plj16,"t_plj");
	TFile* f_plj16pre=TFile::Open("../root/hist_plj_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_plj16pre=(TH1D*)f_plj16pre->Get("hist_bkg");
        TH1D* th2_plj_16pre= unroll(th2_plj16pre,"t_plj");
	TFile* f_plj17=TFile::Open("../root/hist_plj_"+var+"_"+njets+"_17.root");
        TH1D* th2_plj17=(TH1D*)f_plj17->Get("hist_bkg");
        TH1D* th2_plj_17= unroll(th2_plj17,"t_plj17");
	TFile* f_plj18=TFile::Open("../root/hist_plj_"+var+"_"+njets+"_18.root");
	...
	TFile* f_fakeL=TFile::Open("../root/hist_fakeL_"+var+"_"+njets+"_16.root");
        TH1D* th2_fakeL16=(TH1D*)f_fakeL->Get("hist_bkg");
        TH1D* th2_fakeL= unroll(th2_fakeL16,"t_fakeL");
	TFile* f_fakeL16pre=TFile::Open("../root/hist_fakeL_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_fakeL16pre=(TH1D*)f_fakeL16pre->Get("hist_bkg");
        TH1D* th2_fakeL_16pre= unroll(th2_fakeL16pre,"t_fakeL");
	TFile* f_fakeL17=TFile::Open("../root/hist_fakeL_"+var+"_"+njets+"_17.root");
        TH1D* th2_fakeL17=(TH1D*)f_fakeL17->Get("hist_bkg");
        TH1D* th2_fakeL_17= unroll(th2_fakeL17,"t_fakeL17");
	TFile* f_fakeL18=TFile::Open("../root/hist_fakeL_"+var+"_"+njets+"_18.root");
        TH1D* th2_fakeL18=(TH1D*)f_fakeL18->Get("hist_bkg");
...
//        TLine* line = new TLine(th2_ZA->GetXaxis()->GetXmin(),0,th2_ZA->GetXaxis()->GetXmax(),0);
	...
	hs->Draw("HIST");
        ...
        htot->Draw("E2 same");
        TFile* f_data2=TFile::Open("../root/hist_MuonEG_"+var+"_"+njets+"_16.root");
        TH1D* th2_data16=(TH1D*)f_data2->Get("hist_bkg");
        TH1D* th2_data= unroll(th2_data16,"t2_data");
        TFile* f_data2_16pre=TFile::Open("../root/hist_MuonEG_"+var+"_"+njets+"_16pre.root");
        TH1D* th2_data16pre=(TH1D*)f_data2_16pre->Get("hist_bkg");
        TH1D* th2_data_16pre= unroll(th2_data16pre,"t2_data16pre");
        TFile* f_data2_17=TFile::Open("../root/hist_MuonEG_"+var+"_"+njets+"_17.root");
        TH1D* th2_data17=(TH1D*)f_data2_17->Get("hist_bkg");
        TH1D* th2_data_17= unroll(th2_data17,"t2_data17");
        TFile* f_data2_18=TFile::Open("../root/hist_MuonEG_"+var+"_"+njets+"_18.root");
        TH1D* th2_data18=(TH1D*)f_data2_18->Get("hist_bkg");
	...
	th2_data->Add(th2_data_17,1);th2_data->Add(th2_data_18,1);th2_data->Add(th2_data_16pre,1);
        ...
        TFile* f_data3=TFile::Open("../root/hist_Muon_"+var+"_"+njets+"_16.root");
        TH1D* th3_data16=(TH1D*)f_data3->Get("hist_bkg");
        TH1D* th3_data= unroll(th3_data16,"t3_data");
        TFile* f_data3_16pre=TFile::Open("../root/hist_Muon_"+var+"_"+njets+"_16pre.root");
        TH1D* th3_data16pre=(TH1D*)f_data3_16pre->Get("hist_bkg");
        TH1D* th3_data_16pre= unroll(th3_data16pre,"t3_data16pre");
        TFile* f_data3_17=TFile::Open("../root/hist_Muon_"+var+"_"+njets+"_17.root");
        TH1D* th3_data17=(TH1D*)f_data3_17->Get("hist_bkg");
        TH1D* th3_data_17= unroll(th3_data17,"t3_data17");
        TFile* f_data3_18=TFile::Open("../root/hist_Muon_"+var+"_"+njets+"_18.root");
        TH1D* th3_data18=(TH1D*)f_data3_18->Get("hist_bkg");
	...
	th3_data->Add(th3_data_17,1);th3_data->Add(th3_data_18,1);th3_data->Add(th3_data_16pre,1);
        ...
        TFile* f_data1=TFile::Open("../root/hist_Ele_"+var+"_"+njets+"_16.root");
        TH1D* th1_data16=(TH1D*)f_data1->Get("hist_bkg");
        TH1D* th1_data= unroll(th1_data16,"t1_data");
        TFile* f_data16pre=TFile::Open("../root/hist_Ele_"+var+"_"+njets+"_16pre.root");
        TH1D* th1_data16pre=(TH1D*)f_data16pre->Get("hist_bkg");
        TH1D* th1_data_16pre= unroll(th1_data16pre,"t1_data16pre");
        TFile* f_data1_17=TFile::Open("../root/hist_Ele_"+var+"_"+njets+"_17.root");
        TH1D* th1_data17=(TH1D*)f_data1_17->Get("hist_bkg");
        TH1D* th1_data_17= unroll(th1_data17,"t1_data17");
        TFile* f_data1_18=TFile::Open("../root/hist_Ele_"+var+"_"+njets+"_18.root");
        TH1D* th1_data18=(TH1D*)f_data1_18->Get("hist_bkg");
...
//        h_up->Draw("EP same");
	...
	c1->Print("aa_CR_"+var+"_"+njets+"_full.pdf");
}
int unroll_full(){
       vector<TString> var={"mllg","photonet","mll"};
       vector<TString> njets={"0jets","1jets","2jets"};

       for(int i=0;i<var.size();i++){
	       for(int k=1;k<njets.size();k++){
		       unroll_run(var[i],njets[k]);
	       }
       }
       return 0;
