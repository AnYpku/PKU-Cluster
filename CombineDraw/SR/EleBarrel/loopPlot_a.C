...
// Setup names of data files for trees.
	...
	std::cout << "set data imformation, we have " << nDATA << "data file"
			<< std::endl;
	std::string dataLabels[nDATA] = { "2018_Ele","2017_Ele","2016_Ele" };
...
std::string mcLabels[nMC] ={"2018_ST","2017_ST","2016_ST","2018_TTA","2017_TTA","2016_TTA","2018_VV","2017_VV","2016_VV","2018_WA","2017_WA","2016_WA","2018_plj_elebarrel","2017_plj_barrel","2016_plj_elebarrel","2018_ZA","2017_ZA","2016_ZA"};
