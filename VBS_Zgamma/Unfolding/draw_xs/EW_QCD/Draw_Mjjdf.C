...
void run(TString var, TString recovar,TString title,TString tag){
	...
	double Err_up[kk],Err_down[kk];
        ...
        ifstream f_in;
	f_in.open("/home/pku/anying/cms/PKU-Cluster/Unfolding/data_card/EW_QCD/combine/r_"+recovar+"_"+tag+".txt");  
        ifstream f_sys;
	f_sys.open("/home/pku/anying/cms/PKU-Cluster/Unfolding/data_card/EW_QCD/combine/breakdown/r_sys_"+recovar+"_"+tag+".txt");  
...
//	else if(tag.Contains("18"))latex.DrawLatex(0.76,0.92,Form("58.7 fb^{-1} (%d TeV)", (beamcomenergytev)));
        ...
        latex.SetLineWidth(2);
        latex.DrawLatex(0.17,0.11,"2.5<#Delta#eta_{jj}<4.5");
        latex.DrawLatex(0.5 ,0.11,"4.5<#Delta#eta_{jj}<6");
        latex.DrawLatex(0.8 ,0.11,"#Delta#eta_{jj}>6");
}
