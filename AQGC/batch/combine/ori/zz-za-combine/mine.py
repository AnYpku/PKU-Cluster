...
input_filename_e = '/home/pku/anying/cms/PKU-Cluster/AQGC/combine/ele/paramsets_'+sys.argv[1]+'_el.txt'
input_filename_m = '/home/pku/anying/cms/PKU-Cluster/AQGC/combine/muon/paramsets_'+sys.argv[1]+'_mu.txt'
...
for i in range(1,7):
        ...
        hists[i+9]=h1.Clone("aqgc_scaling_bin_%i"%(i+10))
        hists[i+9].SetTitle("aqgc_scaling_bin_%i"%(i+10))
        hists[i+9].Write()
