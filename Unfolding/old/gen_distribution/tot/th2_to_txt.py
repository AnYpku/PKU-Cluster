...
f_sig16 = TFile.Open("../2016/obs/root/hist_ZA-EWK.root")
f_sig17 = TFile.Open("../2017/obs/root/hist_ZA-EWK.root")
f_sig18 = TFile.Open("../2018/obs/root/hist_ZA-EWK.root")
tstack = f_in.Get("hs")
...
for i in range(1,6):
   ...
   genhist16 =f_sig16.Get("hist5_{}".format(i)) 
   genhist17 =f_sig17.Get("hist5_{}".format(i)) 
   genhist18 =f_sig18.Get("hist5_{}".format(i)) 
   for k in range(1,6):
           genbin.append( genhist16.GetBinContent(k)+genhist17.GetBinContent(k)+genhist18.GetBinContent(k))
#	   genbin16.append(genhist16.GetBinContent(k))
#	   genbin17.append(genhist17.GetBinContent(k))
#	   genbin18.append(genhist18.GetBinContent(k))
#   for k in range(1,6):
#          genbin.append(genbin16[k]+genbin17[k]+genbin18[k])
