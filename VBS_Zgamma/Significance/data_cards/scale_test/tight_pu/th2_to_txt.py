...
fdir = '/home/pku/anying/cms/PKU-Cluster/Significance/tight_pu/root/'
...
genbinerror=[]
arr={}
f=open('/home/pku/anying/cms/PKU-Cluster/Significance/Uncer/tight_pu/summary_uncer_'+sys.argv[2]+sys.argv[1]+'.txt')
import re
import numpy as np
for line in f:
        if not line.strip():
