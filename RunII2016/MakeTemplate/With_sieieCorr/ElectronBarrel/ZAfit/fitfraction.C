...
TFile* fdata = TFile::Open("../root/Data_template2-DEle16.root");
TFile* ftrue = TFile::Open("../root/True_template2-ZA16.root");
TFile* ffake = TFile::Open("../root/Fake_template2-DEle16.root");
...
//            fr = p0* (hfake->Integral(1,hfake->FindFixBin(0.03001))/hfake->Integral())/(hdata->Integral(1,hdata->FindFixBin(0.03001))/hdata->Integral());
		...
		ofstream myfile1(TString("./fractionfitResult_za/txt/fakerate_")+ name + Form("_pt%0.f_%0.f.txt", lowpt, highpt),ios::out);
