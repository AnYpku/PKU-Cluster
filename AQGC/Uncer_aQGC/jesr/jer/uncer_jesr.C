...
void run(TString sample){
	...
	TFile*file1 = new TFile("./root/hist_"+sample+"_jer16.root");
	TFile*file2 = new TFile("./root/hist_"+sample+"_jer17.root");
	TFile*file3 = new TFile("./root/hist_"+sample+"_jer18.root");
