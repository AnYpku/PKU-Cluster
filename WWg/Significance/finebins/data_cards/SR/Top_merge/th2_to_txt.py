...
fdir = '/home/pku/anying/cms/PKU-Cluster/WWg/Significance/finebins/root/'
f_Data=TFile.Open(fdir+'hist_MuonEG_'+sys.argv[1]+'.root')
...
genbinerror=[]
arr={}
f=open('/home/pku/anying/cms/PKU-Cluster/WWg/Significance/finebins/Uncer/SR/summary_uncer_'+sys.argv[1]+'.txt')
import re
import numpy as np
for line in f:
        if not line.strip():
