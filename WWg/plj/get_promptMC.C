void run(TString var,TString cut,vector<double> bins){
	...
	TH1D*h1[num];
	for(int i=0;i<num;i++){
		TFile*fin=new TFile("/home/pku/anying/cms/rootfiles/WWg/cutla-out"+sample[i]+"18_plj.root");
