...
void rm::Loop(TString tag)
{
   ...
   TFile*fPU=new TFile("/home/pku/anying/cms/PKU-Cluster/PUID/PUIDMaps.root");
   f1=new TFile("/home/pku/anying/cms/PKU-Cluster/PUID/PUID_80XTraining_EffSFandUncties.root");
   TH2F*h2_eff_mc_M=(TH2F*)fPU->Get("h2_eff_mc20"+tag+"_M");
   TH2F*h2_eff_sf_M=(TH2F*)fPU->Get("h2_eff_sf20"+tag+"_M");
   TH2F*h2_mistag_mc_M=(TH2F*)fPU->Get("h2_mistag_mc20"+tag+"_M");
   TH2F*h2_mistag_sf_M=(TH2F*)fPU->Get("h2_mistag_sf20"+tag+"_M");
   TH2F*h2_eff_mc_T=(TH2F*)fPU->Get("h2_eff_mc20"+tag+"_T");
   TH2F*h2_eff_sf_T=(TH2F*)fPU->Get("h2_eff_sf20"+tag+"_T");
   TH2F*h2_mistag_mc_T=(TH2F*)fPU->Get("h2_mistag_mc20"+tag+"_T");
   TH2F*h2_mistag_sf_T=(TH2F*)fPU->Get("h2_mistag_sf20"+tag+"_T");
   TH2F*h2_eff_mc_L=(TH2F*)fPU->Get("h2_eff_mc20"+tag+"_L");
   TH2F*h2_eff_sf_L=(TH2F*)fPU->Get("h2_eff_sf20"+tag+"_L");
   TH2F*h2_mistag_mc_L=(TH2F*)fPU->Get("h2_mistag_mc20"+tag+"_L");
   TH2F*h2_mistag_sf_L=(TH2F*)fPU->Get("h2_mistag_sf20"+tag+"_L");
   TH2F*h_sys_M;TH2F*h_sys_T;TH2F*h_sys_L;
   if(tag.Contains("16")){
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	   ...
	   puIdweight_T_effUp=get_puIdweight_effDn(jet1eta,jet1phi,jet1pt,h2_eff_mc_T,h2_eff_sf_T,h2_mistag_mc_T,h2_mistag_sf_T,jet1puIdTight,h_sys_T,"T",realjet1,tag)*get_puIdweight_effDn(jet2eta,jet2phi,jet2pt,h2_eff_mc_T,h2_eff_sf_T,h2_mistag_mc_T,h2_mistag_sf_T,jet2puIdTight,h_sys_T,"T",realjet2,tag);
...
void rm::SetValue(){
	...
	muon_hlt_scale=1;
	puIdweight_M=1;
	puIdweight_M_effUp=1;
	puIdweight_M_effDn=1;
	puIdweight_M_misUp=1;
	puIdweight_M_misDn=1;
	puIdweight_T=1;
	puIdweight_T_effUp=1;
	puIdweight_T_effDn=1;
	puIdweight_T_misUp=1;
	puIdweight_T_misDn=1;
	puIdweight_L=1;
	puIdweight_L_effUp=1;
	puIdweight_L_effDn=1;
	puIdweight_L_misUp=1;
	puIdweight_L_misDn=1;
}
Double_t rm::get_puIdweight(double ak4jet_eta,double ak4jet_phi,double ak4jet_pt,TH2F*h2_eff_mc,TH2F*h2_eff_sf,TH2F*h2_mistag_mc,TH2F*h2_mistag_sf,double ak4jet_puId,int realjet){
...
Double_t rm::get_puIdweight_effUp(double ak4jet_eta,double ak4jet_phi,double ak4jet_pt,TH2F*h2_eff_mc,TH2F*h2_eff_sf,TH2F*h2_mistag_mc,TH2F*h2_mistag_sf,double ak4jet_puId,TH2F*h_sys,TString type,int realjet,TString tag){
//      cout<<"get "<<type<<" weight with up"<<endl;
//      cout<<"h2_eff_sf20"+tag+"_"+type+"_Systuncty"<<endl;
...
Double_t rm::get_puIdweight_effDn(double ak4jet_eta,double ak4jet_phi,double ak4jet_pt,TH2F*h2_eff_mc,TH2F*h2_eff_sf,TH2F*h2_mistag_mc,TH2F*h2_mistag_sf,double ak4jet_puId,TH2F*h_sys,TString type,int realjet,TString tag){
	h_sys=(TH2F*)f1->Get("h2_eff_sf20"+tag+"_"+type+"_Systuncty");
	double DR1=1e4,DR2=1e4;
	int ip1=-1,ip2=-1;
	double MCweight=1,Dataweight=1,puIdweight=1;
...
Double_t rm::get_puIdweight_misUp(double ak4jet_eta,double ak4jet_phi,double ak4jet_pt,TH2F*h2_eff_mc,TH2F*h2_eff_sf,TH2F*h2_mistag_mc,TH2F*h2_mistag_sf,double ak4jet_puId,TH2F*h_sys,TString type,int realjet,TString tag){
...
Double_t rm::get_puIdweight_misDn(double ak4jet_eta,double ak4jet_phi,double ak4jet_pt,TH2F*h2_eff_mc,TH2F*h2_eff_sf,TH2F*h2_mistag_mc,TH2F*h2_mistag_sf,double ak4jet_puId,TH2F*h_sys,TString type,int realjet,TString tag){
	h_sys=(TH2F*)f1->Get("h2_mistag_sf20"+tag+"_"+type+"_Systuncty");
	double DR1=1e4,DR2=1e4;
	int ip1=-1,ip2=-1;
	double MCweight=1,Dataweight=1,puIdweight=1;
