...
TH1D* hist_1d(TString filename){
	...
	TString file;
	if(filename.Contains("plj")==0) file = "./optimal_aqgc_"+filename+"17.root";
	else file="./optimal_aqgc_"+filename+"17_weight.root";
...
int d_hist_ele(){
	TFile* f1=new TFile("out_aqgc_ele17.root","RECREATE");
