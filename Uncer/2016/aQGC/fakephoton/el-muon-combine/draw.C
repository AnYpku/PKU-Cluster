...
TFile*f1=new TFile("../ele/ele_hist.root");
TFile*f2=new TFile("../ele/ele_up_hist.root");
TFile*f3=new TFile("../ele/ele_down_hist.root");

TH1D*h1=(TH1D*)f1->Get("ele");
TH1D*h2=(TH1D*)f2->Get("ele_up");
TH1D*h3=(TH1D*)f3->Get("ele_down");

TFile*ff1=new TFile("../muon/mu_hist.root");
TFile*ff2=new TFile("../muon/mu_up_hist.root");
TFile*ff3=new TFile("../muon/mu_down_hist.root");
