...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016eleendcap/mjj5007501000_detajj25456_zepp18/aa.root")
tstack = f_in.Get("hs")
...
fakephoton=[1.31,1.32,1.25,1.33,1.35,1.34,1.33]
l1pref    =[1.02,1.03,1.04,1.01,1.01,1.03,1.02]

jes_QCD  =[1.05,1.04,1.12,1.16,1.19,1.24,1.17]
jes_EWK      =[1.02,1.03,1.05,1.08,1.05,1.06,1.03]
...
for i in range(1,8):
   f = open('%s_%s_bin_%d.txt'%('ele16', 'endcap', i),'w')
