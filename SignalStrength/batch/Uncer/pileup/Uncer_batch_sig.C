...
void run(TString cut1,TString tag,TString sample){
     ...
     Double_t scalef,pileupWeight,prefWeight,prefWeightUp,prefWeightDown,puIdweight_T,puIdweight_M,puIdweight_L,puIdweight;
     ...
     TFile*f=new TFile(dir1+"puweight.root");
     ...
     for(int k=0;k<tree->GetEntries();k++){
	     ...
	     cout<<npT<<" "<<pileupWeight<<" "<<pileupWeight_up<<" "<<pileupWeight_down<<endl;
