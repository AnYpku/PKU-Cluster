#define num 8
void Uncer(){
 Double_t lpt[num]= {20,25,30,35,40,50,60,100};//i
...
TFile* f1 = new TFile("/afs/cern.ch/work/y/yian/work/PKU-Cluster/RunII2018/plj/plj-plot/EleBarrel/plj-hist/cutla-outDEle_plj_h.root");
TFile* f2 = new TFile("/afs/cern.ch/work/y/yian/work/PKU-Cluster/RunII2018/plj/plj-plot/EleBarrel/plj-hist/cutla-outDEle_h.root");
TFile* f3 = new TFile("/afs/cern.ch/work/y/yian/work/PKU-Cluster/RunII2018/plj/plj-plot/EleBarrel/plj-hist/cutla-outZA_plj_h.root");
