...
TFile* fdataT = TFile::Open("../../root/Data_template-cutlep-outData.root");
TFile* fdataF = TFile::Open("../../root/Fake_template-cutlep-outData.root");
//TFile* fmcT = TFile::Open("../../root/True_template-outZA-EWK.root");
TFile* fmcT = TFile::Open("../../root/True_template-outZA.root");
TString dir = "./txt/"; 
