...
//=========  (Fri Jun  5 17:39:00 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-532.5156,1.0625,3563.758);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(3042.946);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(3195.094);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,3.726848);
   unrolledsPhist_stack_1->SetBinError(1,0.930392);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,37.04777);
   unrolledsPhist_stack_2->SetBinError(1,3.485173);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,16.49264);
   unrolledsPhist_stack_3->SetBinError(1,2.587731);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,515.8044);
   unrolledsPhist_stack_5->SetBinError(1,13.14985);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,926.6175);
   unrolledsPhist_stack_6->SetBinError(1,23.44465);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,21.78401);
   unrolledsPhist_stack_7->SetBinError(1,0.6948547);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [21.78]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [926.62]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [515.80]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [16.49]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [37.05]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [3.73]","lpf");
