...
//        Double_t mlla_bins[5]={90, 130, 170, 210, 240};
	...
	TFile* f_ZA=TFile::Open("./2016/mubarrel/hist_ZA.root");
	TFile* f_ZA17=TFile::Open("./2017/mubarrel/hist_ZA.root");
	TFile* f_ZA18=TFile::Open("./2018/mubarrel/hist_ZA.root");
...
//	const char *name[9]={"Mjj 500~600","Mjj 600~800","Mjj 800~2000","Mjj 500~600","Mjj 600~800","Mjj 800~2000","Mjj 500~600","Mjj 600~800","Mjj 800~2000"};
	...
	TFile* f_ZA_sig=TFile::Open("./2016/mubarrel/hist_ZA-EWK.root");
	TFile* f_ZA_sig17=TFile::Open("./2017/mubarrel/hist_ZA-EWK.root");
	TFile* f_ZA_sig18=TFile::Open("./2018/mubarrel/hist_ZA-EWK.root");
...
//	t_ZA_sigout->Scale(lumi);
	...
	TFile* f_WA=TFile::Open("./2016/mubarrel/hist_WA.root");
	TFile* f_WA17=TFile::Open("./2017/mubarrel/hist_WA.root");
	TFile* f_WA18=TFile::Open("./2018/mubarrel/hist_WA.root");
...
//	t_WA->Scale(lumi);
	...
	TFile* f_VV=TFile::Open("./2016/mubarrel/hist_VV.root");
	TFile* f_VV17=TFile::Open("./2017/mubarrel/hist_VV.root");
	TFile* f_VV18=TFile::Open("./2018/mubarrel/hist_VV.root");
...
//	t_VV->Scale(lumi);
	...
	TFile* f_TTA=TFile::Open("./2016/mubarrel/hist_TTA.root");
	TFile* f_TTA17=TFile::Open("./2017/mubarrel/hist_TTA.root");
	TFile* f_TTA18=TFile::Open("./2018/mubarrel/hist_TTA.root");
...
//	t_TTA->Scale(lumi);
	...
	TFile* f_ST=TFile::Open("./2016/mubarrel/hist_ST.root");
	TFile* f_ST17=TFile::Open("./2017/mubarrel/hist_ST.root");
	TFile* f_ST18=TFile::Open("./2018/mubarrel/hist_ST.root");
...
//	t_ST->Scale(lumi);
	...
	TFile* f_plj=TFile::Open("./2016/mubarrel/hist_plj_mubarrel.root");
	TFile* f_plj17=TFile::Open("./2017/mubarrel/hist_plj_mubarrel.root");
	TFile* f_plj18=TFile::Open("./2018/mubarrel/hist_plj_mubarrel.root");
