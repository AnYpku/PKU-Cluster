...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(TString name,TString tag);
...
void xx::Init(TTree *tree)
{
   ...
   newtree->Branch("puIdweight_L_JER_up",&puIdweight_L_JER_up,"puIdweight_L_JER_up/D");
   newtree->Branch("puIdweight_M_JER_up",&puIdweight_M_JER_up,"puIdweight_M_JER_up/D");
   newtree->Branch("puIdweight_T_JER_up",&puIdweight_T_JER_up,"puIdweight_T_JER_up/D");

   newtree->Branch("puIdweight_L_JER_down",&puIdweight_L_JER_down,"puIdweight_L_JER_down/D");
   newtree->Branch("puIdweight_M_JER_down",&puIdweight_M_JER_down,"puIdweight_M_JER_down/D");
   newtree->Branch("puIdweight_T_JER_down",&puIdweight_T_JER_down,"puIdweight_T_JER_down/D");
