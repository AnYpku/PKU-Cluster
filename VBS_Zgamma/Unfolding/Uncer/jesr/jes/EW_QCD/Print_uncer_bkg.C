...
void run(TString var, TString tag){
	...
	TFile*file=new TFile("../root/unfold_ZA-EWKout_"+var+"_jes"+tag+".root");
	TFile*file1=new TFile("./root/unfold_ZAout_"+var+"_jes"+tag+".root");
	TFile*file2=new TFile("./root/unfold_ZA_interfout_"+var+"_jes"+tag+".root");
