...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2017/FourChannels/2017muendcap/SR/mjj5007501000_detajj25456_zepp18/aa.root")
tstack = f_in.Get("hs")
...
jes_EWK      =[1.04,1.07,1.05,1.07,1.09,1.08,1.11]
