...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2017/FourChannels/2017eleendcap/SR/CR/aa.root")
tstack = f_in.Get("hs")
...
pdf_QCD  =[1.02]
scale_QCD_band3=[1.17]
scale_QCD_band2=[1.16]
scale_QCD_band1=[1.011]
pdf_ewk   =[1.04]
scale_ewk =[1.00]
interf =[1.17]
...
jer_VV   =[1.10]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('ele17', 'endcap'),'w')
