...
void plj::Loop(TString name)
{
   ...
   ifstream f1,f2;
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/fakephoton/mubarrel/step1/pljweight"+name+".txt");
   f2.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/fakephoton/muendcap/step1/pljweight"+name+".txt");
