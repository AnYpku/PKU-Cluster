...
int d_hist(){
	TH2D* h0    = run("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016eleendcap/output-slimmed-rootfiles/optimal_2016SR_plj_eleendcap.root",0);
	TH2D* hup   = run("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016eleendcap/output-slimmed-rootfiles/optimal_2016SR_plj_eleendcap_up.root",1);
	TH2D* hdown = run("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2016/FourChannels/2016eleendcap/output-slimmed-rootfiles/optimal_2016SR_plj_eleendcap_down.root",2);
