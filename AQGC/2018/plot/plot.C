...
//	setTDRStyle();
	string mu_file="/home/pku/anying/cms/PKU-Cluster/AQGC/2018/muon/paramsets_"+a+"_mu.txt";
	string ele_file="/home/pku/anying/cms/PKU-Cluster/AQGC/2018/ele/paramsets_"+a+"_el.txt";
	ifstream infile_mu;
	ifstream infile_ele;
...
//		weight[i]=1;
	...
	TFile *file1 = new TFile("out_aqgc_mu18.root","R"); 
	...
	TFile *file2 = new TFile("out_aqgc_ele18.root","R");
        file2->cd("");
