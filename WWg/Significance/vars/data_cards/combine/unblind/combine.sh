...
do
  ...
  do
    ...
    do
      ...
      combine -M Significance  full${y}_${var}_${njets}_test.txt > result${y}_${var}_${njets}_test.txt 
      combine -M Significance  full${y}_${var}_${njets}_test.txt --freezeParameters all > result${y}_${var}_${njets}_freezeAll.txt
    done
  done
  ...
  combine -M Significance  full_${var}.txt > result_full_${var}.txt
  combine -M Significance  full_${var}.txt --freezeParameters all > result_full_${var}_freezeAll.txt
done
