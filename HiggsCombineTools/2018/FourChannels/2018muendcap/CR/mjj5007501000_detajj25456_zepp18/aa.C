...
//=========  (Sun Jan 19 19:40:50 2020) by ROOT version6.10/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-120.2041,1.0625,804.4426);
   pad1->SetFillColor(0);
   ...
   hs_stack_1->SetMaximum(721.2244);
   ...
   ST_stack_1->SetBinContent(1,1.105853);
   ST_stack_1->SetBinError(1,0.5017752);
   ...
   TTA_stack_2->SetBinContent(1,7.23157);
   TTA_stack_2->SetBinError(1,1.677048);
   ...
   VV_stack_3->SetBinContent(1,9.507965);
   VV_stack_3->SetBinError(1,2.05119);
   ...
   plj_stack_5->SetBinContent(1,409.5445);
   plj_stack_5->SetBinError(1,11.33486);
   ...
   t_ZA_stack_6->SetBinContent(1,252.8578);
   t_ZA_stack_6->SetBinError(1,12.76806);
   ...
   ZA_sig_stack_7->SetBinContent(1,6.632665);
   ZA_sig_stack_7->SetBinError(1,0.3964182);
