...
// Tue Feb 18 11:15:14 2020 by ROOT version 5.34/38
// from TChain ZPKUCandidates/
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<double>  *drjj_up;
   vector<double>  *Mjj_up;
   vector<double>  *detajj_up;
   vector<double>  *drjj_down;
   vector<double>  *Mjj_down;
   vector<double>  *detajj_down;
   Int_t           nm;
   Int_t           np;
   ...
   TBranch        *b_drj2l1_up;   //!
   TBranch        *b_drj2l2_up;   //!
   TBranch        *b_drj1a_down;   //!
   TBranch        *b_drj1l1_down;   //!
   TBranch        *b_drj1l2_down;   //!
   TBranch        *b_drj2l1_down;   //!
   TBranch        *b_drj2l2_down;   //!
   TBranch        *b_drjj_up;   //!
   TBranch        *b_Mjj_up;   //!
   TBranch        *b_detajj_up;   //!
   TBranch        *b_drjj_down;   //!
   TBranch        *b_Mjj_down;   //!
   TBranch        *b_detajj_down;   //!
   TBranch        *b_nm;   //!
   TBranch        *b_np;   //!
   ...
   vector<double> zepp_up;vector<double> zepp_down;
   double delta_phi;
};
...
#ifdef small_cxx
small::small(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("./cutla-outZA-JESR-src4.root/ZPKUCandidates");
      chain->Add("./cutla-outZA-JESR-src3.root/ZPKUCandidates");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t small::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t small::LoadTree(Long64_t entry)
{
...
void small::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("drj1a_up", &drj1a_up, &b_drj1a_up);
    fChain->SetBranchAddress("drj2a_up", &drj1a_up, &b_drj1a_up);
   fChain->SetBranchAddress("drj1l1_up", &drj1l1_up, &b_drj1l1_up);
   fChain->SetBranchAddress("drj1l2_up", &drj1l2_up, &b_drj1l2_up);
   fChain->SetBranchAddress("drj2l1_up", &drj2l1_up, &b_drj2l1_up);
   fChain->SetBranchAddress("drj2l2_up", &drj2l2_up, &b_drj2l2_up);
   fChain->SetBranchAddress("drj1a_down", &drj1a_down, &b_drj1a_down);
    fChain->SetBranchAddress("drj2a_down", &drj1a_down, &b_drj1a_down);
   fChain->SetBranchAddress("drj1l1_down", &drj1l1_down, &b_drj1l1_down);
   fChain->SetBranchAddress("drj1l2_down", &drj1l2_down, &b_drj1l2_down);
   fChain->SetBranchAddress("drj2l1_down", &drj2l1_down, &b_drj2l1_down);
   fChain->SetBranchAddress("drj2l2_down", &drj2l2_down, &b_drj2l2_down);
   fChain->SetBranchAddress("drjj_up", &drjj_up, &b_drjj_up);
   fChain->SetBranchAddress("Mjj_up", &Mjj_up, &b_Mjj_up);
   fChain->SetBranchAddress("detajj_up", &detajj_up, &b_detajj_up);
   fChain->SetBranchAddress("drjj_down", &drjj_down, &b_drjj_down);
   fChain->SetBranchAddress("Mjj_down", &Mjj_down, &b_Mjj_down);
   fChain->SetBranchAddress("detajj_down", &detajj_down, &b_detajj_down);
   fChain->SetBranchAddress("nm", &nm, &b_nm);
...
void small::Show(Long64_t entry)
{
...
Int_t small::Cut(Long64_t entry)
{
