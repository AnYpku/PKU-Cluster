...
fdir = '/home/pku/anying/cms/PKU-Cluster/WWg/Significance/test/root/'
...
genbinerror=[]
arr={}
f=open('/home/pku/anying/cms/PKU-Cluster/WWg/Significance/test/Uncer/SR/summary_uncer_'+sys.argv[1]+'.txt')
import re
import numpy as np
for line in f:
        if not line.strip():
