...
void jesrUncer::Loop(TH2D* th2[3])
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	   ...
	   JET = ( (!(fabs(jet2eta)<3.14 && fabs(jet2eta)>2.65) && !(fabs(jet1eta)<3.14 && fabs(jet1eta)>2.65) &&  jet1pt<50 && jet2pt<50 && jet1pt>30 && jet2pt>30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7) || (jet1pt>50 && jet2pt>50 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7) ) && Mjj > 150 && drla > 0.7 && drla2 > 0.7 && drj1a > 0.5 && drj2a > 0.5 && drjj> 0.5 && drj1l > 0.5 && drj2l > 0.5 && drj1l2 > 0.5 && drj2l2 > 0.5 && zepp<2.4 && delta_phi>1.9;
	   JET_new = ( (!(fabs(jet2eta_new)<3.14 && fabs(jet2eta_new)>2.65) && !(fabs(jet1eta_new)<3.14 && fabs(jet1eta_new)>2.65) &&  jet1pt_new<50 && jet2pt_new<50 && jet1pt_new>30 && jet2pt_new>30 && fabs(jet1eta_new)< 4.7 && fabs(jet2eta_new)<4.7) || (jet1pt_new>50 && jet2pt_new>50 && fabs(jet1eta_new)< 4.7 && fabs(jet2eta_new)<4.7) ) && Mjj_new > 150 && drla > 0.7 && drla2 > 0.7 && drj1a_new > 0.5 && drj2a_new > 0.5 && drjj_new> 0.5 && drj1l_new > 0.5 && drj2l_new > 0.5 && drj1l2_new > 0.5 && drj2l2_new > 0.5 && zepp_new<2.4 && delta_phi_new>1.9;
	   JET_down = ( (!(fabs(jet2eta_JEC_down)<3.14 && fabs(jet2eta_JEC_down)>2.65) && !(fabs(jet1eta_JEC_down)<3.14 && fabs(jet1eta_JEC_down)>2.65) &&  jet1pt_JEC_down<50 && jet2pt_JEC_down<50 && jet1pt_JEC_down>30 && jet2pt_JEC_down>30 && fabs(jet1eta_JEC_down)< 4.7 && fabs(jet2eta_JEC_down)<4.7) || (jet1pt_JEC_down>50 && jet2pt_JEC_down>50 && fabs(jet1eta_JEC_down)< 4.7 && fabs(jet2eta_JEC_down)<4.7) ) && Mjj_JEC_down > 150 && drla > 0.7 && drla2 > 0.7 && drj1a_JEC_down > 0.5 && drj2a_JEC_down > 0.5  && drjj_JEC_down> 0.5 && drj1l_JEC_down > 0.5 && drj2l_JEC_down > 0.5 && drj1l2_JEC_down > 0.5 && drj2l2_JEC_down > 0.5 && zepp_JEC_down<2.4 && delta_phi_JEC_down>1.9;
	   JET_up = ( (!(fabs(jet2eta_JEC_up)<3.14 && fabs(jet2eta_JEC_up)>2.65) && !(fabs(jet1eta_JEC_up)<3.14 && fabs(jet1eta_JEC_up)>2.65) &&  jet1pt_JEC_up<50 && jet2pt_JEC_up<50 && jet1pt_JEC_up>30 && jet2pt_JEC_up>30 && fabs(jet1eta_JEC_up)< 4.7 && fabs(jet2eta_JEC_up)<4.7) || (jet1pt_JEC_up>50 && jet2pt_JEC_up>50 && fabs(jet1eta_JEC_up)< 4.7 && fabs(jet2eta_JEC_up)<4.7) ) && Mjj_JEC_up > 150 && drla > 0.7 && drla2 > 0.7 && drj1a_JEC_up > 0.5 && drj2a_JEC_up > 0.5  && drjj_JEC_up> 0.5 && drj1l_JEC_up > 0.5 && drj2l_JEC_up > 0.5 && drj1l2_JEC_up > 0.5 && drj2l2_JEC_up > 0.5 && zepp_JEC_up<2.4 && delta_phi_JEC_down>1.9;

	   if( !(
//				   (drll>0.3 &&drla>0.7 && drla2>0.7 && lep == 13 &&  HLT_Mu1 > 0 && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep > 70. && massVlep < 110. && photonet > 20. &&( (fabs(photoneta) < 1.4442) /*|| ( fabs(photoneta)<2.5&&fabs(photoneta)>1.566)*/ ) && Mva>100)||	
