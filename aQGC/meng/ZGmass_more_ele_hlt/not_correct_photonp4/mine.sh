...
text2workspace.py -m 126 all.txt -o os_mll_${operator}.root -P HiggsAnalysis.CombinedLimit.OneParameterPhysicsModel:my_1d_model --PO range_param=[${lower},${upper}] --PO scaling_filename=/uscms_data/d3/mlu/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/ZGmass_more_ele_hlt/wpwp_${operator}_scaling_refined.root
