...
sed -i '/group/d' tmp
sed -i '/ST_Stat_bin1_elebarrel/d' tmp
echo "$theory"
sed -i ':label;N;s/\n/,/;t label' tmp
#sed -i "$ a $theory" tmp
...
combine -M MultiDimFit --algo grid --points 50  --rMin 0.6 --rMax 3 -m 125 -n theory_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeNuisanceGroups theory --expectSignal=1

combine -M MultiDimFit --algo grid --points 50  --rMin 0.6 --rMax 3 -m 125 -n Stat_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeNuisanceGroups Stat --expectSignal=1

combine -M MultiDimFit --algo grid --points 50  --rMin 0.6 --rMax 3 -m 125 -n JESR_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeNuisanceGroups JESR --expectSignal=1

combine -M MultiDimFit --algo grid --points 50  --rMin 0.6 --rMax 3 -m 125 -n muon_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeNuisanceGroups muon --expectSignal=1

combine -M MultiDimFit --algo grid --points 50  --rMin 0.6 --rMax 3 -m 125 -n ele_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeNuisanceGroups egamma --expectSignal=1

combine -M MultiDimFit --algo grid --points 50  --rMin 0.6 --rMax 3 -m 125 -n Others_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeNuisanceGroups Others --expectSignal=1

combine -M MultiDimFit --algo grid --points 50  --rMin 0.6 --rMax 3 -m 125 -n fake_${name} higgsCombinebestfit_${name}.MultiDimFit.mH125.root --snapshotName MultiDimFit --freezeNuisanceGroups fake --expectSignal=1
