...
////
        ...
        latex.SetTextSize(0.06);
        latex.SetLineWidth(2);
        latex.DrawLatex(0.5,1.4*max,"10<m_{#font[12]{l_{1}#gamma}}<50");
        latex.DrawLatex(4.5,1.4*max,"50<m_{#font[12]{l_{1}#gamma}}<120");
        latex.DrawLatex(8.5,1.4*max,"m_{#font[12]{l_{1}#gamma}}>120");
