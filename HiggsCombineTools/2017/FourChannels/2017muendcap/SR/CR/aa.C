...
//=========  (Fri Jun  5 17:21:14 2020) by ROOT version 6.12/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-79.59274,1.0625,532.6591);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(454.8156);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",1,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(477.5564);
   ...
   unrolledsPhist_stack_1->SetBinContent(1,0.397595);
   unrolledsPhist_stack_1->SetBinError(1,0.2608142);
   ...
   unrolledsPhist_stack_2->SetBinContent(1,4.118996);
   unrolledsPhist_stack_2->SetBinError(1,0.701082);
   ...
   unrolledsPhist_stack_3->SetBinContent(1,4.01778);
   unrolledsPhist_stack_3->SetBinError(1,1.036918);
   ...
   unrolledsPhist_stack_5->SetBinContent(1,103.2234);
   unrolledsPhist_stack_5->SetBinError(1,5.111009);
   ...
   unrolledsPhist_stack_6->SetBinContent(1,112.5886);
   unrolledsPhist_stack_6->SetBinError(1,4.424435);
   ...
   unrolledsPhist_stack_7->SetBinContent(1,3.061432);
   unrolledsPhist_stack_7->SetBinError(1,0.2110194);
   ...
   TLegendEntry *entry=leg->AddEntry("unrolled hist_stack_7","EWK [3.06]","lpf");
   ...
   entry=leg->AddEntry("unrolled hist_stack_6","ZA [112.59]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_5","non-prompt [103.22]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_3","VV [4.02]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_2","TTA [4.12]","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("unrolled hist_stack_1","ST  [0.40]","lpf");
