...
void aa(string a, double limit){
	setTDRStyle();
	string mu_file="/eos/user/m/melu/ZAjj_L1_prefiring/aQGC_estimation/muon/step1/ZGmass/paramsets_"+a+"_mu.txt";
	string ele_file="/eos/user/m/melu/ZAjj_L1_prefiring/aQGC_estimation/ele/step1/step1/ZGmass/paramsets_"+a+"_el.txt";
	ifstream infile_mu;
	ifstream infile_ele;
...
//        gr->SetFillColor(1);
	...
	TLegend *l1 = new TLegend(0.5,0.7,0.7,0.91);
	TLegend *l2 = new TLegend(0.7,0.7,0.9,0.91);
	//l1->SetBorderSize(2);
	l1->SetFillColor(10);
	l1->SetTextSize(0.04);
	l2->SetFillColor(10);
