...
void xx::Init(TTree *tree)
{
	...
	newtree = fChain->CloneTree(0);
        newtree->Branch("puIdweight_L_effUp",&puIdweight_L_effUp,"puIdweight_L_effUp/D");
        newtree->Branch("puIdweight_L_effDn",&puIdweight_L_effDn,"puIdweight_L_effDn/D");
        newtree->Branch("puIdweight_L_misUp",&puIdweight_L_misUp,"puIdweight_L_misUp/D");
        newtree->Branch("puIdweight_L_misDn",&puIdweight_L_misDn,"puIdweight_L_misDn/D");
