...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2017/FourChannels/2017elebarrel/SR/mjj5007501000_detajj25456_zepp18/aa.root")
tstack = f_in.Get("hs")
...
scale_QCD_band3=[1.138,1.148,1.059,1.131,1.098,1.120,1.073]
scale_QCD_band2=[1.138,1.148,1.059,1.131,1.098,1.120,1.073]
scale_QCD_band1=[1.051,1.057,1.130,1.011,1.007,1.013,1.013]
...
jes_EWK  =[1.02,1.04,1.07,1.22,1.11,1.10,1.11]
