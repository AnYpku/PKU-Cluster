...
//  hs->GetYaxis()->CenterTitle();
	...
	double maximumMC = 2 * sumMC->GetMaximum();
	...
	latex.SetTextFont(42);
        ...
        latex.DrawLatex(poi_X,maximumMC*0.9,"#mu#mu#gamma_{#font[132]{barrel}}");
	if (isDataPresent_) {
...
//			nominal->GetYaxis()->CenterTitle();
	...
	//-- resize y axis --
	hs->SetMaximum(40 * maximumForStack);
	//
	cv->SetLogy(true);
	cv->Update();
	cv->Modified(true);
