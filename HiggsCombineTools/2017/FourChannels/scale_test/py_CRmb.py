...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2017/FourChannels/2017muendcap/SR/CR/aa.root")
tstack = f_in.Get("hs")
...
jer_VV   =[1.10]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('muon17', 'endcap'),'w')
