...
Double_t lowpt[ptnumber] ={20,25,50};//j
Double_t highpt[ptnumber]={25,50,400};

  Double_t lpt[num]= {20,25,30,40,50,60};//i
  Double_t hpt[num]={25,30,40,50,60,400};
...
TString dir4 = "./txt/";
ofstream file1(dir4 +"closure_FakeUncer.txt");
TString dir =  "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/pesudo/eleendcap/txt/";
TString dir1 = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/pesudo/eleendcap/roofit/txt/";
//TString dir1 = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/MakeTemplate/With_sieieCorr/pesudo/fit_eleendcap/fractionfitResult_za/";
...
//    cout<<fixed<<setprecision(0)<<lpt[i]<<"~"<<fixed<<setprecision(3)<<hpt[i]<<"\t"<<fabs(FakeNumber-fitFake_number)/FakeNumber<<endl;
    ...
    file1<<fixed<<setprecision(3)<<fabs(FakeNumber-fitFake_number)/FakeNumber<<endl;
