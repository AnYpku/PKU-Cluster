...
//=========  (Sun Jan 19 19:43:33 2020) by ROOT version6.10/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-32.32024,1.0625,216.297);
   pad1->SetFillColor(0);
   ...
   hs_stack_1->SetMaximum(193.9214);
   ...
   ST_stack_1->SetBinContent(1,0.2257638);
   ST_stack_1->SetBinError(1,0.2257638);
   ...
   TTA_stack_2->SetBinContent(1,7.668295);
   TTA_stack_2->SetBinError(1,1.241993);
   ...
   VV_stack_3->SetBinContent(1,7.122669);
   VV_stack_3->SetBinError(1,1.753581);
   ...
   t_ZA_stack_6->SetBinContent(1,165.1383);
   t_ZA_stack_6->SetBinError(1,10.19916);
   ...
   ZA_sig_stack_7->SetBinContent(1,4.532089);
   ZA_sig_stack_7->SetBinError(1,0.324423);
