...
using namespace std;
void fX0_parameterization(int index,vector<double>ZGbin){
...
void f_parameterization(){
	...
	fX0_parameterization(1,ZGbin);
	fX0_parameterization(2,ZGbin);
	fX0_parameterization(3,ZGbin);
	fX0_parameterization(4,ZGbin);
	fX0_parameterization(5,ZGbin);
	fX0_parameterization(6,ZGbin);
	fX0_parameterization(7,ZGbin);
	fX0_parameterization(8,ZGbin);
	fX0_parameterization(9,ZGbin);
	fX0_parameterization(10,ZGbin);
	fX0_parameterization(11,ZGbin);
	fX0_parameterization(12,ZGbin);
	fX0_parameterization(13,ZGbin);
	fX0_parameterization(14,ZGbin);
	fX0_parameterization(15,ZGbin);
	fX0_parameterization(16,ZGbin);
}
