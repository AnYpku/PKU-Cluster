...
def main():
    ...
    prefix = "/home/linghua/Dropbox/Stat_test/test1/Workspaces/"
    path_to_the_project = prefix+"/aQGC_ANYING/MakeToys/"
    directory_output = "Toys"
    path_to_the_workspace = prefix+"/aQGC_ANYING/WORKSPACE/"
