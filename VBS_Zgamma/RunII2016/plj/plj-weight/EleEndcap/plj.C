...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ifstream f1;
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/eleendcap/step1/pljweight.txt");
//   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/eleendcap/step1/pljweight_up.txt");
//   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/fakephoton/eleendcap/step1/pljweight_down.txt");
   Double_t scalef_f[6];
   for(Int_t i=0;i<6;i++){
      f1>>scalef_f[i];
