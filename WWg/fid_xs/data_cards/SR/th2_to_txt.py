...
def get_unc(directory):
    arr={}
    f=open(directory+'Uncer/SR/summary_uncer_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.txt')
    for line in f:
            if not line.strip():
                continue
            print line
...
f_Data=TFile.Open(dir1+'root/hist_MuonEG_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_WWg = TFile.Open(dir2+'root/hist_WWG_emu_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_ZA = TFile.Open(dir1+'root/hist_ZGJets_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_plj = TFile.Open(dir1+'root/hist_plj_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_fakeL = TFile.Open(dir1+'root/hist_fakeL_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_TTA = TFile.Open(dir1+'root/hist_TTGJets_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_WA = TFile.Open(dir1+'root/hist_WGJets_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_VV = TFile.Open(dir1+'root/hist_VV_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_ST = TFile.Open(dir1+'root/hist_ST_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
f_tZq = TFile.Open(dir1+'root/hist_tZq_'+sys.argv[3]+'_'+sys.argv[2]+'_'+sys.argv[1]+'.root')
