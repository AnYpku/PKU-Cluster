...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2018/FourChannels/2018muendcap/SR/CR/aa.root")
tstack = f_in.Get("hs")
...
jer_VV   =[1.10]
for i in range(1,2):
   f = open('%s_%s_control.txt'%('muon18', 'endcap'),'w')
