...
TString dir166="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2016legacy/aQGC/fakephoton/muon/";
...
TFile*f11=new TFile(dir166+"mu_hist.root");
TFile*f22=new TFile(dir166+"mu_up_hist.root");
TFile*f33=new TFile(dir166+"mu_down_hist.root");

TH1D*h1=(TH1D*)f1->Get("ele");
TH1D*h2=(TH1D*)f2->Get("ele_up");
TH1D*h3=(TH1D*)f3->Get("ele_down");
TH1D*h11=(TH1D*)f11->Get("mu");
TH1D*h22=(TH1D*)f22->Get("mu_up");
TH1D*h33=(TH1D*)f33->Get("mu_down");

TString dir17="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/aQGC/fakephoton/ele/";
TString dir177="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/aQGC/fakephoton/muon/";
...
TFile*ff11=new TFile(dir177+"mu_hist.root");
TFile*ff22=new TFile(dir177+"mu_up_hist.root");
TFile*ff33=new TFile(dir177+"mu_down_hist.root");

TH1D*hh1=(TH1D*)ff1->Get("ele");
TH1D*hh2=(TH1D*)ff2->Get("ele_up");
TH1D*hh3=(TH1D*)ff3->Get("ele_down");
TH1D*hh11=(TH1D*)ff11->Get("mu");
TH1D*hh22=(TH1D*)ff22->Get("mu_up");
TH1D*hh33=(TH1D*)ff33->Get("mu_down");

TString dir18="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/aQGC/fakephoton/ele/";
TString dir188="/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2018/aQGC/fakephoton/muon/";
...
TFile*fff11=new TFile(dir188+"mu_hist.root");
TFile*fff22=new TFile(dir188+"mu_up_hist.root");
TFile*fff33=new TFile(dir188+"mu_down_hist.root");

TH1D*hhh1=(TH1D*)fff1->Get("ele");
TH1D*hhh2=(TH1D*)fff2->Get("ele_up");
TH1D*hhh3=(TH1D*)fff3->Get("ele_down");
TH1D*hhh11=(TH1D*)fff11->Get("mu");
TH1D*hhh22=(TH1D*)fff22->Get("mu_up");
TH1D*hhh33=(TH1D*)fff33->Get("mu_down");
