...
f_in = TFile.Open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/HiggsCombineTools/2018/FourChannels/2018elebarrel/SR/mjj5007501000_detajj25456_zepp18/aa.root")
tstack = f_in.Get("hs")
...
jes=[1.02,1.04,1.14,1.07,1.01,1.10,1.06]
jes_QCD=[1.23,1.29,1.41,1.48,1.46,1.94,1.96]
