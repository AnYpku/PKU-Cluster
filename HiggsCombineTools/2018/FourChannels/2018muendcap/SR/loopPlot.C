...
//	std::string pathToTrees = "/home/pku/anying/cms/file_in_cms/2018RunIIrootfiles/2018cutla/";
	std::string pathToTrees = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2018/aa2/ScalSeq/output-slimmed-rootfiles/";
...
// Setup names of data files for trees.
	...
	for (int ii = 0; ii < nDATA; ii++) {
		fData.push_back(pathToTrees + "optimal_2018_" + dataLabels[ii] + ".root");
...
// set mc imformation
		...
		for (int ii = 0; ii < nMC; ii++) {
			fMC.push_back(pathToTrees +"optimal_2018_"+ mcLabels[ii] + ".root");
...
// set mcsig information
	...
	for (int ii = 0; ii < nMCSig; ii++) {
		fMCSig.push_back(pathToTrees + "optimal_2018_" + mcLabelsSig[ii] + ".root");
