...
//	const TString InData_New = "./cutla-";
	...
	treef->SetBranchAddress("photon_id_scale", &photon_id_scale);
        ...
        treef->SetBranchAddress("jet1puIdMedium", &jet1puIdMedium);
        treef->SetBranchAddress("jet2puIdMedium", &jet2puIdMedium);
...
void f_parameterization_elehist(){
	fX0_parameterization_elehist(1);
	fX0_parameterization_elehist(2);
	fX0_parameterization_elehist(3);
	fX0_parameterization_elehist(4);
	fX0_parameterization_elehist(5);
	fX0_parameterization_elehist(6);
	fX0_parameterization_elehist(7);
	fX0_parameterization_elehist(8);
	fX0_parameterization_elehist(9);
	fX0_parameterization_elehist(10);
	fX0_parameterization_elehist(11);
	fX0_parameterization_elehist(12);
	fX0_parameterization_elehist(13);
	fX0_parameterization_elehist(14);
	fX0_parameterization_elehist(15);
	fX0_parameterization_elehist(16);
}
