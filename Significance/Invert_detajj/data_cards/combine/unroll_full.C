...
void run(){
	...
	Double_t lumi=137.1;
        ...
        TH1F*th2_ZA17  =(TH1F*)f2->Get("hist_QCD");
        TH1F*th2_ZA18  =(TH1F*)f3->Get("hist_QCD");
	...
	const char *name[3]={"0.5-0.6","0.6-0.7","0.7-0.8"};
        ...
        TH1F*th2_ZA_sig17  =(TH1F*)f2->Get("hist_Sig");
        TH1F*th2_ZA_sig18  =(TH1F*)f3->Get("hist_Sig");
	...
	th2_ZA_sig->SetMarkerStyle(21);
        ...
        TH1F* th2_VV17  =(TH1F*)f2->Get("hist_VV");
        TH1F* th2_VV18  =(TH1F*)f3->Get("hist_VV");
	...
	th2_VV->SetMarkerColor(40);
        ...
        TH1F* th2_TTA17  =(TH1F*)f2->Get("hist_TTA");
        TH1F* th2_TTA18  =(TH1F*)f3->Get("hist_TTA");
	...
	th2_TTA->SetMarkerColor(kCyan);
        ...
        TH1F* th2_ST17  =(TH1F*)f2->Get("hist_ST");
        TH1F* th2_ST18  =(TH1F*)f3->Get("hist_ST");
	...
	th2_ST->SetMarkerColor(kGreen+2);
        ...
        TH1F* th2_plj17  =(TH1F*)f2->Get("hist_non_prompt");
        TH1F* th2_plj18  =(TH1F*)f3->Get("hist_non_prompt");
	...
	hs->Add(th2_ZA_sig);
        ...
        TFile*f4=new TFile("/home/pku/anying/cms/PKU-Cluster/Significance/Invert_detajj/root/hist_16.root");
        TFile*f5=new TFile("/home/pku/anying/cms/PKU-Cluster/Significance/Invert_detajj/root/hist_17.root");
        TFile*f6=new TFile("/home/pku/anying/cms/PKU-Cluster/Significance/Invert_detajj/root/hist_18.root");
        TH1D*hist_data=(TH1D*)f4->Get("hist_Muon16");
        TH1D*hist_data17=(TH1D*)f5->Get("hist_Muon17");
        TH1D*hist_data18=(TH1D*)f6->Get("hist_Muon18");
        hist_data->Add(hist_data17,1);hist_data->Add(hist_data18,1);
        TH1F*htot  =(TH1F*)f1->Get("hist_total");
        TH1F*htot17  =(TH1F*)f2->Get("hist_total");
        TH1F*htot18  =(TH1F*)f3->Get("hist_total");
	htot->Add(htot17,1);
        htot->Add(htot18,1);
...
//        vline2->Draw();
        ...
        TGraphAsymmErrors*gr16=(TGraphAsymmErrors*)f1->Get("data_16");
        TGraphAsymmErrors*gr17=(TGraphAsymmErrors*)f2->Get("data_17");
        TGraphAsymmErrors*gr18=(TGraphAsymmErrors*)f3->Get("data_18");
	double x[3],x_up[3],x_down[3],y_up[3],y_down[3];
	double y[3],y16[3],y17[3],y18[3];
	for(int i=0;i<gr16->GetN();i++){
                y[i]=0;y16[i]=0;y17[i]=0;y18[i]=0;
