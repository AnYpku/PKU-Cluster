...
//TString b="chiso5-12_";
        ...
        TH1F* hdata = (TH1F*)fdata->Get(Form("data_pt%0.f_%0.f",lowpt,highpt));
        TH1F* hfake = (TH1F*)fdata->Get(Form("fake_pt%0.f_%0.f",lowpt,highpt));
        TH1F* htrue = (TH1F*)ftrue->Get(Form("true_pt%0.f_%0.f",lowpt,highpt));
        TH1F* hzaf  = (TH1F*)ftrue->Get(Form("fake_pt%0.f_%0.f",lowpt,highpt));
        hfake->Add(hzaf,-59.7);
	htrue->Scale(59.7);
