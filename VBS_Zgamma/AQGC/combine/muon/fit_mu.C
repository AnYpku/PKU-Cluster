void fX0_parameterization_mu(int index,vector<double>ZGbin){
        ...
        TString dir6="/home/pku/anying/cms/PKU-Cluster/AQGC/2016/muon/hist/hist_mu_"; 
        TString dir7="/home/pku/anying/cms/PKU-Cluster/AQGC/2017/muon/hist/hist_mu_"; 
        TString dir8="/home/pku/anying/cms/PKU-Cluster/AQGC/2018/muon/hist/hist_mu_"; 
...
//      ParamSetf.open("paramsets_fT0_mu.txt");
	...
	const int num=ZGbin.size()-1;
	    ...
	    leg->Draw("SAME") ;
	    cout <<"x9"<<endl;
	    if(index==1) c1->SaveAs(TString("fit_fM0")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==2) c1->SaveAs(TString("fit_fM1")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==3) c1->SaveAs(TString("fit_fM2")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==4) c1->SaveAs(TString("fit_fM3")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==5) c1->SaveAs(TString("fit_fM4")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==6) c1->SaveAs(TString("fit_fM5")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==7) c1->SaveAs(TString("fit_fM6")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==8) c1->SaveAs(TString("fit_fM7")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==9) c1->SaveAs(TString("fit_fT0")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==10) c1->SaveAs(TString("fit_fT1")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==11) c1->SaveAs(TString("fit_fT2")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==12) c1->SaveAs(TString("fit_fT5")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==13) c1->SaveAs(TString("fit_fT6")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==14) c1->SaveAs(TString("fit_fT7")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==15) c1->SaveAs(TString("fit_fT8")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
	    if(index==16) c1->SaveAs(TString("fit_fT9")+Form("_ZGbin_%u",i)+TString(".pdf")) ;
