...
// Sun Dec 20 15:28:36 2020 by ROOT version 6.12/07
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TString m_dataset;
   chain(TTree *tree=0,TString dataset="");
   virtual ~chain();
...
#ifdef chain_cxx
chain::chain(TTree *tree,TString dataset) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("./cutla-outZA16.root/ZPKUCandidates");
      tree = chain;
#endif // SINGLE_TREE
...
Long64_t chain::LoadTree(Long64_t entry)
{
...
void chain::Show(Long64_t entry)
{
...
Int_t chain::Cut(Long64_t entry)
{
