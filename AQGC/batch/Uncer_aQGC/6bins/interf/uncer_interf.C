...
void run(TString channel){
	...
	TH1D* h2 = (TH1D*)file1->Get("hist_interf");
	TH1D* hh1 = (TH1D*)file2->Get("hist-EWK");
	TH1D* hh2 = (TH1D*)file2->Get("hist_interf");
	TH1D* hhh1 = (TH1D*)file3->Get("hist-EWK");
	TH1D* hhh2 = (TH1D*)file3->Get("hist_interf");
        h1->Add(hh1,1);
        h1->Add(hhh1,1);
        h2->Add(hh2,1);
        h2->Add(hhh2,1);
