...
void calculate_test(Double_t lowpt,Double_t highpt,Double_t lowchiso,Double_t highchiso);
void run_calculate_test(Int_t a);
...
//    cout<<"selectFake_number"<<selectFake_number;
 ...
 void run_calculate_test(Int_t a,Int_t b){
     ...
     calculate_test(lowpt[a],highpt[a],lowchiso[b],highchiso[b]);
