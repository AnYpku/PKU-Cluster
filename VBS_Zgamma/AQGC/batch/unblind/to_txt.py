...
f_interf = TFile.Open(fdir+'hist_ZA_interf'+sys.argv[1]+sys.argv[2]+'.root')
...
if sys.argv[2].find("ele") == -1:
   f_Data=TFile.Open(fdir+'hist_Muon'+sys.argv[1]+sys.argv[2]+'.root')
else:
   f_Data=TFile.Open(fdir+'hist_Ele'+sys.argv[1]+sys.argv[2]+'.root')
